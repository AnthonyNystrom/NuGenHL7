...
{
	/// <summary> <p>Represents the OMS_O05_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class OMS_O05_PATIENT:AbstractGroup
	{
		...
		virtual public OMS_O05_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of OMS_O05_INSURANCE </summary>
		...
		/// <summary> Returns  first repetition of OMS_O05_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OMS_O05_INSURANCE getINSURANCE()
		{
		...
		/// <summary> Returns a specific repetition of OMS_O05_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMS_O05_INSURANCE getINSURANCE(int rep)
		{
