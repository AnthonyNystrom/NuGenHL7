...
{
	/// <summary> <p>Represents the RPA_I08_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RPA_I08_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RPA_I08_VISIT Group.</summary>
		public RPA_I08_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
