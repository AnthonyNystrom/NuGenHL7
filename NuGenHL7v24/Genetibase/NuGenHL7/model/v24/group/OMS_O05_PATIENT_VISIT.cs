...
{
	/// <summary> <p>Represents the OMS_O05_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OMS_O05_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OMS_O05_PATIENT_VISIT Group.</summary>
		public OMS_O05_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
