...
{
	/// <summary> <p>Represents the RDE_O11_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class RDE_O11_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns RDE_O11_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public RDE_O11_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (RDE_O11_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of RDE_O11_INSURANCE </summary>
		...
		/// <summary> Creates a new RDE_O11_PATIENT Group.</summary>
		public RDE_O11_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of RDE_O11_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual RDE_O11_INSURANCE getINSURANCE()
		{
			RDE_O11_INSURANCE ret = null;
			try
			{
				ret = (RDE_O11_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RDE_O11_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RDE_O11_INSURANCE getINSURANCE(int rep)
		{
			return (RDE_O11_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
