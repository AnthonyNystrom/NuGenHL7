...
{
	/// <summary> <p>Represents the PPP_PCB_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPP_PCB_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_ORDER_OBSERVATION Group.</summary>
		public PPP_PCB_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
