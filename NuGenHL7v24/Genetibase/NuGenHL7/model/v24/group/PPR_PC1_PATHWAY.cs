...
{
	/// <summary> <p>Represents the PPR_PC1_PATHWAY Group.  A Group is an ordered collection of message 
	...
	public class PPR_PC1_PATHWAY:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_PATHWAY Group.</summary>
		public PPR_PC1_PATHWAY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
