...
{
	/// <summary> <p>Represents the OMP_O09_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OMP_O09_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OMP_O09_PATIENT_VISIT Group.</summary>
		public OMP_O09_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
