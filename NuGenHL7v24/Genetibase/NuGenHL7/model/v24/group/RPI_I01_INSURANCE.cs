...
{
	/// <summary> <p>Represents the RPI_I01_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class RPI_I01_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new RPI_I01_INSURANCE Group.</summary>
		public RPI_I01_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
