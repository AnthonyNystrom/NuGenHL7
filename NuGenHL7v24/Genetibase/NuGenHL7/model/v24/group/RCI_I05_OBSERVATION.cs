...
{
	/// <summary> <p>Represents the RCI_I05_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class RCI_I05_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RCI_I05_RESULTS </summary>
		...
		/// <summary> Returns  first repetition of RCI_I05_RESULTS (a Group object) - creates it if necessary</summary>
		public virtual RCI_I05_RESULTS getRESULTS()
		{
		...
		/// <summary> Returns a specific repetition of RCI_I05_RESULTS
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RCI_I05_RESULTS getRESULTS(int rep)
		{
