...
{
	/// <summary> <p>Represents the VXU_V04_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class VXU_V04_PATIENT:AbstractGroup
	{
		...
		/// <summary> Creates a new VXU_V04_PATIENT Group.</summary>
		public VXU_V04_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
