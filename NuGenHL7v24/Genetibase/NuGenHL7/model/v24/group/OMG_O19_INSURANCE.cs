...
{
	/// <summary> <p>Represents the OMG_O19_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OMG_O19_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OMG_O19_INSURANCE Group.</summary>
		public OMG_O19_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
