...
{
	/// <summary> <p>Represents the DFT_P03_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class DFT_P03_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new DFT_P03_INSURANCE Group.</summary>
		public DFT_P03_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
