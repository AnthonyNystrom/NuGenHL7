...
{
	/// <summary> <p>Represents the PGL_PC6_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_PROBLEM_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_PROBLEM_ROLE Group.</summary>
		public PGL_PC6_PROBLEM_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
