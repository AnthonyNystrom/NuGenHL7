...
{
	/// <summary> <p>Represents the PGL_PC6_ORDER Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns PGL_PC6_ORDER_DETAIL (a Group object) - creates it if necessary</summary>
		virtual public PGL_PC6_ORDER_DETAIL ORDER_DETAIL
		{
			get
			{
		...
		/// <summary> Creates a new PGL_PC6_ORDER Group.</summary>
