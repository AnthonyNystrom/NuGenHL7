...
{
	/// <summary> <p>Represents the OML_O21_OBSERVATION_REQUEST Group.  A Group is an ordered collection of message 
	...
	public class OML_O21_OBSERVATION_REQUEST:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OML_O21_CONTAINER_2 </summary>
		virtual public int CONTAINER_2Reps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns the number of existing repetitions of OML_O21_OBSERVATION </summary>
		...
		/// <summary> Returns the number of existing repetitions of OML_O21_PRIOR_RESULT </summary>
		...
		/// <summary> Returns  first repetition of OML_O21_CONTAINER_2 (a Group object) - creates it if necessary</summary>
		public virtual OML_O21_CONTAINER_2 getCONTAINER_2()
		{
		...
		/// <summary> Returns a specific repetition of OML_O21_CONTAINER_2
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O21_CONTAINER_2 getCONTAINER_2(int rep)
		{
		...
		/// <summary> Returns  first repetition of OML_O21_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual OML_O21_OBSERVATION getOBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of OML_O21_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O21_OBSERVATION getOBSERVATION(int rep)
		{
			return (OML_O21_OBSERVATION) this.get_Renamed("OBSERVATION", rep);
		}
		
		/// <summary> Returns  first repetition of OML_O21_PRIOR_RESULT (a Group object) - creates it if necessary</summary>
		public virtual OML_O21_PRIOR_RESULT getPRIOR_RESULT()
		{
		...
		/// <summary> Returns a specific repetition of OML_O21_PRIOR_RESULT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O21_PRIOR_RESULT getPRIOR_RESULT(int rep)
		{
