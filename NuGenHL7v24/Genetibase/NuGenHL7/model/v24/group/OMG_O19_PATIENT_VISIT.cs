...
{
	/// <summary> <p>Represents the OMG_O19_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OMG_O19_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OMG_O19_PATIENT_VISIT Group.</summary>
		public OMG_O19_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
