...
{
	/// <summary> <p>Represents the PPG_PCG_PATHWAY Group.  A Group is an ordered collection of message 
	...
	public class PPG_PCG_PATHWAY:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PPG_PCG_PATHWAY_ROLE </summary>
		...
		/// <summary> Returns the number of existing repetitions of PPG_PCG_GOAL </summary>
		...
		/// <summary> Returns  first repetition of PPG_PCG_PATHWAY_ROLE (a Group object) - creates it if necessary</summary>
		public virtual PPG_PCG_PATHWAY_ROLE getPATHWAY_ROLE()
		{
		...
		/// <summary> Returns a specific repetition of PPG_PCG_PATHWAY_ROLE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPG_PCG_PATHWAY_ROLE getPATHWAY_ROLE(int rep)
		{
			return (PPG_PCG_PATHWAY_ROLE) this.get_Renamed("PATHWAY_ROLE", rep);
		}
		
		/// <summary> Returns  first repetition of PPG_PCG_GOAL (a Group object) - creates it if necessary</summary>
		public virtual PPG_PCG_GOAL getGOAL()
		{
		...
		/// <summary> Returns a specific repetition of PPG_PCG_GOAL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPG_PCG_GOAL getGOAL(int rep)
		{
