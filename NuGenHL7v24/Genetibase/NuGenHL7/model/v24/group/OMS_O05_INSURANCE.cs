...
{
	/// <summary> <p>Represents the OMS_O05_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OMS_O05_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OMS_O05_INSURANCE Group.</summary>
		public OMS_O05_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
