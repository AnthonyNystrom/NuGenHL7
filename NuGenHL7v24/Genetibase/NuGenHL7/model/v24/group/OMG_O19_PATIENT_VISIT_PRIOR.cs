...
{
	/// <summary> <p>Represents the OMG_O19_PATIENT_VISIT_PRIOR Group.  A Group is an ordered collection of message 
	...
	public class OMG_O19_PATIENT_VISIT_PRIOR:AbstractGroup
	{
		...
		/// <summary> Creates a new OMG_O19_PATIENT_VISIT_PRIOR Group.</summary>
