...
{
	/// <summary> <p>Represents the RER_RER_ORDER Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: ORC (Common Order) <b></b><br>
	/// 1: RXE (Pharmacy/Treatment Encoded Order) <b></b><br>
	...
	public class RER_RER_ORDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RER_RER_ORDER Group.</summary>
