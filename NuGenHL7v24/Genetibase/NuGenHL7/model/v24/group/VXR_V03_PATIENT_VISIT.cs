...
{
	/// <summary> <p>Represents the VXR_V03_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class VXR_V03_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new VXR_V03_PATIENT_VISIT Group.</summary>
		public VXR_V03_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
