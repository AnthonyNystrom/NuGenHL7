...
{
	/// <summary> <p>Represents the PGL_PC6_PROBLEM Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_PROBLEM:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PGL_PC6_PROBLEM_ROLE </summary>
		...
		/// <summary> Returns the number of existing repetitions of PGL_PC6_PROBLEM_OBSERVATION </summary>
		...
		/// <summary> Returns  first repetition of PGL_PC6_PROBLEM_ROLE (a Group object) - creates it if necessary</summary>
		public virtual PGL_PC6_PROBLEM_ROLE getPROBLEM_ROLE()
		{
		...
		/// <summary> Returns a specific repetition of PGL_PC6_PROBLEM_ROLE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PGL_PC6_PROBLEM_ROLE getPROBLEM_ROLE(int rep)
		{
			return (PGL_PC6_PROBLEM_ROLE) this.get_Renamed("PROBLEM_ROLE", rep);
		}
		
		/// <summary> Returns  first repetition of PGL_PC6_PROBLEM_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual PGL_PC6_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of PGL_PC6_PROBLEM_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PGL_PC6_PROBLEM_OBSERVATION getPROBLEM_OBSERVATION(int rep)
		{
