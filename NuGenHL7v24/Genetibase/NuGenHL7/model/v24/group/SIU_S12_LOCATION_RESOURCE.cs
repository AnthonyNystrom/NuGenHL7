...
{
	/// <summary> <p>Represents the SIU_S12_LOCATION_RESOURCE Group.  A Group is an ordered collection of message 
	...
	public class SIU_S12_LOCATION_RESOURCE:AbstractGroup
	{
		...
		/// <summary> Creates a new SIU_S12_LOCATION_RESOURCE Group.</summary>
		public SIU_S12_LOCATION_RESOURCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
