...
{
	/// <summary> <p>Represents the MFN_M10_MF_TEST_BATT_DETAIL Group.  A Group is an ordered collection of message 
	...
	{
		/// <summary> Returns OM5 (Observation Batteries (Sets)) - creates it if necessary</summary>
