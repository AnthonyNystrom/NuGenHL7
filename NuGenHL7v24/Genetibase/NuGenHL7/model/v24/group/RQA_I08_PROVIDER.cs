...
{
	/// <summary> <p>Represents the RQA_I08_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RQA_I08_PROVIDER:AbstractGroup
	{
		...
		public RQA_I08_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
