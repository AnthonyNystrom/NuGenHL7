...
{
	/// <summary> <p>Represents the OMG_O19_PATIENT Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: PID (Patient identification) <b></b><br>
	/// 1: PD1 (patient additional demographic) <b>optional </b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: OMG_O19_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 4: OMG_O19_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class OMG_O19_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns OMG_O19_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OMG_O19_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (OMG_O19_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OMG_O19_INSURANCE </summary>
		...
		/// <summary> Creates a new OMG_O19_PATIENT Group.</summary>
		public OMG_O19_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OMG_O19_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OMG_O19_INSURANCE getINSURANCE()
		{
			OMG_O19_INSURANCE ret = null;
			try
			{
				ret = (OMG_O19_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OMG_O19_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMG_O19_INSURANCE getINSURANCE(int rep)
		{
			return (OMG_O19_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
