...
{
	/// <summary> <p>Represents the PGL_PC6_GOAL_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_GOAL_ROLE:AbstractGroup
	{
		...
		public PGL_PC6_GOAL_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
