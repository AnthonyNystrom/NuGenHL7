...
{
	/// <summary> <p>Represents the PPP_PCB_ORDER Group.  A Group is an ordered collection of message 
	...
	public class PPP_PCB_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns PPP_PCB_ORDER_DETAIL (a Group object) - creates it if necessary</summary>
		virtual public PPP_PCB_ORDER_DETAIL ORDER_DETAIL
		{
			get
			{
		...
		/// <summary> Creates a new PPP_PCB_ORDER Group.</summary>
