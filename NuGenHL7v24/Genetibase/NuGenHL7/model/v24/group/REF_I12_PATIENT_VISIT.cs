...
{
	/// <summary> <p>Represents the REF_I12_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class REF_I12_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new REF_I12_PATIENT_VISIT Group.</summary>
