...
{
	/// <summary> <p>Represents the PRR_PC5_PROBLEM_PATHWAY Group.  A Group is an ordered collection of message 
	...
	public class PRR_PC5_PROBLEM_PATHWAY:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_PROBLEM_PATHWAY Group.</summary>
