...
{
	/// <summary> <p>Represents the RQA_I08_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class RQA_I08_INSURANCE:AbstractGroup
	{
		...
		public RQA_I08_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
