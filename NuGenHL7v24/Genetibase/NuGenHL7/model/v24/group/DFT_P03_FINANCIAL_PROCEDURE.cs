...
{
	/// <summary> <p>Represents the DFT_P03_FINANCIAL_PROCEDURE Group.  A Group is an ordered collection of message 
	...
	public class DFT_P03_FINANCIAL_PROCEDURE:AbstractGroup
	{
		...
		/// <summary> Creates a new DFT_P03_FINANCIAL_PROCEDURE Group.</summary>
		public DFT_P03_FINANCIAL_PROCEDURE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
