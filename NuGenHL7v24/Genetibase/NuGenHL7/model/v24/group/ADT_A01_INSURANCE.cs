...
{
	/// <summary> <p>Represents the ADT_A01_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class ADT_A01_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A01_INSURANCE Group.</summary>
		public ADT_A01_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
