...
{
	/// <summary> <p>Represents the VXR_V03_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class VXR_V03_INSURANCE:AbstractGroup
	{
		...
		public VXR_V03_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
