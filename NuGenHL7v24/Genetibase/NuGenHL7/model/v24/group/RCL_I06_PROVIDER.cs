...
{
	/// <summary> <p>Represents the RCL_I06_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RCL_I06_PROVIDER:AbstractGroup
	{
		...
		public RCL_I06_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
