...
{
	/// <summary> <p>Represents the PPV_PCA_GOAL Group.  A Group is an ordered collection of message 
	...
	public class PPV_PCA_GOAL:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PPV_PCA_GOAL_ROLE </summary>
		...
		/// <summary> Returns the number of existing repetitions of PPV_PCA_GOAL_PATHWAY </summary>
		virtual public int GOAL_PATHWAYReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns the number of existing repetitions of PPV_PCA_GOAL_OBSERVATION </summary>
		...
		/// <summary> Returns the number of existing repetitions of PPV_PCA_PROBLEM </summary>
		...
		/// <summary> Returns the number of existing repetitions of PPV_PCA_ORDER </summary>
		...
		/// <summary> Creates a new PPV_PCA_GOAL Group.</summary>
		...
		/// <summary> Returns  first repetition of PPV_PCA_GOAL_ROLE (a Group object) - creates it if necessary</summary>
		public virtual PPV_PCA_GOAL_ROLE getGOAL_ROLE()
		{
		...
		/// <summary> Returns a specific repetition of PPV_PCA_GOAL_ROLE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPV_PCA_GOAL_ROLE getGOAL_ROLE(int rep)
		{
			return (PPV_PCA_GOAL_ROLE) this.get_Renamed("GOAL_ROLE", rep);
		}
		
		/// <summary> Returns  first repetition of PPV_PCA_GOAL_PATHWAY (a Group object) - creates it if necessary</summary>
		public virtual PPV_PCA_GOAL_PATHWAY getGOAL_PATHWAY()
		{
		...
		/// <summary> Returns a specific repetition of PPV_PCA_GOAL_PATHWAY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPV_PCA_GOAL_PATHWAY getGOAL_PATHWAY(int rep)
		{
			return (PPV_PCA_GOAL_PATHWAY) this.get_Renamed("GOAL_PATHWAY", rep);
		}
		
		/// <summary> Returns  first repetition of PPV_PCA_GOAL_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual PPV_PCA_GOAL_OBSERVATION getGOAL_OBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of PPV_PCA_GOAL_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPV_PCA_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep)
		{
			return (PPV_PCA_GOAL_OBSERVATION) this.get_Renamed("GOAL_OBSERVATION", rep);
		}
		
		/// <summary> Returns  first repetition of PPV_PCA_PROBLEM (a Group object) - creates it if necessary</summary>
		public virtual PPV_PCA_PROBLEM getPROBLEM()
		{
		...
		/// <summary> Returns a specific repetition of PPV_PCA_PROBLEM
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPV_PCA_PROBLEM getPROBLEM(int rep)
		{
			return (PPV_PCA_PROBLEM) this.get_Renamed("PROBLEM", rep);
		}
		
		/// <summary> Returns  first repetition of PPV_PCA_ORDER (a Group object) - creates it if necessary</summary>
		public virtual PPV_PCA_ORDER getORDER()
		{
		...
		/// <summary> Returns a specific repetition of PPV_PCA_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPV_PCA_ORDER getORDER(int rep)
		{
