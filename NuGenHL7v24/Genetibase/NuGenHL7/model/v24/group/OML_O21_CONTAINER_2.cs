...
{
	/// <summary> <p>Represents the OML_O21_CONTAINER_2 Group.  A Group is an ordered collection of message 
	...
	public class OML_O21_CONTAINER_2:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O21_CONTAINER_2 Group.</summary>
		public OML_O21_CONTAINER_2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
