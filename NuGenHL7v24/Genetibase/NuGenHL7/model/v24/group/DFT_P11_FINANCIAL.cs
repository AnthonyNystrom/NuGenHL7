...
{
	/// <summary> <p>Represents the DFT_P11_FINANCIAL Group.  A Group is an ordered collection of message 
	...
	public class DFT_P11_FINANCIAL:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_FINANCIAL_PROCEDURE </summary>
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_FINANCIAL_COMMON_ORDER </summary>
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_FINANCIAL_INSURANCE </summary>
		virtual public int FINANCIAL_INSURANCEReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns  first repetition of DFT_P11_FINANCIAL_PROCEDURE (a Group object) - creates it if necessary</summary>
		public virtual DFT_P11_FINANCIAL_PROCEDURE getFINANCIAL_PROCEDURE()
		{
		...
		/// <summary> Returns a specific repetition of DFT_P11_FINANCIAL_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_FINANCIAL_PROCEDURE getFINANCIAL_PROCEDURE(int rep)
		{
			return (DFT_P11_FINANCIAL_PROCEDURE) this.get_Renamed("FINANCIAL_PROCEDURE", rep);
		}
		
		/// <summary> Returns  first repetition of DFT_P11_FINANCIAL_COMMON_ORDER (a Group object) - creates it if necessary</summary>
		public virtual DFT_P11_FINANCIAL_COMMON_ORDER getFINANCIAL_COMMON_ORDER()
		{
		...
		/// <summary> Returns a specific repetition of DFT_P11_FINANCIAL_COMMON_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_FINANCIAL_COMMON_ORDER getFINANCIAL_COMMON_ORDER(int rep)
		{
		...
		/// <summary> Returns  first repetition of DFT_P11_FINANCIAL_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual DFT_P11_FINANCIAL_INSURANCE getFINANCIAL_INSURANCE()
		{
		...
		/// <summary> Returns a specific repetition of DFT_P11_FINANCIAL_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_FINANCIAL_INSURANCE getFINANCIAL_INSURANCE(int rep)
		{
