...
{
	/// <summary> <p>Represents the MFN_M11_MF_TEST_CALCULATED Group.  A Group is an ordered collection of message 
	...
	public class MFN_M11_MF_TEST_CALCULATED:AbstractGroup
	{
		...
		/// <summary> Returns MFN_M11_MF_TEST_CALC_DETAIL (a Group object) - creates it if necessary</summary>
		virtual public MFN_M11_MF_TEST_CALC_DETAIL MF_TEST_CALC_DETAIL
		{
			get
			{
