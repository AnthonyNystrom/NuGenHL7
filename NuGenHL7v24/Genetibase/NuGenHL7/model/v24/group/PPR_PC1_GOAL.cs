...
{
	/// <summary> <p>Represents the PPR_PC1_GOAL Group.  A Group is an ordered collection of message 
	...
	public class PPR_PC1_GOAL:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PPR_PC1_GOAL_ROLE </summary>
		...
		/// <summary> Returns the number of existing repetitions of PPR_PC1_GOAL_OBSERVATION </summary>
		...
		/// <summary> Creates a new PPR_PC1_GOAL Group.</summary>
		...
		/// <summary> Returns  first repetition of PPR_PC1_GOAL_ROLE (a Group object) - creates it if necessary</summary>
		public virtual PPR_PC1_GOAL_ROLE getGOAL_ROLE()
		{
		...
		/// <summary> Returns a specific repetition of PPR_PC1_GOAL_ROLE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPR_PC1_GOAL_ROLE getGOAL_ROLE(int rep)
		{
			return (PPR_PC1_GOAL_ROLE) this.get_Renamed("GOAL_ROLE", rep);
		}
		
		/// <summary> Returns  first repetition of PPR_PC1_GOAL_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual PPR_PC1_GOAL_OBSERVATION getGOAL_OBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of PPR_PC1_GOAL_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPR_PC1_GOAL_OBSERVATION getGOAL_OBSERVATION(int rep)
		{
