...
{
	/// <summary> <p>Represents the PPR_PC1_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPR_PC1_PROBLEM_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_PROBLEM_ROLE Group.</summary>
		public PPR_PC1_PROBLEM_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
