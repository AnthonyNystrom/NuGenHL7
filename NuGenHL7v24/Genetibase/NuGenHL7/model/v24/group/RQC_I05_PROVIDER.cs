...
{
	/// <summary> <p>Represents the RQC_I05_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RQC_I05_PROVIDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RQC_I05_PROVIDER Group.</summary>
		public RQC_I05_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
