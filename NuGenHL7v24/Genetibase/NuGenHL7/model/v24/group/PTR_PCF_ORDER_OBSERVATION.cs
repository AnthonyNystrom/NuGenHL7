...
{
	/// <summary> <p>Represents the PTR_PCF_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PTR_PCF_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_ORDER_OBSERVATION Group.</summary>
		public PTR_PCF_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
