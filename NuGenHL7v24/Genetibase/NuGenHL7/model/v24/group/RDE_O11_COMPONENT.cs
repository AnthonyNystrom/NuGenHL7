...
{
	/// <summary> <p>Represents the RDE_O11_COMPONENT Group.  A Group is an ordered collection of message 
	...
	public class RDE_O11_COMPONENT:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O11_COMPONENT Group.</summary>
		public RDE_O11_COMPONENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
