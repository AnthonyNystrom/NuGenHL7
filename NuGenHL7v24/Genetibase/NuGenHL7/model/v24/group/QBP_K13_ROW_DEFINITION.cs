...
{
	/// <summary> <p>Represents the QBP_K13_ROW_DEFINITION Group.  A Group is an ordered collection of message 
	...
	public class QBP_K13_ROW_DEFINITION:AbstractGroup
	{
		...
		/// <summary> Creates a new QBP_K13_ROW_DEFINITION Group.</summary>
