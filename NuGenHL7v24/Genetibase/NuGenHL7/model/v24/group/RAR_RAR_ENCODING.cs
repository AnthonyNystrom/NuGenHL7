...
{
	/// <summary> <p>Represents the RAR_RAR_ENCODING Group.  A Group is an ordered collection of message 
	...
	public class RAR_RAR_ENCODING:AbstractGroup
	{
		...
		/// <summary> Creates a new RAR_RAR_ENCODING Group.</summary>
		public RAR_RAR_ENCODING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
