...
{
	/// <summary> <p>Represents the PPR_PC1_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PPR_PC1_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_PATIENT_VISIT Group.</summary>
		public PPR_PC1_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
