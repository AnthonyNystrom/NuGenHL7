...
{
	/// <summary> <p>Represents the OML_O21_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class OML_O21_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O21_OBSERVATION Group.</summary>
		public OML_O21_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
