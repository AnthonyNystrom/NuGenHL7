...
{
	/// <summary> <p>Represents the PPR_PC1_ORDER_DETAIL Group.  A Group is an ordered collection of message 
	...
	public class PPR_PC1_ORDER_DETAIL:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PPR_PC1_ORDER_OBSERVATION </summary>
		...
		/// <summary> Creates a new PPR_PC1_ORDER_DETAIL Group.</summary>
		...
		/// <summary> Returns  first repetition of PPR_PC1_ORDER_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual PPR_PC1_ORDER_OBSERVATION getORDER_OBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of PPR_PC1_ORDER_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPR_PC1_ORDER_OBSERVATION getORDER_OBSERVATION(int rep)
		{
