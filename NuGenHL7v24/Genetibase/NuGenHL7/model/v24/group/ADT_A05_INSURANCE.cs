...
{
	/// <summary> <p>Represents the ADT_A05_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class ADT_A05_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A05_INSURANCE Group.</summary>
		public ADT_A05_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
