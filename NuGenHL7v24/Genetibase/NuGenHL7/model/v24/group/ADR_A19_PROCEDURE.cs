...
{
	/// <summary> <p>Represents the ADR_A19_PROCEDURE Group.  A Group is an ordered collection of message 
	...
	public class ADR_A19_PROCEDURE:AbstractGroup
	{
		...
		/// <summary> Creates a new ADR_A19_PROCEDURE Group.</summary>
		public ADR_A19_PROCEDURE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
