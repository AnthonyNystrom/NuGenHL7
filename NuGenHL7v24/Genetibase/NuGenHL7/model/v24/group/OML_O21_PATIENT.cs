...
{
	/// <summary> <p>Represents the OML_O21_PATIENT Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: PID (Patient identification) <b></b><br>
	/// 1: PD1 (patient additional demographic) <b>optional </b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: OML_O21_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 4: OML_O21_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class OML_O21_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns OML_O21_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OML_O21_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (OML_O21_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OML_O21_INSURANCE </summary>
		...
		/// <summary> Creates a new OML_O21_PATIENT Group.</summary>
		public OML_O21_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OML_O21_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OML_O21_INSURANCE getINSURANCE()
		{
			OML_O21_INSURANCE ret = null;
			try
			{
				ret = (OML_O21_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OML_O21_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O21_INSURANCE getINSURANCE(int rep)
		{
			return (OML_O21_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
