...
{
	/// <summary> <p>Represents the SRM_S01_GENERAL_RESOURCE Group.  A Group is an ordered collection of message 
	...
	public class SRM_S01_GENERAL_RESOURCE:AbstractGroup
	{
		...
		public SRM_S01_GENERAL_RESOURCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
