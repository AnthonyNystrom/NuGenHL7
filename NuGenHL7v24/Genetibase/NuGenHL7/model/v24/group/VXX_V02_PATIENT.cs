...
{
	/// <summary> <p>Represents the VXX_V02_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class VXX_V02_PATIENT:AbstractGroup
	{
		...
		/// <summary> Creates a new VXX_V02_PATIENT Group.</summary>
		public VXX_V02_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
