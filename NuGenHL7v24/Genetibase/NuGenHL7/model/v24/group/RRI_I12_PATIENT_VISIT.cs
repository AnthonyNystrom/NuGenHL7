...
{
	/// <summary> <p>Represents the RRI_I12_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RRI_I12_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RRI_I12_PATIENT_VISIT Group.</summary>
		public RRI_I12_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
