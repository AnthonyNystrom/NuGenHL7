...
{
	/// <summary> <p>Represents the RSP_Z82_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z82_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z82_PATIENT_VISIT Group.</summary>
		public RSP_Z82_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
