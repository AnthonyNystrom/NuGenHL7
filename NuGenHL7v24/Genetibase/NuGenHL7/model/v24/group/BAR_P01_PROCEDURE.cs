...
{
	/// <summary> <p>Represents the BAR_P01_PROCEDURE Group.  A Group is an ordered collection of message 
	...
	public class BAR_P01_PROCEDURE:AbstractGroup
	{
		...
		/// <summary> Creates a new BAR_P01_PROCEDURE Group.</summary>
		public BAR_P01_PROCEDURE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
