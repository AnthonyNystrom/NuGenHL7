...
namespace Genetibase.NuGenHL7.model.v24.group
{
	...
	public class ORL_O22_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORL_O22_GENERAL_ORDER </summary>
		virtual public int GENERAL_ORDERReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns  first repetition of ORL_O22_GENERAL_ORDER (a Group object) - creates it if necessary</summary>
		public virtual ORL_O22_GENERAL_ORDER getGENERAL_ORDER()
		{
		...
		/// <summary> Returns a specific repetition of ORL_O22_GENERAL_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORL_O22_GENERAL_ORDER getGENERAL_ORDER(int rep)
		{
