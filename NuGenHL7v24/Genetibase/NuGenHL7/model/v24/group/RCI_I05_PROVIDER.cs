...
{
	/// <summary> <p>Represents the RCI_I05_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RCI_I05_PROVIDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RCI_I05_PROVIDER Group.</summary>
		public RCI_I05_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
