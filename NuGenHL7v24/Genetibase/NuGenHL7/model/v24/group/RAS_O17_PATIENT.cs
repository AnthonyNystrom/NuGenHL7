...
{
	/// <summary> <p>Represents the RAS_O17_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class RAS_O17_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns RAS_O17_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public RAS_O17_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
		...
		/// <summary> Creates a new RAS_O17_PATIENT Group.</summary>
