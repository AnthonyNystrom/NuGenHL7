...
{
	/// <summary> <p>Represents the RPA_I08_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class RPA_I08_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new RPA_I08_INSURANCE Group.</summary>
		public RPA_I08_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
