...
{
	/// <summary> <p>Represents the RDS_O13_COMPONENT Group.  A Group is an ordered collection of message 
	...
	public class RDS_O13_COMPONENT:AbstractGroup
	{
		...
		/// <summary> Creates a new RDS_O13_COMPONENT Group.</summary>
		public RDS_O13_COMPONENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
