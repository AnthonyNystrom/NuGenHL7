...
{
	/// <summary> <p>Represents the RAS_O17_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RAS_O17_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RAS_O17_PATIENT_VISIT Group.</summary>
		public RAS_O17_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
