...
{
	/// <summary> <p>Represents the OMN_O07_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OMN_O07_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OMN_O07_PATIENT_VISIT Group.</summary>
