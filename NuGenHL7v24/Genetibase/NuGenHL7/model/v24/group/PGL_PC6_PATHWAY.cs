...
{
	/// <summary> <p>Represents the PGL_PC6_PATHWAY Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_PATHWAY:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_PATHWAY Group.</summary>
		public PGL_PC6_PATHWAY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
