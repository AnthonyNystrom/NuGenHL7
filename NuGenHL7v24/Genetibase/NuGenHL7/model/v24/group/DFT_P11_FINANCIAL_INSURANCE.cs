...
{
	/// <summary> <p>Represents the DFT_P11_FINANCIAL_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class DFT_P11_FINANCIAL_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new DFT_P11_FINANCIAL_INSURANCE Group.</summary>
		public DFT_P11_FINANCIAL_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
