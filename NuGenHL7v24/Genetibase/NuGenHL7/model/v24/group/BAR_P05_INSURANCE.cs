...
{
	/// <summary> <p>Represents the BAR_P05_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class BAR_P05_INSURANCE:AbstractGroup
	{
		...
		public BAR_P05_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
