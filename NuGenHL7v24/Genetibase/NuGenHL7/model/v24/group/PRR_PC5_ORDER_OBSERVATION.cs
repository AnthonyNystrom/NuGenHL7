...
{
	/// <summary> <p>Represents the PRR_PC5_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PRR_PC5_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_ORDER_OBSERVATION Group.</summary>
		public PRR_PC5_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
