...
{
	/// <summary> <p>Represents the RDS_O13_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RDS_O13_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RDS_O13_PATIENT_VISIT Group.</summary>
		public RDS_O13_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
