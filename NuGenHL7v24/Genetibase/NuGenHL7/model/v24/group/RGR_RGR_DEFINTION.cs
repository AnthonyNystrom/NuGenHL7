...
{
	/// <summary> <p>Represents the RGR_RGR_DEFINTION Group.  A Group is an ordered collection of message 
	...
	public class RGR_RGR_DEFINTION:AbstractGroup
	{
		...
		/// <summary> Creates a new RGR_RGR_DEFINTION Group.</summary>
		public RGR_RGR_DEFINTION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
