...
namespace Genetibase.NuGenHL7.model.v24.segment
{
	...
	public class OM1:AbstractSegment
	{
		...
		/// <summary> Returns Producer's Service/Test/Observation ID (OM1-2).</summary>
		virtual public CE ProducerSServiceTestObservationID
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Returns Other Service/Test/Observation IDs for the Observation (OM1-7).</summary>
		virtual public CE OtherServiceTestObservationIDsForTheObservation
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Returns Portable Device Indicator (OM1-15).</summary>
		virtual public ID PortableDeviceIndicator
		{
			get
			{
				ID ret = null;
		...
		/// <summary> Returns Nature of Service/Test/Observation (OM1-18).</summary>
		virtual public IS NatureOfServiceTestObservation
		{
			get
			{
				IS ret = null;
		...
		virtual public CE ObservationsRequiredToInterpretTheObservation
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Returns Factors that may Affect Affect the Observation (OM1-39).</summary>
		virtual public TX FactorsThatMayAffectAffectTheObservation
		{
			get
			{
				TX ret = null;
		...
		/// <summary> Creates a OM1 (General Segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		...
		/// <summary> Returns a single repetition of Service/Test/Observation Performance Schedule (OM1-40).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual ST getServiceTestObservationPerformanceSchedule(int rep)
		{
			ST ret = null;
			try
			{
		...
		/// <summary> Returns all repetitions of Service/Test/Observation Performance Schedule (OM1-40).</summary>
		public virtual ST[] getServiceTestObservationPerformanceSchedule()
		{
			ST[] ret = null;
			try
			{
