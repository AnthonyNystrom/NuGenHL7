...
namespace Genetibase.NuGenHL7.model.v24.segment
{
	...
	public class SAC:AbstractSegment
	{
		...
		virtual public NM AvailableVolume
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Creates a SAC (Specimen and container detail) segment object that belongs to the given 
		/// message.  
		/// </summary>
		...
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getAdditive(int rep)
		{
			CE ret = null;
			try
			{
		...
		/// <summary> Returns a single repetition of Special Handling Considerations (SAC-43).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getSpecialHandlingConsiderations(int rep)
		{
			CE ret = null;
			try
			{
		...
		public virtual CE[] getSpecialHandlingConsiderations()
		{
			CE[] ret = null;
			try
			{
