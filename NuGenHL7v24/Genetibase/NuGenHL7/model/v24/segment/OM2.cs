...
namespace Genetibase.NuGenHL7.model.v24.segment
{
	...
	/// OM2-7: Critical Range for Ordinal and Continuous Observations (NR)<br> 
	...
	public class OM2:AbstractSegment
	{
		...
		/// <summary> Returns Reference (Normal) Range - Ordinal and Continuous Observations (OM2-6).</summary>
		virtual public RFR ReferenceNormalRangeOrdinalAndContinuousObservations
		{
			get
			{
				RFR ret = null;
		...
		/// <summary> Returns Critical Range for Ordinal and Continuous Observations (OM2-7).</summary>
		virtual public NR CriticalRangeForOrdinalAndContinuousObservations
		{
			get
			{
				NR ret = null;
		...
		public OM2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(NR), false, 1, 205, new System.Object[]{message});
				this.add(typeof(RFR), false, 1, 250, new System.Object[]{message});
