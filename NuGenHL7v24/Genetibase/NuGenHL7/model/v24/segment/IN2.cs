	...
	public class IN2:AbstractSegment
	{
		...
		public IN2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(RMC), false, 0, 250, new System.Object[]{message});
				this.add(typeof(PTA), false, 0, 250, new System.Object[]{message});
				this.add(typeof(DDI), false, 1, 250, new System.Object[]{message});
