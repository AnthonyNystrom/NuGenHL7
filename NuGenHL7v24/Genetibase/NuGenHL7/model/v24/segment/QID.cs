...
namespace Genetibase.NuGenHL7.model.v24.segment
{
	...
	/// <summary> <p>Represents an HL7 QID message segment. 
	...
	public class QID:AbstractSegment
	{
		...
		/// <summary> Creates a QID (Query Identification) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public QID(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			Message message = Message;
			try
			{
				this.add(typeof(ST), true, 1, 32, new System.Object[]{message});
