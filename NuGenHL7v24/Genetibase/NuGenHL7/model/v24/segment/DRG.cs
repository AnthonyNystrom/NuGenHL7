...
namespace Genetibase.NuGenHL7.model.v24.segment
{
	...
	public class DRG:AbstractSegment
	{
		...
		virtual public IS DRGTransferType
		{
			get
			{
				IS ret = null;
		...
		/// <summary> Creates a DRG (Diagnosis Related Group) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public DRG(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(ID), false, 1, 1, new System.Object[]{message, 136});
				this.add(typeof(IS), false, 1, 21, new System.Object[]{message, 415});
			}
			catch (NuGenHL7Exception)
			{
			}
