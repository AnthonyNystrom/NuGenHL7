...
namespace Genetibase.NuGenHL7.model.v24.segment
{
	...
	public class PV1:AbstractSegment
	{
		...
		/// <summary> Returns a single repetition of Discharge Date/Time (PV1-45).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual TS getDischargeDateTime(int rep)
		{
			TS ret = null;
			try
			{
		...
		/// <summary> Returns all repetitions of Discharge Date/Time (PV1-45).</summary>
		public virtual TS[] getDischargeDateTime()
		{
			TS[] ret = null;
			try
			{
