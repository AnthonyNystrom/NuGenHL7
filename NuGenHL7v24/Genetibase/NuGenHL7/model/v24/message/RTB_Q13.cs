...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RTB_Q13 message structure (see chapter 5). This structure contains the 
	...
	/// 5: RTB_Q13_ROW_DEFINITION (a Group object) <b>optional </b><br>
	...
	public class RTB_Q13:AbstractMessage
	{
		...
		/// <summary> Returns RTB_Q13_ROW_DEFINITION (a Group object) - creates it if necessary</summary>
		virtual public RTB_Q13_ROW_DEFINITION ROW_DEFINITION
		{
			get
			{
				...
				try
				{
					ret = (RTB_Q13_ROW_DEFINITION) this.get_Renamed("ROW_DEFINITION");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RTB_Q13 Group with custom ModelClassFactory.</summary>
		public RTB_Q13(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RTB_Q13 Group with DefaultModelClassFactory. </summary>
