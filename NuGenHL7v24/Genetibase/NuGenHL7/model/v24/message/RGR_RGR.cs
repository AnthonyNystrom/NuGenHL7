...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RGR_RGR message structure (see chapter 4). This structure contains the 
	...
	public class RGR_RGR:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RGR_RGR_DEFINTION </summary>
		virtual public int DEFINTIONReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns a specific repetition of RGR_RGR_DEFINTION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RGR_RGR_DEFINTION getDEFINTION(int rep)
		{
			return (RGR_RGR_DEFINTION) this.get_Renamed("DEFINTION", rep);
		}
	}
}