...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RSP_Z90 message structure (see chapter 5). This structure contains the 
	...
	/// 6: RSP_Z90_QUERY_RESPONSE (a Group object) <b>repeating</b><br>
	/// 7: DSC (Continuation Pointer) <b></b><br>
	/// </summary>
	[Serializable]
	public class RSP_Z90:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_Z90_QUERY_RESPONSE </summary>
		...
		/// <summary> Creates a new RSP_Z90 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of RSP_Z90_QUERY_RESPONSE (a Group object) - creates it if necessary</summary>
		public virtual RSP_Z90_QUERY_RESPONSE getQUERY_RESPONSE()
		{
			RSP_Z90_QUERY_RESPONSE ret = null;
			try
			{
				ret = (RSP_Z90_QUERY_RESPONSE) this.get_Renamed("QUERY_RESPONSE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RSP_Z90_QUERY_RESPONSE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_Z90_QUERY_RESPONSE getQUERY_RESPONSE(int rep)
		{
			return (RSP_Z90_QUERY_RESPONSE) this.get_Renamed("QUERY_RESPONSE", rep);
		}
	}
}