...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RSP_K24 message structure (see chapter 3). This structure contains the 
	...
	public class RSP_K24:AbstractMessage
	{
		...
		/// <summary> Creates a new RSP_K24 Group with custom ModelClassFactory.</summary>
		public RSP_K24(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_K24 Group with DefaultModelClassFactory. </summary>
