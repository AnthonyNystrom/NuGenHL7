...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RDE_O11 message structure (see chapter 4). This structure contains the 
	...
	public class RDE_O11:AbstractMessage
	{
		...
		/// <summary> Returns RDE_O11_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public RDE_O11_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of RDE_O11_ORDER </summary>
		...
		/// <summary> Creates a new RDE_O11 Group with custom ModelClassFactory.</summary>
		public RDE_O11(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RDE_O11 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of RDE_O11_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RDE_O11_ORDER getORDER(int rep)
		{
