...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a BAR_P06 message structure (see chapter 6). This structure contains the 
	...
	public class BAR_P06:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of BAR_P06_PATIENT </summary>
		...
		/// <summary> Returns  first repetition of BAR_P06_PATIENT (a Group object) - creates it if necessary</summary>
		public virtual BAR_P06_PATIENT getPATIENT()
		{
		...
		/// <summary> Returns a specific repetition of BAR_P06_PATIENT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P06_PATIENT getPATIENT(int rep)
		{
