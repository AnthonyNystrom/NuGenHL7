...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a ADT_A06 message structure (see chapter 3). This structure contains the 
	...
	/// 5: MRG (Merge patient information) <b>optional </b><br>
	...
	/// 15: ADT_A06_PROCEDURE (a Group object) <b>optional repeating</b><br>
	/// 16: GT1 (Guarantor) <b>optional repeating</b><br>
	/// 17: ADT_A06_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class ADT_A06:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A06_PROCEDURE </summary>
		...
		/// <summary> Returns the number of existing repetitions of ADT_A06_INSURANCE </summary>
		...
		/// <summary> Returns  first repetition of ADT_A06_PROCEDURE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A06_PROCEDURE getPROCEDURE()
		{
		...
		/// <summary> Returns a specific repetition of ADT_A06_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A06_PROCEDURE getPROCEDURE(int rep)
		{
			return (ADT_A06_PROCEDURE) this.get_Renamed("PROCEDURE", rep);
		}
		...
		/// <summary> Returns  first repetition of ADT_A06_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A06_INSURANCE getINSURANCE()
		{
		...
		/// <summary> Returns a specific repetition of ADT_A06_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A06_INSURANCE getINSURANCE(int rep)
		{
			return (ADT_A06_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
	}
}