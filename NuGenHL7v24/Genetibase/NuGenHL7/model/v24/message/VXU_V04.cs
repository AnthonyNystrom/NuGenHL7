...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// 6: VXU_V04_INSURANCE (a Group object) <b>optional repeating</b><br>
	/// 7: VXU_V04_ORDER (a Group object) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class VXU_V04:AbstractMessage
	{
		...
		virtual public VXU_V04_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of VXU_V04_INSURANCE </summary>
		...
		/// <summary> Returns the number of existing repetitions of VXU_V04_ORDER </summary>
		...
		/// <summary> Returns  first repetition of VXU_V04_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual VXU_V04_INSURANCE getINSURANCE()
		{
		...
		/// <summary> Returns a specific repetition of VXU_V04_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXU_V04_INSURANCE getINSURANCE(int rep)
		{
		...
		/// <summary> Returns a specific repetition of VXU_V04_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXU_V04_ORDER getORDER(int rep)
		{
