...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a ORF_R04 message structure (see chapter 7). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: MSA (Message Acknowledgment) <b></b><br>
	/// 2: QRD (Original-Style Query Definition) <b></b><br>
	/// 3: QRF (Original Style Query Filter) <b>optional </b><br>
	/// 4: ORF_R04_RESPONSE (a Group object) <b>repeating</b><br>
	/// 5: ERR (Error) <b>optional </b><br>
	/// 6: QAK (Query Acknowledgment) <b>optional </b><br>
	...
	public class ORF_R04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ORF_R04_RESPONSE </summary>
		...
		/// <summary> Returns  first repetition of ORF_R04_RESPONSE (a Group object) - creates it if necessary</summary>
		public virtual ORF_R04_RESPONSE getRESPONSE()
		{
			ORF_R04_RESPONSE ret = null;
			try
			{
				ret = (ORF_R04_RESPONSE) this.get_Renamed("RESPONSE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORF_R04_RESPONSE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORF_R04_RESPONSE getRESPONSE(int rep)
		{
			return (ORF_R04_RESPONSE) this.get_Renamed("RESPONSE", rep);
		}
	}
}