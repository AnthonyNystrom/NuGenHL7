...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RSP_K13 message structure (see chapter 5). This structure contains the 
	...
	/// 5: RSP_K13_ROW_DEFINITION (a Group object) <b>optional </b><br>
	...
	public class RSP_K13:AbstractMessage
	{
		...
		/// <summary> Returns RSP_K13_ROW_DEFINITION (a Group object) - creates it if necessary</summary>
		virtual public RSP_K13_ROW_DEFINITION ROW_DEFINITION
		{
			get
			{
				...
				try
				{
					ret = (RSP_K13_ROW_DEFINITION) this.get_Renamed("ROW_DEFINITION");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RSP_K13 Group with custom ModelClassFactory.</summary>
		public RSP_K13(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_K13 Group with DefaultModelClassFactory. </summary>
