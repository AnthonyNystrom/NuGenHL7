...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a MFR_M01 message structure (see chapter 8). This structure contains the 
	...
	/// 6: MFI (Master File Identification) <b></b><br>
	/// 7: MFR_M01_MF_QUERY (a Group object) <b>repeating</b><br>
	...
	public class MFR_M01:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFR_M01_MF_QUERY </summary>
		...
		/// <summary> Returns  first repetition of MFR_M01_MF_QUERY (a Group object) - creates it if necessary</summary>
		public virtual MFR_M01_MF_QUERY getMF_QUERY()
		{
			MFR_M01_MF_QUERY ret = null;
			try
			{
				ret = (MFR_M01_MF_QUERY) this.get_Renamed("MF_QUERY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of MFR_M01_MF_QUERY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFR_M01_MF_QUERY getMF_QUERY(int rep)
		{
			return (MFR_M01_MF_QUERY) this.get_Renamed("MF_QUERY", rep);
		}
	}
}