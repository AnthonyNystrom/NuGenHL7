...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RSP_K22 message structure (see chapter 3). This structure contains the 
	...
	/// 5: RSP_K22_QUERY_RESPONSE (a Group object) <b>optional repeating</b><br>
	...
	public class RSP_K22:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_K22_QUERY_RESPONSE </summary>
		...
		/// <summary> Creates a new RSP_K22 Group with custom ModelClassFactory.</summary>
		public RSP_K22(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_K22 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of RSP_K22_QUERY_RESPONSE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_K22_QUERY_RESPONSE getQUERY_RESPONSE(int rep)
		{
			return (RSP_K22_QUERY_RESPONSE) this.get_Renamed("QUERY_RESPONSE", rep);
		}
	}
}