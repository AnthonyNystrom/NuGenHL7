...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RRI_I12 message structure (see chapter 11). This structure contains the 
	...
	/// 13: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class RRI_I12:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RRI_I12_PROVIDER_CONTACT </summary>
		...
		/// <summary> Returns the number of existing repetitions of RRI_I12_PROCEDURE </summary>
		...
		/// <summary> Returns the number of existing repetitions of RRI_I12_OBSERVATION </summary>
		...
		/// <summary> Returns RRI_I12_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public RRI_I12_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
		...
		/// <summary> Returns a specific repetition of RRI_I12_PROVIDER_CONTACT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRI_I12_PROVIDER_CONTACT getPROVIDER_CONTACT(int rep)
		{
		...
		/// <summary> Returns  first repetition of RRI_I12_PROCEDURE (a Group object) - creates it if necessary</summary>
		public virtual RRI_I12_PROCEDURE getPROCEDURE()
		{
		...
		/// <summary> Returns a specific repetition of RRI_I12_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRI_I12_PROCEDURE getPROCEDURE(int rep)
		{
			return (RRI_I12_PROCEDURE) this.get_Renamed("PROCEDURE", rep);
		}
		
		/// <summary> Returns  first repetition of RRI_I12_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual RRI_I12_OBSERVATION getOBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of RRI_I12_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRI_I12_OBSERVATION getOBSERVATION(int rep)
		{
