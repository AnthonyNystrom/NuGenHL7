...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a ADT_A54 message structure (see chapter 3). This structure contains the 
	...
	public class ADT_A54:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A54 Group with custom ModelClassFactory.</summary>
		public ADT_A54(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A54 Group with DefaultModelClassFactory. </summary>
