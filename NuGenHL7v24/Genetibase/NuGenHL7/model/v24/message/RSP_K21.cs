...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RSP_K21 message structure (see chapter 3). This structure contains the 
	...
	/// 5: RSP_K21_QUERY_RESPONSE (a Group object) <b>optional </b><br>
	...
	public class RSP_K21:AbstractMessage
	{
		...
		/// <summary> Returns RSP_K21_QUERY_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public RSP_K21_QUERY_RESPONSE QUERY_RESPONSE
		{
			get
			{
