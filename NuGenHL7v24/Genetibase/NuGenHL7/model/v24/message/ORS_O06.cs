...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a ORS_O06 message structure (see chapter 4). This structure contains the 
	...
	public class ORS_O06:AbstractMessage
	{
		...
		/// <summary> Returns ORS_O06_RSPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORS_O06_RSPONSE RSPONSE
		{
			get
			{
