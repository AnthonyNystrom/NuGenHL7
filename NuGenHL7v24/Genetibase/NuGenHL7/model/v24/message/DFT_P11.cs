...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a DFT_P11 message structure (see chapter 6.4.3). This structure contains the 
	...
	/// 9: DFT_P11_COMMON_ORDER (a Group object) <b>optional repeating</b><br>
	/// 10: DG1 (Diagnosis) <b>optional repeating</b><br>
	/// 11: DRG (Diagnosis Related Group) <b>optional </b><br>
	/// 12: GT1 (Guarantor) <b>optional repeating</b><br>
	/// 13: DFT_P11_INSURANCE (a Group object) <b>optional repeating</b><br>
	/// 14: ACC (Accident) <b>optional </b><br>
	/// 15: DFT_P11_FINANCIAL (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class DFT_P11:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_COMMON_ORDER </summary>
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_INSURANCE </summary>
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_FINANCIAL </summary>
		...
		/// <summary> Creates a new DFT_P11 Group with custom ModelClassFactory.</summary>
		public DFT_P11(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new DFT_P11 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of DFT_P11_COMMON_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_COMMON_ORDER getCOMMON_ORDER(int rep)
		{
			return (DFT_P11_COMMON_ORDER) this.get_Renamed("COMMON_ORDER", rep);
		}
		...
		/// <summary> Returns  first repetition of DFT_P11_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual DFT_P11_INSURANCE getINSURANCE()
		{
			DFT_P11_INSURANCE ret = null;
			try
			{
				ret = (DFT_P11_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of DFT_P11_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_INSURANCE getINSURANCE(int rep)
		{
			return (DFT_P11_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
		
		/// <summary> Returns  first repetition of DFT_P11_FINANCIAL (a Group object) - creates it if necessary</summary>
		public virtual DFT_P11_FINANCIAL getFINANCIAL()
		{
			DFT_P11_FINANCIAL ret = null;
			try
			{
				ret = (DFT_P11_FINANCIAL) this.get_Renamed("FINANCIAL");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of DFT_P11_FINANCIAL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_FINANCIAL getFINANCIAL(int rep)
		{
			return (DFT_P11_FINANCIAL) this.get_Renamed("FINANCIAL", rep);
		}
	}
}