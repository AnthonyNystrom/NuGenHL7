...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a ADT_A43 message structure (see chapter 3). This structure contains the 
	...
	public class ADT_A43:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A43_PATIENT </summary>
		...
		/// <summary> Returns  first repetition of ADT_A43_PATIENT (a Group object) - creates it if necessary</summary>
		public virtual ADT_A43_PATIENT getPATIENT()
		{
		...
		/// <summary> Returns a specific repetition of ADT_A43_PATIENT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A43_PATIENT getPATIENT(int rep)
		{
