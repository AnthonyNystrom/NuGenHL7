...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a QBP_K13 message structure (see chapter 5). This structure contains the 
	...
	public class QBP_K13:AbstractMessage
	{
		...
		/// <summary> Returns QBP_K13_ROW_DEFINITION (a Group object) - creates it if necessary</summary>
		virtual public QBP_K13_ROW_DEFINITION ROW_DEFINITION
		{
			get
			{
		...
		/// <summary> Creates a new QBP_K13 Group with custom ModelClassFactory.</summary>
		public QBP_K13(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QBP_K13 Group with DefaultModelClassFactory. </summary>
