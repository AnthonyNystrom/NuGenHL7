...
namespace Genetibase.NuGenHL7.model.v24.message
{
	...
	/// <summary> <p>Represents a RSP_K15 message structure (see chapter 5). This structure contains the 
	...
	public class RSP_K15:AbstractMessage
	{
		...
		/// <summary> Creates a new RSP_K15 Group with custom ModelClassFactory.</summary>
		public RSP_K15(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_K15 Group with DefaultModelClassFactory. </summary>
