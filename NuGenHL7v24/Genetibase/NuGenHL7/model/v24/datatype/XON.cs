...
namespace Genetibase.NuGenHL7.model.v24.datatype
{
	...
	public class XON:AbstractType, Composite
	{
		...
		/// <summary> Returns check digit (NM) (component #3).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns identifier type code (IS) (component #6).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
