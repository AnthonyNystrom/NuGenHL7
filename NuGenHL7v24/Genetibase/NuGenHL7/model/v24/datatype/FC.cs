...
namespace Genetibase.NuGenHL7.model.v24.datatype
{
	...
	public class FC:AbstractType, Composite
	{
		...
		/// <summary> Returns Financial Class (component #0).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public IS FinancialClass
		{
			get
			{
				IS ret = null;
		...
		/// <summary> Returns Effective Date (TS) (component #1).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
