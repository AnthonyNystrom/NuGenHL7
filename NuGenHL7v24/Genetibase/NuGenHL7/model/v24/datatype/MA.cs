...
namespace Genetibase.NuGenHL7.model.v24.datatype
{
	...
	public class MA:AbstractType, Composite
	{
		...
		/// <summary> Returns sample 1 from channel 4 (component #3).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public NM Sample1FromChannel4
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns sample 1 from channel 5 (component #4).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public NM Sample1FromChannel5
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns sample 1 from channel 6 (component #5).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public NM Sample1FromChannel6
		{
			get
			{
				NM ret = null;
