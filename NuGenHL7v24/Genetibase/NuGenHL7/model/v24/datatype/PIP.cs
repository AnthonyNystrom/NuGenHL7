...
namespace Genetibase.NuGenHL7.model.v24.datatype
{
	...
	/// <summary> <p>The HL7 PIP (Privileges) data type.  Consists of the following components: </p><ol>
	/// <li>privilege (CE)</li>
	...
	public class PIP:AbstractType, Composite
	{
		...
		/// <summary> Returns facility (EI) (component #4).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
