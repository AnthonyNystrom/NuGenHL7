...
namespace Genetibase.NuGenHL7.model.v24.datatype
{
	...
	/// <summary> <p>The HL7 MO (money) data type.  Consists of the following components: </p><ol>
	/// <li>quantity (NM)</li>
	...
	public class MO:AbstractType, Composite
	{
		...
		/// <summary> Returns denomination (component #1).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ID Denomination
		{
			get
			{
				ID ret = null;
		...
		/// </param>
		public MO(Message message):base(message)
		{
			data = new Type[2];
