...
namespace Genetibase.NuGenHL7.model.v24.datatype
{
	...
	/// <summary> <p>The HL7 PLN (Practitioner ID Numbers) data type.  Consists of the following components: </p><ol>
	...
	public class PLN:AbstractType, Composite
	{
		...
		/// <summary> Returns state/other qualifying info (component #2).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ST StateOtherQualifyingInfo
		{
			get
			{
				ST ret = null;
