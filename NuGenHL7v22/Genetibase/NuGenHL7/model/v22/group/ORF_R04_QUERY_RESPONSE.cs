...
{
	/// <summary> <p>Represents the ORF_R04_QUERY_RESPONSE Group.  A Group is an ordered collection of message 
	...
	public class ORF_R04_QUERY_RESPONSE:AbstractGroup
	{
		...
		/// <summary> Creates a new ORF_R04_QUERY_RESPONSE Group.</summary>
