...
{
	/// <summary> <p>Represents the NMD_N01_CLOCK_AND_STATS_WITH_NOTES Group.  A Group is an ordered collection of message 
	...
	{
		/// <summary> Returns NMD_N01_CLOCK (a Group object) - creates it if necessary</summary>
		virtual public NMD_N01_CLOCK CLOCK
		{
			get
			{
		...
		/// <summary> Returns NMD_N01_APP_STATS (a Group object) - creates it if necessary</summary>
		virtual public NMD_N01_APP_STATS APP_STATS
		{
			get
			{
		...
		/// <summary> Returns NMD_N01_APP_STATUS (a Group object) - creates it if necessary</summary>
		virtual public NMD_N01_APP_STATUS APP_STATUS
		{
			get
			{
		...
		/// <summary> Creates a new NMD_N01_CLOCK_AND_STATS_WITH_NOTES Group.</summary>
