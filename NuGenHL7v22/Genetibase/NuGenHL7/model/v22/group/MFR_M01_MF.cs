...
{
	/// <summary> <p>Represents the MFR_M01_MF Group.  A Group is an ordered collection of message 
	...
	public class MFR_M01_MF:AbstractGroup
	{
		...
		/// <summary> Creates a new MFR_M01_MF Group.</summary>
		public MFR_M01_MF(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
