...
{
	/// <summary> <p>Represents the ADT_A04_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class ADT_A04_INSURANCE:AbstractGroup
	{
		...
		public ADT_A04_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
