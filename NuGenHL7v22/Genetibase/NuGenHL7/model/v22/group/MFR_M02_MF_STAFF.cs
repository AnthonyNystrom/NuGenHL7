...
{
	/// <summary> <p>Represents the MFR_M02_MF_STAFF Group.  A Group is an ordered collection of message 
	...
	public class MFR_M02_MF_STAFF:AbstractGroup
	{
		...
		/// <summary> Creates a new MFR_M02_MF_STAFF Group.</summary>
		public MFR_M02_MF_STAFF(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
