...
{
	/// <summary> <p>Represents the NMD_N01_APP_STATUS Group.  A Group is an ordered collection of message 
	...
	public class NMD_N01_APP_STATUS:AbstractGroup
	{
		...
		public NMD_N01_APP_STATUS(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
