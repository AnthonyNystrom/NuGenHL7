...
{
	/// <summary> <p>Represents the ORF_R04_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class ORF_R04_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new ORF_R04_OBSERVATION Group.</summary>
		public ORF_R04_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
