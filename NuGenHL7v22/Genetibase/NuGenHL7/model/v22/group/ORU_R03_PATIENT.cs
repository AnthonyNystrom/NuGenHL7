...
{
	/// <summary> <p>Represents the ORU_R03_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class ORU_R03_PATIENT:AbstractGroup
	{
		...
		/// <summary> Creates a new ORU_R03_PATIENT Group.</summary>
		public ORU_R03_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
