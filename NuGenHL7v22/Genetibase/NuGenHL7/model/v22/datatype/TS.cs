...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	public class TS:AbstractType, Composite
	{
		...
		/// <summary> Returns time of an event (component #0).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ST TimeOfAnEvent
		{
			get
			{
				ST ret = null;
		...
		/// casting and handling an exception.
		/// </summary>
		virtual public ST DegreeOfPrecision
		{
			get
			{
				ST ret = null;
