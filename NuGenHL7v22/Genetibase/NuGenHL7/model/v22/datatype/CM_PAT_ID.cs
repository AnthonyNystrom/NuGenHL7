...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CM_PAT_ID (Patient ID) data type.  Consists of the following components: </p><ol>
	/// <li>ID number (ST)</li>
	...
	/// </summary>
	[Serializable]
	public class CM_PAT_ID:AbstractType, Composite
	{
		...
		/// </param>
		public CM_PAT_ID(Message message):base(message)
		{
			data = new Type[5];
