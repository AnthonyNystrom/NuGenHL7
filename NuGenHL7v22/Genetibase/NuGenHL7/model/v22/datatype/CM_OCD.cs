...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CM_OCD (occurence) data type.  Consists of the following components: </p><ol>
	...
	public class CM_OCD:AbstractType, Composite
	{
		...
		/// <summary> Creates a CM_OCD.</summary>
		/// <param name="message">the Message to which this Type belongs
		/// </param>
		public CM_OCD(Message message):base(message)
		{
			data = new Type[2];
