...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CN_PERSON (CN für Personen) data type.  Consists of the following components: </p><ol>
	/// <li>ID number (ID)</li>
	...
	public class CN_PERSON:AbstractType, Composite
	{
		...
		/// <summary> Creates a CN_PERSON.</summary>
		/// <param name="message">the Message to which this Type belongs
		/// </param>
		public CN_PERSON(Message message):base(message)
		{
			data = new Type[8];
