...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CM_DDI (daily deductible) data type.  Consists of the following components: </p><ol>
	/// <li>delay days (ST)</li>
	/// <li>amount (NM)</li>
	...
	public class CM_DDI:AbstractType, Composite
	{
		...
		/// <summary> Creates a CM_DDI.</summary>
		/// <param name="message">the Message to which this Type belongs
		/// </param>
		public CM_DDI(Message message):base(message)
		{
			data = new Type[3];
