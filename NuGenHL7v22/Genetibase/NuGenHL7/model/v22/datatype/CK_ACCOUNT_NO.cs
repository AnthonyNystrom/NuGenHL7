...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CK_ACCOUNT_NO (Abrechnungsnummer) data type.  Consists of the following components: </p><ol>
	...
	public class CK_ACCOUNT_NO:AbstractType, Composite
	{
		...
		/// <summary> Returns account number (component #0).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public NM AccountNumber
		{
			get
			{
				NM ret = null;
