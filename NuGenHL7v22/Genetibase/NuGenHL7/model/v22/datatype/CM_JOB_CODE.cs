...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CM_JOB_CODE (Berufsbezeichnung) data type.  Consists of the following components: </p><ol>
	/// <li>job code (ID)</li>
	...
	public class CM_JOB_CODE:AbstractType, Composite
	{
		...
		/// <summary> Returns employee classification (component #1).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ID EmployeeClassification
		{
			get
			{
				ID ret = null;
		...
		/// <summary> Creates a CM_JOB_CODE.</summary>
		/// <param name="message">the Message to which this Type belongs
		/// </param>
		public CM_JOB_CODE(Message message):base(message)
		{
			data = new Type[2];
