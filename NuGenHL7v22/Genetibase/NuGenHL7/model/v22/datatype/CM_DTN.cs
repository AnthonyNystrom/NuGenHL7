...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CM_DTN (Day Type and Number) data type.  Consists of the following components: </p><ol>
	/// <li>day type (ID)</li>
	...
	public class CM_DTN:AbstractType, Composite
	{
		...
		/// <summary> Creates a CM_DTN.</summary>
