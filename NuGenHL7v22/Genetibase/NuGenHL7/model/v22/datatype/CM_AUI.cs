...
namespace Genetibase.NuGenHL7.model.v22.datatype
{
	...
	/// <summary> <p>The HL7 CM_AUI (authorization information) data type.  Consists of the following components: </p><ol>
	...
	/// </summary>
	[Serializable]
	public class CM_AUI:AbstractType, Composite
	{
		...
		/// <summary> Creates a CM_AUI.</summary>
		/// <param name="message">the Message to which this Type belongs
		/// </param>
		public CM_AUI(Message message):base(message)
		{
			data = new Type[3];
