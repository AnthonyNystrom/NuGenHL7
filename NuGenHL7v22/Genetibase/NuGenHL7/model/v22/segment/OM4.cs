...
namespace Genetibase.NuGenHL7.model.v22.segment
{
	...
	public class OM4:AbstractSegment
	{
		...
		virtual public CQ_QUANTITY NormalCollectionVolume
		{
			get
			{
		...
		virtual public CQ_QUANTITY MinimumCollectionVolume
		{
			get
			{
				CQ_QUANTITY ret = null;
		...
		virtual public CQ_QUANTITY SpecimenRetentionTime
		{
			get
			{
				CQ_QUANTITY ret = null;
		...
		/// <summary> Creates a OM4 (OBSERVATION that require specimens) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public OM4(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(CQ_QUANTITY), false, 1, 20, new System.Object[]{message});
				this.add(typeof(TX), false, 1, 10240, new System.Object[]{message});
				this.add(typeof(ID), false, 0, 60, new System.Object[]{message, 27});
				this.add(typeof(CQ_QUANTITY), false, 1, 20, new System.Object[]{message});
			}
			catch (NuGenHL7Exception)
			{
		...
		/// <summary> Returns a single repetition of Specimen Priorities (OM4-14).</summary>
