...
namespace Genetibase.NuGenHL7.model.v22.segment
{
	...
	{
		/// <summary> Returns Set ID - Observational Simple (OBX-1).</summary>
		virtual public SI SetIDObservationalSimple
		{
			get
			{
				SI ret = null;
		...
		/// <summary> Returns Observation Value (OBX-5).</summary>
		virtual public Varies ObservationValue
		{
			get
			{
				Varies ret = null;
		...
		/// <summary> Returns Effective date last observation normal values (OBX-12).</summary>
		virtual public TS EffectiveDateLastObservationNormalValues
		{
			get
			{
				TS ret = null;
		...
		virtual public CN ResponsibleObserver
		{
			get
			{
				CN ret = null;
