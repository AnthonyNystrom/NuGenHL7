...
namespace Genetibase.NuGenHL7.model.v22.segment
{
	...
	public class ODT:AbstractSegment
	{
		...
		/// <summary> Creates a ODT (DIET TRAY INSTRUCTION) segment object that belongs to the given 
		/// message.  
		/// </summary>
		...
		/// <summary> Returns a single repetition of Text Instruction (ODT-3).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		...
		/// <summary> Returns all repetitions of Text Instruction (ODT-3).</summary>
