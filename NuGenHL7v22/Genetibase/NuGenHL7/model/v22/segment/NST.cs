...
namespace Genetibase.NuGenHL7.model.v22.segment
{
	...
	/// NST-8: Message Received (NM)<br> 
	/// NST-9: Message Sent (NM)<br> 
	...
	public class NST:AbstractSegment
	{
		...
		/// <summary> Returns Message Received (NST-8).</summary>
		virtual public NM MessageReceived
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns Message Sent (NST-9).</summary>
		virtual public NM MessageSent
		{
			get
			{
				NM ret = null;
