...
namespace Genetibase.NuGenHL7.model.v22.segment
{
	...
	public class RQ1:AbstractSegment
	{
		...
		virtual public SI AnticipatedPrice
		{
			get
			{
				SI ret = null;
		...
		virtual public CE ManufacturerID
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a RQ1 (REQUISITION DETAIL-!) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public RQ1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				this.add(typeof(SI), false, 1, 10, new System.Object[]{message});
