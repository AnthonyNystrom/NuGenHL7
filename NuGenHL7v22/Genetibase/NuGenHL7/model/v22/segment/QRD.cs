...
namespace Genetibase.NuGenHL7.model.v22.segment
{
	...
	public class QRD:AbstractSegment
	{
		...
		virtual public CQ_QUANTITY QuantityLimitedRequest
		{
			get
			{
		...
		public QRD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(CQ_QUANTITY), true, 1, 10, new System.Object[]{message});
				this.add(typeof(ST), true, 0, 20, new System.Object[]{message});
				this.add(typeof(ID), true, 0, 3, new System.Object[]{message, 48});
				this.add(typeof(ST), true, 0, 20, new System.Object[]{message});
				this.add(typeof(CM_VR), false, 0, 20, new System.Object[]{message});
		...
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CM_VR getWhatDepartmentDataCode(int rep)
		{
            CM_VR ret = null;
			try
			{
		...
		public virtual CM_VR[] getWhatDepartmentDataCode()
		{
			CM_VR[] ret = null;
			try
			{
		...
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CM_VR getWhatDataCodeValueQualifier(int rep)
		{
			CM_VR ret = null;
			try
			{
		...
		public virtual CM_VR[] getWhatDataCodeValueQualifier()
		{
			CM_VR[] ret = null;
			try
			{
