...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a MFD_M01 message structure (see chapter ?). This structure contains the 
	...
	public class MFD_M01:AbstractMessage
	{
		...
		/// <summary> Creates a new MFD_M01 Group with custom ModelClassFactory.</summary>
		public MFD_M01(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
