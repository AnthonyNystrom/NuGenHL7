...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a ORU_R03 message structure (see chapter ?). This structure contains the 
	...
	public class ORU_R03:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ORU_R03_PATIENT_RESULT </summary>
		...
		/// <summary> Returns a specific repetition of ORU_R03_PATIENT_RESULT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORU_R03_PATIENT_RESULT getPATIENT_RESULT(int rep)
		{
