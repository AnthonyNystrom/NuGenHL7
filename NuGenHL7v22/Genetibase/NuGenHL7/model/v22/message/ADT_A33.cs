...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a ADT_A33 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A33:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A33 Group with custom ModelClassFactory.</summary>
		public ADT_A33(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
