...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a NMD_N01 message structure (see chapter ?). This structure contains the 
	...
	public class NMD_N01:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of NMD_N01_CLOCK_AND_STATS_WITH_NOTES </summary>
		...
		/// <summary> Creates a new NMD_N01 Group with custom ModelClassFactory.</summary>
		public NMD_N01(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		...
		/// <summary> Returns  first repetition of NMD_N01_CLOCK_AND_STATS_WITH_NOTES (a Group object) - creates it if necessary</summary>
		public virtual NMD_N01_CLOCK_AND_STATS_WITH_NOTES getCLOCK_AND_STATS_WITH_NOTES()
		{
		...
		/// <summary> Returns a specific repetition of NMD_N01_CLOCK_AND_STATS_WITH_NOTES
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual NMD_N01_CLOCK_AND_STATS_WITH_NOTES getCLOCK_AND_STATS_WITH_NOTES(int rep)
		{
