...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a MFK_M03 message structure (see chapter ?). This structure contains the 
	...
	public class MFK_M03:AbstractMessage
	{
		...
		/// <summary> Creates a new MFK_M03 Group with custom ModelClassFactory.</summary>
		public MFK_M03(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFK_M03 Group with DefaultModelClassFactory. </summary>
