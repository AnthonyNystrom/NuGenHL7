...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a MFD_M02 message structure (see chapter ?). This structure contains the 
	...
	public class MFD_M02:AbstractMessage
	{
		...
		/// <summary> Creates a new MFD_M02 Group with custom ModelClassFactory.</summary>
		public MFD_M02(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFD_M02 Group with DefaultModelClassFactory. </summary>
