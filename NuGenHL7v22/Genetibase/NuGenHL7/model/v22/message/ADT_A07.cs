...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// 12: ADT_A07_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class ADT_A07:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A07_INSURANCE </summary>
		...
		/// <summary> Returns a specific repetition of ADT_A07_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A07_INSURANCE getINSURANCE(int rep)
		{
			return (ADT_A07_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
	}
}