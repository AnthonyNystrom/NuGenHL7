...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a MFQ_M03 message structure (see chapter ?). This structure contains the 
	...
	public class MFQ_M03:AbstractMessage
	{
		...
		/// <summary> Creates a new MFQ_M03 Group with custom ModelClassFactory.</summary>
		public MFQ_M03(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFQ_M03 Group with DefaultModelClassFactory. </summary>
