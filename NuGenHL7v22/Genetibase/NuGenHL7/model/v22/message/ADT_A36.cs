...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a ADT_A36 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A36:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A36 Group with custom ModelClassFactory.</summary>
		public ADT_A36(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A36 Group with DefaultModelClassFactory. </summary>
