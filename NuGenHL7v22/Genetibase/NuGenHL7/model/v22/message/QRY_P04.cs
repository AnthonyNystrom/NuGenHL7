...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a QRY_P04 message structure (see chapter ?). This structure contains the 
	...
	public class QRY_P04:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_P04 Group with custom ModelClassFactory.</summary>
		public QRY_P04(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QRY_P04 Group with DefaultModelClassFactory. </summary>
