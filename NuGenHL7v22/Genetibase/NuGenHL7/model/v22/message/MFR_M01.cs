...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a MFR_M01 message structure (see chapter ?). This structure contains the 
	...
	/// 6: MFR_M01_MF (a Group object) <b>repeating</b><br>
	...
	public class MFR_M01:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFR_M01_MF </summary>
		...
		/// <summary> Returns a specific repetition of MFR_M01_MF
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFR_M01_MF getMF(int rep)
		{
			return (MFR_M01_MF) this.get_Renamed("MF", rep);
		}
	}
}