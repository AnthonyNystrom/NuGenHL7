...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a ADT_A27 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A27:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A27 Group with custom ModelClassFactory.</summary>
		public ADT_A27(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A27 Group with DefaultModelClassFactory. </summary>
