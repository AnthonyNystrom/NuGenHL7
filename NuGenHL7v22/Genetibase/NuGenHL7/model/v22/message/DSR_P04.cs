...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a DSR_P04 message structure (see chapter ?). This structure contains the 
	...
	/// 5: DSP (DISPLAY DATA) <b>repeating</b><br>
	...
	public class DSR_P04:AbstractMessage
	{
		...
		/// <summary> Creates a new DSR_P04 Group with custom ModelClassFactory.</summary>
		public DSR_P04(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new DSR_P04 Group with DefaultModelClassFactory. </summary>
