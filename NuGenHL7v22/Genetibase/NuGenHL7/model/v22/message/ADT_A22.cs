...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a ADT_A22 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A22:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A22 Group with custom ModelClassFactory.</summary>
		public ADT_A22(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A22 Group with DefaultModelClassFactory. </summary>
