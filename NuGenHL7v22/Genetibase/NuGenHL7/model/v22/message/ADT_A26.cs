...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a ADT_A26 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A26:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A26 Group with custom ModelClassFactory.</summary>
		public ADT_A26(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A26 Group with DefaultModelClassFactory. </summary>
