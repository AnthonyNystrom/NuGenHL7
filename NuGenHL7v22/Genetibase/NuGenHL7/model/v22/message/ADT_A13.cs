...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// 11: ADT_A13_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class ADT_A13:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A13_INSURANCE </summary>
		...
		/// <summary> Returns  first repetition of ADT_A13_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A13_INSURANCE getINSURANCE()
		{
			ADT_A13_INSURANCE ret = null;
			try
			{
				ret = (ADT_A13_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A13_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A13_INSURANCE getINSURANCE(int rep)
		{
			return (ADT_A13_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
	}
}