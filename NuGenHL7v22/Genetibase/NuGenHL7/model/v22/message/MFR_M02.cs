...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a MFR_M02 message structure (see chapter ?). This structure contains the 
	...
	public class MFR_M02:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFR_M02_MF_STAFF </summary>
		...
		/// <summary> Creates a new MFR_M02 Group with custom ModelClassFactory.</summary>
		public MFR_M02(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		...
		/// <summary> Returns a specific repetition of MFR_M02_MF_STAFF
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFR_M02_MF_STAFF getMF_STAFF(int rep)
		{
			return (MFR_M02_MF_STAFF) this.get_Renamed("MF_STAFF", rep);
		}
	}
}