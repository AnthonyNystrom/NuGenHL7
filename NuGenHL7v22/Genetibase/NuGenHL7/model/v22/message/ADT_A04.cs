...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	public class ADT_A04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A04_INSURANCE </summary>
		...
		/// <summary> Returns  first repetition of ADT_A04_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A04_INSURANCE getINSURANCE()
		{
		...
		/// <summary> Returns a specific repetition of ADT_A04_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A04_INSURANCE getINSURANCE(int rep)
		{
