...
namespace Genetibase.NuGenHL7.model.v22.message
{
	...
	/// <summary> <p>Represents a DSR_R03 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MESSAGE HEADER) <b></b><br>
	/// 1: MSA (MESSAGE ACKNOWLEDGMENT) <b>optional </b><br>
	/// 2: QRD (QUERY DEFINITION) <b></b><br>
	/// 3: QRF (QUERY FILTER) <b>optional </b><br>
	...
	public class DSR_R03:AbstractMessage
	{
		...
		/// <summary> Creates a new DSR_R03 Group with custom ModelClassFactory.</summary>
		public DSR_R03(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new DSR_R03 Group with DefaultModelClassFactory. </summary>
