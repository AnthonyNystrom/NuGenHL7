...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class RXD:AbstractSegment
	{
		...
		/// <summary> Returns Actual Drug Strength Volume (RXD-28).</summary>
		virtual public NM ActualDrugStrengthVolume
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns Actual Drug Strength Volume Units (RXD-29).</summary>
		virtual public CWE ActualDrugStrengthVolumeUnits
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Dispense to Pharmacy (RXD-30).</summary>
		virtual public CWE DispenseToPharmacy
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Dispense to Pharmacy Address (RXD-31).</summary>
		virtual public XAD DispenseToPharmacyAddress
		{
			get
			{
				XAD ret = null;
		...
		/// <summary> Returns Pharmacy Order Type (RXD-32).</summary>
		...
		/// <summary> Returns Dispense Type (RXD-33).</summary>
		virtual public CWE DispenseType
		{
			get
			{
				CWE ret = null;
