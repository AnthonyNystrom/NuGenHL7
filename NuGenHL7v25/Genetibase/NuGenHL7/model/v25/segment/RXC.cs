...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class RXC:AbstractSegment
	{
		...
		virtual public NM ComponentStrength
		{
			get
			{
				NM ret = null;
		...
		virtual public CE ComponentStrengthUnits
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Returns Component Drug Strength Volume (RXC-8).</summary>
		virtual public NM ComponentDrugStrengthVolume
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns Component Drug Strength Volume Units (RXC-9).</summary>
		virtual public CWE ComponentDrugStrengthVolumeUnits
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Creates a RXC (Pharmacy/Treatment Component Order) segment object that belongs to the given 
		/// message.  
		/// </summary>
		...
		/// <summary> Returns a single repetition of Supplementary Code (RXC-7).</summary>
