...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class RXA:AbstractSegment
	{
		...
		/// <summary> Returns Administered Drug Strength Volume (RXA-23).</summary>
		virtual public NM AdministeredDrugStrengthVolume
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns Administered Drug Strength Volume Units (RXA-24).</summary>
		virtual public CWE AdministeredDrugStrengthVolumeUnits
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Administered Barcode Identifier (RXA-25).</summary>
		virtual public CWE AdministeredBarcodeIdentifier
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Pharmacy Order Type (RXA-26).</summary>
