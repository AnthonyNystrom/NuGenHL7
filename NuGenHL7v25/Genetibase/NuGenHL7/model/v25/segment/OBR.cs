...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class OBR:AbstractSegment
	{
		...
		/// <summary> Returns Priority _ OBR (OBR-5).</summary>
		...
		/// <summary> Returns Medically Necessary Duplicate Procedure Reason. (OBR-48).</summary>
		...
		/// <summary> Returns Result Handling (OBR-49).</summary>
		virtual public IS ResultHandling
		{
			get
			{
				IS ret = null;
		...
		public OBR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(PRL), false, 1, 400, new System.Object[]{message});
				...
				this.add(typeof(IS), false, 1, 2, new System.Object[]{message, 507});
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns a single repetition of Placer Supplemental Service Information (OBR-46).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		...
		/// <summary> Returns all repetitions of Placer Supplemental Service Information (OBR-46).</summary>
		...
		/// <summary> Returns a single repetition of Filler Supplemental Service Information (OBR-47).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
