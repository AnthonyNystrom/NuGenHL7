...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class LDP:AbstractSegment
	{
		...
		/// <summary> Returns Location Cost Center (LDP-12).</summary>
		virtual public CE LocationCostCenter
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a LDP (Location Department) segment object that belongs to the given 
		/// message.  
		/// </summary>
