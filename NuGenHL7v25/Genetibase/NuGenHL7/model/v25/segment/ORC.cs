...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class ORC:AbstractSegment
	{
		...
		/// <summary> Returns Advanced Beneficiary Notice Override Reason (ORC-26).</summary>
		virtual public CWE AdvancedBeneficiaryNoticeOverrideReason
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Filler's Expected Availability Date/Time (ORC-27).</summary>
		virtual public TS FillerSExpectedAvailabilityDateTime
		{
			get
			{
				TS ret = null;
		...
		/// <summary> Returns Confidentiality Code (ORC-28).</summary>
		...
		/// <summary> Returns Order Type (ORC-29).</summary>
		virtual public CWE OrderType
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Enterer Authorization Mode (ORC-30).</summary>
		virtual public CNE EntererAuthorizationMode
		{
			get
			{
				CNE ret = null;
