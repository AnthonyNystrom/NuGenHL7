...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	/// IN2-71: Race (CE)<br> 
	/// IN2-72: CMS Patient_s Relationship to Insured (CE)<br> 
	...
	public class IN2:AbstractSegment
	{
		...
		/// <summary> Returns CMS Patient_s Relationship to Insured (IN2-72).</summary>
		virtual public CE CMSPatientSRelationshipToInsured
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a IN2 (Insurance Additional Information) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public IN2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(RMC), false, 0, 82, new System.Object[]{message});
				this.add(typeof(PTA), false, 0, 56, new System.Object[]{message});
