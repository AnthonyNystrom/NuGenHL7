...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class PR1:AbstractSegment
	{
		...
		/// <summary> Returns Procedure Identifier (PR1-19).</summary>
		virtual public EI ProcedureIdentifier
		{
			get
			{
				EI ret = null;
		...
		/// <summary> Returns Procedure Action Code (PR1-20).</summary>
		virtual public ID ProcedureActionCode
		{
			get
			{
				ID ret = null;
