...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class IN1:AbstractSegment
	{
		...
		/// <summary> Returns Insured's Administrative Sex (IN1-43).</summary>
		virtual public IS InsuredSAdministrativeSex
		{
			get
			{
				IS ret = null;
		...
		/// <summary> Returns Signature Code (IN1-50).</summary>
		virtual public IS SignatureCode
		{
			get
			{
				IS ret = null;
		...
		/// <summary> Returns Signature Code Date (IN1-51).</summary>
		virtual public DT SignatureCodeDate
		{
			get
			{
				DT ret = null;
		...
		/// <summary> Returns Insured_s Birth Place (IN1-52).</summary>
		virtual public ST InsuredSBirthPlace
		{
			get
			{
				ST ret = null;
		...
		/// <summary> Returns VIP Indicator (IN1-53).</summary>
		...
		public IN1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(DT), false, 1, 8, new System.Object[]{message});
				this.add(typeof(AUI), false, 1, 239, new System.Object[]{message});
				...
				this.add(typeof(CX), false, 0, 250, new System.Object[]{message});
				this.add(typeof(IS), false, 1, 1, new System.Object[]{message, 535});
				this.add(typeof(DT), false, 1, 8, new System.Object[]{message});
