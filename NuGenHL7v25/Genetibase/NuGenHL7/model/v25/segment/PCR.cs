	...
	public class PCR:AbstractSegment
	{
		...
		public PCR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(ST), false, 0, 30, new System.Object[]{message});
				...
				this.add(typeof(ID), false, 0, 2, new System.Object[]{message, 251});
				this.add(typeof(ID), false, 0, 2, new System.Object[]{message, 252});
				this.add(typeof(ID), false, 0, 1, new System.Object[]{message, 253});
			}
			catch (NuGenHL7Exception)
			{
			}
