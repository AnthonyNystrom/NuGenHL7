...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class DG1:AbstractSegment
	{
		...
		/// <summary> Returns Diagnosis Identifier (DG1-20).</summary>
		virtual public EI DiagnosisIdentifier
		{
			get
			{
				EI ret = null;
		...
		/// <summary> Returns Diagnosis Action Code (DG1-21).</summary>
		virtual public ID DiagnosisActionCode
		{
			get
			{
				ID ret = null;
		...
		public DG1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(ID), false, 1, 1, new System.Object[]{message, 136});
				this.add(typeof(TS), false, 1, 26, new System.Object[]{message});
				this.add(typeof(EI), false, 1, 427, new System.Object[]{message});
				this.add(typeof(ID), false, 1, 1, new System.Object[]{message, 206});
			}
			catch (NuGenHL7Exception)
			{
			}
