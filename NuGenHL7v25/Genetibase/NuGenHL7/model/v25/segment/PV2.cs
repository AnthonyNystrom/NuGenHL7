...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class PV2:AbstractSegment
	{
		...
		virtual public TS ExpectedSurgeryDateAndTime
		{
			get
			{
				TS ret = null;
		...
		virtual public CE ModeOfArrivalCode
		{
			get
			{
				CE ret = null;
		...
		virtual public CE AdmissionLevelOfCareCode
		{
			get
			{
				CE ret = null;
		...
		virtual public CE PatientConditionCode
		{
			get
			{
				CE ret = null;
		...
		virtual public DT PatientStatusEffectiveDate
		{
			get
			{
				DT ret = null;
		...
		virtual public TS ExpectedLOAReturnDateTime
		{
			get
			{
				TS ret = null;
		...
		/// <summary> Returns Expected Pre-admission Testing Date/Time (PV2-48).</summary>
		virtual public TS ExpectedPreAdmissionTestingDateTime
		{
			get
			{
				TS ret = null;
		...
		public PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(TS), false, 1, 26, new System.Object[]{message});
				this.add(typeof(TS), false, 1, 26, new System.Object[]{message});
				this.add(typeof(IS), false, 0, 20, new System.Object[]{message, 534});
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns a single repetition of Visit User Code (PV2-7).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual IS getVisitUserCode(int rep)
		{
			IS ret = null;
			try
			{
		...
		public virtual IS[] getVisitUserCode()
		{
			IS[] ret = null;
			try
			{
		...
		/// <summary> Returns a single repetition of Recreational Drug Use Code (PV2-39).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getRecreationalDrugUseCode(int rep)
		{
			CE ret = null;
			try
			{
		...
		public virtual CE[] getRecreationalDrugUseCode()
		{
			CE[] ret = null;
			try
			{
		...
		/// <summary> Returns a single repetition of Precaution Code (PV2-41).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getPrecautionCode(int rep)
		{
			CE ret = null;
			try
			{
		...
		public virtual CE[] getPrecautionCode()
		{
			CE[] ret = null;
			try
			{
		...
		/// <summary> Returns a single repetition of Advance Directive Code (PV2-45).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		...
		/// <summary> Returns a single repetition of Notify Clergy Code (PV2-49).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual IS getNotifyClergyCode(int rep)
		{
			IS ret = null;
			try
			{
		...
		/// <summary> Returns all repetitions of Notify Clergy Code (PV2-49).</summary>
		public virtual IS[] getNotifyClergyCode()
		{
			IS[] ret = null;
			try
			{
