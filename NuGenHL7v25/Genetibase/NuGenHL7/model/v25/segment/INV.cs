...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class INV:AbstractSegment
	{
		...
		/// <summary> Returns On Board Stability Time (INV-19).</summary>
		virtual public CQ OnBoardStabilityTime
		{
			get
			{
				CQ ret = null;
		...
		/// <summary> Returns Target Value (INV-20).</summary>
		virtual public CQ TargetValue
		{
			get
			{
				CQ ret = null;
