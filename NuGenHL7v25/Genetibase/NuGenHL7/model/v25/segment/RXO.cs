...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class RXO:AbstractSegment
	{
		...
		/// <summary> Returns Requested Drug Strength Volume (RXO-25).</summary>
		virtual public NM RequestedDrugStrengthVolume
		{
			get
			{
				NM ret = null;
		...
		/// <summary> Returns Requested Drug Strength Volume Units (RXO-26).</summary>
		virtual public CWE RequestedDrugStrengthVolumeUnits
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Pharmacy Order Type (RXO-27).</summary>
		...
		/// <summary> Returns Dispensing Interval (RXO-28).</summary>
		virtual public NM DispensingInterval
		{
			get
			{
				NM ret = null;
