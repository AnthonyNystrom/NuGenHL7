...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class AIP:AbstractSegment
	{
		...
		/// <summary> Returns Resource Type (AIP-4).</summary>
		...
		/// <summary> Creates a AIP (Appointment Information _ Personnel Resource) segment object that belongs to the given 
		/// message.  
		/// </summary>
