	...
	public class MFA:AbstractSegment
	{
		...
		public MFA(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(Varies), true, 0, 250, new System.Object[]{message});
		...
		public virtual Varies getPrimaryKeyValueMFA(int rep)
		{
			Varies ret = null;
			try
			{
		...
		public virtual Varies[] getPrimaryKeyValueMFA()
		{
			Varies[] ret = null;
			try
			{
