...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class RXG:AbstractSegment
	{
		...
		/// <summary> Returns Give Drug Strength Volume (RXG-23).</summary>
		...
		/// <summary> Returns Give Drug Strength Volume Units (RXG-24).</summary>
		...
		/// <summary> Returns Give Barcode Identifier (RXG-25).</summary>
		virtual public CWE GiveBarcodeIdentifier
		{
			get
			{
				CWE ret = null;
		...
		/// <summary> Returns Pharmacy Order Type (RXG-26).</summary>
		...
		/// <summary> Creates a RXG (Pharmacy/Treatment Give) segment object that belongs to the given 
		/// message.  
		/// </summary>
