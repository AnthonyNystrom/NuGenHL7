...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	/// OM2-6: Reference (Normal) Range - Ordinal and Continuous Observations (RFR)<br> 
	...
	public class OM2:AbstractSegment
	{
		...
		/// <summary> Returns Absolute Range for Ordinal and Continuous Observations (OM2-8).</summary>
		virtual public RFR AbsoluteRangeForOrdinalAndContinuousObservations
		{
			get
			{
				RFR ret = null;
		...
		public OM2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(RFR), false, 0, 250, new System.Object[]{message});
				this.add(typeof(RFR), false, 0, 205, new System.Object[]{message});
				this.add(typeof(RFR), false, 1, 250, new System.Object[]{message});
				this.add(typeof(DLT), false, 0, 250, new System.Object[]{message});
		...
		/// <summary> Returns a single repetition of Reference (Normal) Range - Ordinal and Continuous Observations (OM2-6).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual RFR getReferenceNormalRangeOrdinalAndContinuousObservations(int rep)
		{
			RFR ret = null;
			try
			{
		...
		/// <summary> Returns all repetitions of Reference (Normal) Range - Ordinal and Continuous Observations (OM2-6).</summary>
		public virtual RFR[] getReferenceNormalRangeOrdinalAndContinuousObservations()
		{
			RFR[] ret = null;
			try
			{
		...
		/// <summary> Returns a single repetition of Critical Range for Ordinal and Continuous Observations (OM2-7).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual RFR getCriticalRangeForOrdinalAndContinuousObservations(int rep)
		{
			RFR ret = null;
			try
			{
		...
		/// <summary> Returns all repetitions of Critical Range for Ordinal and Continuous Observations (OM2-7).</summary>
		public virtual RFR[] getCriticalRangeForOrdinalAndContinuousObservations()
		{
			RFR[] ret = null;
			try
			{
