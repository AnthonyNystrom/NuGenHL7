...
namespace Genetibase.NuGenHL7.model.v25.segment
{
	...
	public class PRA:AbstractSegment
	{
		...
		virtual public DT DateLeftPractice
		{
			get
			{
				DT ret = null;
		...
		public PRA(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(SPD), false, 0, 112, new System.Object[]{message});
				this.add(typeof(PLN), false, 0, 99, new System.Object[]{message});
				this.add(typeof(PIP), false, 0, 770, new System.Object[]{message});
				this.add(typeof(DT), false, 1, 8, new System.Object[]{message});
				this.add(typeof(CE), false, 1, 250, new System.Object[]{message});
				this.add(typeof(DT), false, 1, 8, new System.Object[]{message});
				this.add(typeof(CE), false, 0, 250, new System.Object[]{message});
				this.add(typeof(SI), false, 1, 60, new System.Object[]{message});
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns a single repetition of Government Reimbursement Billing Eligibility (PRA-11).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getGovernmentReimbursementBillingEligibility(int rep)
		{
			CE ret = null;
			try
			{
