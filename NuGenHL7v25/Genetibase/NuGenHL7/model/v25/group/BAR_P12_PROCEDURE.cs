...
{
	/// <summary> <p>Represents the BAR_P12_PROCEDURE Group.  A Group is an ordered collection of message 
	...
	public class BAR_P12_PROCEDURE:AbstractGroup
	{
		...
		/// <summary> Creates a new BAR_P12_PROCEDURE Group.</summary>
		public BAR_P12_PROCEDURE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
