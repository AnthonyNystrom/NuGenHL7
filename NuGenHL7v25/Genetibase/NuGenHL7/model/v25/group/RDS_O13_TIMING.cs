...
{
	/// <summary> <p>Represents the RDS_O13_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RDS_O13_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RDS_O13_TIMING Group.</summary>
		public RDS_O13_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
