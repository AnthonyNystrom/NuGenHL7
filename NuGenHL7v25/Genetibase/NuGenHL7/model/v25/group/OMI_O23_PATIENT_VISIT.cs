...
{
	/// <summary> <p>Represents the OMI_O23_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OMI_O23_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OMI_O23_PATIENT_VISIT Group.</summary>
		public OMI_O23_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
