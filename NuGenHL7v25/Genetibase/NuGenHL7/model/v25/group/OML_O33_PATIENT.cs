...
{
	/// <summary> <p>Represents the OML_O33_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class OML_O33_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns OML_O33_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OML_O33_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (OML_O33_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OML_O33_INSURANCE </summary>
		...
		/// <summary> Creates a new OML_O33_PATIENT Group.</summary>
		public OML_O33_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OML_O33_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OML_O33_INSURANCE getINSURANCE()
		{
			OML_O33_INSURANCE ret = null;
			try
			{
				ret = (OML_O33_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OML_O33_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O33_INSURANCE getINSURANCE(int rep)
		{
			return (OML_O33_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
