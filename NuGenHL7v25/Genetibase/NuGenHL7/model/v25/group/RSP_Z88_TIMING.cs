...
{
	/// <summary> <p>Represents the RSP_Z88_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z88_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z88_TIMING Group.</summary>
		public RSP_Z88_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
