...
{
	/// <summary> <p>Represents the OML_O35_TIIMING Group.  A Group is an ordered collection of message 
	...
	public class OML_O35_TIIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O35_TIIMING Group.</summary>
		public OML_O35_TIIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
