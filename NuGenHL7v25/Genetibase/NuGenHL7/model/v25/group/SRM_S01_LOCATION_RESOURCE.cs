...
{
	/// <summary> <p>Represents the SRM_S01_LOCATION_RESOURCE Group.  A Group is an ordered collection of message 
	...
	public class SRM_S01_LOCATION_RESOURCE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRM_S01_LOCATION_RESOURCE Group.</summary>
		public SRM_S01_LOCATION_RESOURCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
