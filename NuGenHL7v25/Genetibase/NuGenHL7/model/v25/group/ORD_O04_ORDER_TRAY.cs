...
{
	/// <summary> <p>Represents the ORD_O04_ORDER_TRAY Group.  A Group is an ordered collection of message 
	...
	public class ORD_O04_ORDER_TRAY:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORD_O04_TIMING_TRAY </summary>
		...
		/// <summary> Creates a new ORD_O04_ORDER_TRAY Group.</summary>
		public ORD_O04_ORDER_TRAY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of ORD_O04_TIMING_TRAY (a Group object) - creates it if necessary</summary>
		public virtual ORD_O04_TIMING_TRAY getTIMING_TRAY()
		{
			ORD_O04_TIMING_TRAY ret = null;
			try
			{
				ret = (ORD_O04_TIMING_TRAY) this.get_Renamed("TIMING_TRAY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORD_O04_TIMING_TRAY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORD_O04_TIMING_TRAY getTIMING_TRAY(int rep)
		{
			return (ORD_O04_TIMING_TRAY) this.get_Renamed("TIMING_TRAY", rep);
		}
