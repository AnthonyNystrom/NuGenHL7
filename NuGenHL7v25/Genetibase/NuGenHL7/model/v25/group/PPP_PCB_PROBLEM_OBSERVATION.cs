...
{
	/// <summary> <p>Represents the PPP_PCB_PROBLEM_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPP_PCB_PROBLEM_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_PROBLEM_OBSERVATION Group.</summary>
