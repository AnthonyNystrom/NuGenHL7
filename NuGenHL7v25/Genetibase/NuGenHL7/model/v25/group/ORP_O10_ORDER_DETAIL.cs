...
{
	/// <summary> <p>Represents the ORP_O10_ORDER_DETAIL Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: RXO (Pharmacy/Treatment Order) <b></b><br>
	/// 1: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 2: RXR (Pharmacy/Treatment Route) <b>repeating</b><br>
	/// 3: ORP_O10_COMPONENT (a Group object) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class ORP_O10_ORDER_DETAIL:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORP_O10_COMPONENT </summary>
		...
		/// <summary> Creates a new ORP_O10_ORDER_DETAIL Group.</summary>
		...
		/// <summary> Returns  first repetition of ORP_O10_COMPONENT (a Group object) - creates it if necessary</summary>
		public virtual ORP_O10_COMPONENT getCOMPONENT()
		{
		...
		/// <summary> Returns a specific repetition of ORP_O10_COMPONENT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORP_O10_COMPONENT getCOMPONENT(int rep)
		{
			return (ORP_O10_COMPONENT) this.get_Renamed("COMPONENT", rep);
		}
	}
}