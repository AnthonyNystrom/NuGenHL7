...
{
	/// <summary> <p>Represents the OML_O35_PATIENT Group.  A Group is an ordered collection of message 
	...
	/// 4: OML_O35_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 5: OML_O35_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class OML_O35_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns OML_O35_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OML_O35_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (OML_O35_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OML_O35_INSURANCE </summary>
		...
		/// <summary> Creates a new OML_O35_PATIENT Group.</summary>
		public OML_O35_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OML_O35_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OML_O35_INSURANCE getINSURANCE()
		{
			OML_O35_INSURANCE ret = null;
			try
			{
				ret = (OML_O35_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OML_O35_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O35_INSURANCE getINSURANCE(int rep)
		{
			return (OML_O35_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
