...
{
	/// <summary> <p>Represents the PRR_PC5_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PRR_PC5_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_PATIENT_VISIT Group.</summary>
		public PRR_PC5_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
