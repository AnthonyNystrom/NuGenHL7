...
{
	/// <summary> <p>Represents the OSR_Q06_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OSR_Q06_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OSR_Q06_TIMING Group.</summary>
		public OSR_Q06_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
