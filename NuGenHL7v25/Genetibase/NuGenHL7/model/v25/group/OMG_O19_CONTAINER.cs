...
{
	/// <summary> <p>Represents the OMG_O19_CONTAINER Group.  A Group is an ordered collection of message 
	...
	public class OMG_O19_CONTAINER:AbstractGroup
	{
		...
		/// <summary> Creates a new OMG_O19_CONTAINER Group.</summary>
		public OMG_O19_CONTAINER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
