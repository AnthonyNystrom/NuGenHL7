...
{
	/// <summary> <p>Represents the EAR_U08_SPECIMEN_CONTAINER Group.  A Group is an ordered collection of message 
	...
	public class EAR_U08_SPECIMEN_CONTAINER:AbstractGroup
	{
		...
		/// <summary> Creates a new EAR_U08_SPECIMEN_CONTAINER Group.</summary>
