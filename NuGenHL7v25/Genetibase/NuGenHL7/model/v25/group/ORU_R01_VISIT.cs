...
{
	/// <summary> <p>Represents the ORU_R01_VISIT Group.  A Group is an ordered collection of message 
	...
	public class ORU_R01_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new ORU_R01_VISIT Group.</summary>
		public ORU_R01_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
