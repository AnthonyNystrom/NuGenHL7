...
{
	/// <summary> <p>Represents the RRE_O12_TIMING_ENCODED Group.  A Group is an ordered collection of message 
	...
	public class RRE_O12_TIMING_ENCODED:AbstractGroup
	{
		...
		/// <summary> Creates a new RRE_O12_TIMING_ENCODED Group.</summary>
		public RRE_O12_TIMING_ENCODED(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
