...
{
	/// <summary> <p>Represents the RRI_I12_PROVIDER_CONTACT Group.  A Group is an ordered collection of message 
	...
	public class RRI_I12_PROVIDER_CONTACT:AbstractGroup
	{
		...
		/// <summary> Creates a new RRI_I12_PROVIDER_CONTACT Group.</summary>
		public RRI_I12_PROVIDER_CONTACT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
