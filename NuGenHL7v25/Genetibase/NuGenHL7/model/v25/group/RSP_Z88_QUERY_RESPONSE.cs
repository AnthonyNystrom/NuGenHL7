...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 0: RSP_Z88_PATIENT (a Group object) <b>optional </b><br>
	/// 1: RSP_Z88_COMMON_ORDER (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class RSP_Z88_QUERY_RESPONSE:AbstractGroup
	{
		/// <summary> Returns RSP_Z88_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public RSP_Z88_PATIENT PATIENT
		{
			get
			{
				...
				try
				{
					ret = (RSP_Z88_PATIENT) this.get_Renamed("PATIENT");
				}
