...
{
	/// <summary> <p>Represents the ORL_O34_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORL_O34_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORL_O34_TIMING Group.</summary>
		public ORL_O34_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
