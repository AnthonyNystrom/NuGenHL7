...
{
	/// <summary> <p>Represents the ORS_O06_RESPONSE Group.  A Group is an ordered collection of message 
	...
	public class ORS_O06_RESPONSE:AbstractGroup
	{
		...
		/// <summary> Creates a new ORS_O06_RESPONSE Group.</summary>
		public ORS_O06_RESPONSE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
