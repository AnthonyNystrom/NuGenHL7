...
{
	/// <summary> <p>Represents the ADR_A19_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class ADR_A19_INSURANCE:AbstractGroup
	{
		...
		public ADR_A19_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
