...
{
	/// <summary> <p>Represents the PPR_PC1_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPR_PC1_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_ORDER_OBSERVATION Group.</summary>
		public PPR_PC1_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
