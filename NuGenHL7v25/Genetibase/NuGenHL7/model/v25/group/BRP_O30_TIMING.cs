...
{
	/// <summary> <p>Represents the BRP_O30_TIMING Group.  A Group is an ordered collection of message 
	...
	public class BRP_O30_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new BRP_O30_TIMING Group.</summary>
		public BRP_O30_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
