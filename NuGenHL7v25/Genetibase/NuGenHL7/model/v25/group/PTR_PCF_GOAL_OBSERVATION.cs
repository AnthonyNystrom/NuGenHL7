...
{
	/// <summary> <p>Represents the PTR_PCF_GOAL_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PTR_PCF_GOAL_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_GOAL_OBSERVATION Group.</summary>
