...
{
	/// <summary> <p>Represents the OMP_O09_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OMP_O09_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OMP_O09_TIMING Group.</summary>
		public OMP_O09_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
