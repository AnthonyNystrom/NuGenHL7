...
{
	/// <summary> <p>Represents the OMD_O03_TIMING_TRAY Group.  A Group is an ordered collection of message 
	...
	public class OMD_O03_TIMING_TRAY:AbstractGroup
	{
		...
		/// <summary> Creates a new OMD_O03_TIMING_TRAY Group.</summary>
		public OMD_O03_TIMING_TRAY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
