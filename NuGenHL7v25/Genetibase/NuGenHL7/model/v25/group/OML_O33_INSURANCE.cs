...
{
	/// <summary> <p>Represents the OML_O33_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OML_O33_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O33_INSURANCE Group.</summary>
		public OML_O33_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
