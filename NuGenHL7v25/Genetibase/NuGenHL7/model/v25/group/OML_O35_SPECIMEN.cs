...
{
	/// <summary> <p>Represents the OML_O35_SPECIMEN Group.  A Group is an ordered collection of message 
	...
	public class OML_O35_SPECIMEN:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OML_O35_SPECIMEN_CONTAINER </summary>
		...
		/// <summary> Creates a new OML_O35_SPECIMEN Group.</summary>
		public OML_O35_SPECIMEN(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OML_O35_SPECIMEN_CONTAINER (a Group object) - creates it if necessary</summary>
		public virtual OML_O35_SPECIMEN_CONTAINER getSPECIMEN_CONTAINER()
		{
			OML_O35_SPECIMEN_CONTAINER ret = null;
			try
			{
				ret = (OML_O35_SPECIMEN_CONTAINER) this.get_Renamed("SPECIMEN_CONTAINER");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OML_O35_SPECIMEN_CONTAINER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O35_SPECIMEN_CONTAINER getSPECIMEN_CONTAINER(int rep)
		{
			return (OML_O35_SPECIMEN_CONTAINER) this.get_Renamed("SPECIMEN_CONTAINER", rep);
		}
	}
}