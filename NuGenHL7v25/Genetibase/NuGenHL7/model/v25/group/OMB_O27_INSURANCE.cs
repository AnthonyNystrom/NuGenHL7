...
{
	/// <summary> <p>Represents the OMB_O27_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OMB_O27_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OMB_O27_INSURANCE Group.</summary>
		public OMB_O27_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
