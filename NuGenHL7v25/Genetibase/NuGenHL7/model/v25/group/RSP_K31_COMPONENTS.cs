...
{
	/// <summary> <p>Represents the RSP_K31_COMPONENTS Group.  A Group is an ordered collection of message 
	...
	public class RSP_K31_COMPONENTS:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_K31_COMPONENTS Group.</summary>
		public RSP_K31_COMPONENTS(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
