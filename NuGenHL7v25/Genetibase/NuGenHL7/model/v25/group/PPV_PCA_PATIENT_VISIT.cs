...
{
	/// <summary> <p>Represents the PPV_PCA_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PPV_PCA_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_PATIENT_VISIT Group.</summary>
		public PPV_PCA_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
