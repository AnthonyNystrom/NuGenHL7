...
{
	/// <summary> <p>Represents the OUL_R23_RESULT Group.  A Group is an ordered collection of message 
	...
	public class OUL_R23_RESULT:AbstractGroup
	{
		...
		/// <summary> Creates a new OUL_R23_RESULT Group.</summary>
		public OUL_R23_RESULT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
