...
{
	/// <summary> <p>Represents the CSU_C09_TIMING_QTY Group.  A Group is an ordered collection of message 
	...
	public class CSU_C09_TIMING_QTY:AbstractGroup
	{
		...
		/// <summary> Creates a new CSU_C09_TIMING_QTY Group.</summary>
		public CSU_C09_TIMING_QTY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
