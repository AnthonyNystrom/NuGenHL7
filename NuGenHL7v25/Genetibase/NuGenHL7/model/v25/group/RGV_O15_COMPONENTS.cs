...
{
	/// <summary> <p>Represents the RGV_O15_COMPONENTS Group.  A Group is an ordered collection of message 
	...
	public class RGV_O15_COMPONENTS:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O15_COMPONENTS Group.</summary>
		public RGV_O15_COMPONENTS(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
