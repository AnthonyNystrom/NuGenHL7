...
{
	/// <summary> <p>Represents the OMD_O03_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OMD_O03_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OMD_O03_INSURANCE Group.</summary>
		public OMD_O03_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
