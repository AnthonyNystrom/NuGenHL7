...
{
	/// <summary> <p>Represents the DFT_P03_FINANCIAL_TIMING_QUANTITY Group.  A Group is an ordered collection of message 
	...
	public class DFT_P03_FINANCIAL_TIMING_QUANTITY:AbstractGroup
	{
		...
		public DFT_P03_FINANCIAL_TIMING_QUANTITY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
