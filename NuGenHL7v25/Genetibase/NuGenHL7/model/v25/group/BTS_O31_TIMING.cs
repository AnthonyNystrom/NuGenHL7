...
{
	/// <summary> <p>Represents the BTS_O31_TIMING Group.  A Group is an ordered collection of message 
	...
	public class BTS_O31_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new BTS_O31_TIMING Group.</summary>
		public BTS_O31_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
