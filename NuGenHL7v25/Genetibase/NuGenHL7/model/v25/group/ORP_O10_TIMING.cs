...
{
	/// <summary> <p>Represents the ORP_O10_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORP_O10_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORP_O10_TIMING Group.</summary>
		public ORP_O10_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
