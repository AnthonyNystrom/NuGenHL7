...
{
	/// <summary> <p>Represents the RRD_O14_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RRD_O14_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RRD_O14_TIMING Group.</summary>
		public RRD_O14_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
