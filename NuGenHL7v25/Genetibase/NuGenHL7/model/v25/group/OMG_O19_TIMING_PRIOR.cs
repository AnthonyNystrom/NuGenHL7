...
{
	/// <summary> <p>Represents the OMG_O19_TIMING_PRIOR Group.  A Group is an ordered collection of message 
	...
	public class OMG_O19_TIMING_PRIOR:AbstractGroup
	{
		...
		/// <summary> Creates a new OMG_O19_TIMING_PRIOR Group.</summary>
		public OMG_O19_TIMING_PRIOR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
