...
{
	/// <summary> <p>Represents the RGV_O15_TIMING_GIVE Group.  A Group is an ordered collection of message 
	...
	public class RGV_O15_TIMING_GIVE:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O15_TIMING_GIVE Group.</summary>
		public RGV_O15_TIMING_GIVE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
