...
{
	/// <summary> <p>Represents the PPV_PCA_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPV_PCA_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_ORDER_OBSERVATION Group.</summary>
		public PPV_PCA_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
