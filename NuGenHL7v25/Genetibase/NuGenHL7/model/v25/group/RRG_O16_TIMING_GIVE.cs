...
{
	/// <summary> <p>Represents the RRG_O16_TIMING_GIVE Group.  A Group is an ordered collection of message 
	...
	public class RRG_O16_TIMING_GIVE:AbstractGroup
	{
		...
		/// <summary> Creates a new RRG_O16_TIMING_GIVE Group.</summary>
		public RRG_O16_TIMING_GIVE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
