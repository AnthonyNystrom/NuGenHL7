...
{
	/// <summary> <p>Represents the PTR_PCF_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PTR_PCF_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_PATIENT_VISIT Group.</summary>
		public PTR_PCF_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
