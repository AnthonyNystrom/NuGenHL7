...
{
	/// <summary> <p>Represents the PTR_PCF_PATHWAY Group.  A Group is an ordered collection of message 
	...
	public class PTR_PCF_PATHWAY:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PTR_PCF_PATHWAY_ROLE </summary>
		...
		/// <summary> Returns the number of existing repetitions of PTR_PCF_PROBLEM </summary>
		...
		/// <summary> Creates a new PTR_PCF_PATHWAY Group.</summary>
		...
		/// <summary> Returns  first repetition of PTR_PCF_PATHWAY_ROLE (a Group object) - creates it if necessary</summary>
		public virtual PTR_PCF_PATHWAY_ROLE getPATHWAY_ROLE()
		{
		...
		/// <summary> Returns a specific repetition of PTR_PCF_PATHWAY_ROLE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PTR_PCF_PATHWAY_ROLE getPATHWAY_ROLE(int rep)
		{
			return (PTR_PCF_PATHWAY_ROLE) this.get_Renamed("PATHWAY_ROLE", rep);
		}
		
		/// <summary> Returns  first repetition of PTR_PCF_PROBLEM (a Group object) - creates it if necessary</summary>
		public virtual PTR_PCF_PROBLEM getPROBLEM()
		{
		...
		/// <summary> Returns a specific repetition of PTR_PCF_PROBLEM
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PTR_PCF_PROBLEM getPROBLEM(int rep)
		{
