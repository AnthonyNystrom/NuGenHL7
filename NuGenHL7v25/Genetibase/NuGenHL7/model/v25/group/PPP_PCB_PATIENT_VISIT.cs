...
{
	/// <summary> <p>Represents the PPP_PCB_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PPP_PCB_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_PATIENT_VISIT Group.</summary>
		public PPP_PCB_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
