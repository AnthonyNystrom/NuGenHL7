...
{
	/// <summary> <p>Represents the RGV_O15_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RGV_O15_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O15_TIMING Group.</summary>
		public RGV_O15_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
