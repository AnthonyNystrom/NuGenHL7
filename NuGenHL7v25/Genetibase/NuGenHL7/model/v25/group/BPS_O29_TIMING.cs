...
{
	/// <summary> <p>Represents the BPS_O29_TIMING Group.  A Group is an ordered collection of message 
	...
	public class BPS_O29_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new BPS_O29_TIMING Group.</summary>
		public BPS_O29_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
