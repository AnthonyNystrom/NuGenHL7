...
{
	/// <summary> <p>Represents the OUL_R23_CONTAINER Group.  A Group is an ordered collection of message 
	...
	public class OUL_R23_CONTAINER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OUL_R23_ORDER </summary>
		...
		/// <summary> Creates a new OUL_R23_CONTAINER Group.</summary>
		...
		/// <summary> Returns  first repetition of OUL_R23_ORDER (a Group object) - creates it if necessary</summary>
		public virtual OUL_R23_ORDER getORDER()
		{
		...
		/// <summary> Returns a specific repetition of OUL_R23_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OUL_R23_ORDER getORDER(int rep)
		{
