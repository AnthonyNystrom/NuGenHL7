...
{
	/// <summary> <p>Represents the ORN_O08_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORN_O08_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORN_O08_TIMING Group.</summary>
		public ORN_O08_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
