...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	public class OML_O21_OBSERVATION_REQUEST:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OML_O21_SPECIMEN </summary>
		...
		/// <summary> Returns  first repetition of OML_O21_SPECIMEN (a Group object) - creates it if necessary</summary>
		public virtual OML_O21_SPECIMEN getSPECIMEN()
		{
		...
		/// <summary> Returns a specific repetition of OML_O21_SPECIMEN
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O21_SPECIMEN getSPECIMEN(int rep)
		{
			return (OML_O21_SPECIMEN) this.get_Renamed("SPECIMEN", rep);
		}
