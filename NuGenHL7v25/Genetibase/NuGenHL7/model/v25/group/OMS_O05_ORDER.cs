...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 1: OMS_O05_TIMING (a Group object) <b>optional repeating</b><br>
	...
	/// 5: OMS_O05_OBSERVATION (a Group object) <b>optional repeating</b><br>
	...
	public class OMS_O05_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OMS_O05_TIMING </summary>
		...
		/// <summary> Returns  first repetition of OMS_O05_TIMING (a Group object) - creates it if necessary</summary>
		public virtual OMS_O05_TIMING getTIMING()
		{
		...
		/// <summary> Returns a specific repetition of OMS_O05_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMS_O05_TIMING getTIMING(int rep)
		{
			return (OMS_O05_TIMING) this.get_Renamed("TIMING", rep);
		}
