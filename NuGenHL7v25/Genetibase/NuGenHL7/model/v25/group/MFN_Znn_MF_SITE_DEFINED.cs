...
{
	/// <summary> <p>Represents the MFN_Znn_MF_SITE_DEFINED Group.  A Group is an ordered collection of message 
	...
	public class MFN_Znn_MF_SITE_DEFINED:AbstractGroup
	{
		...
		/// <summary> Creates a new MFN_Znn_MF_SITE_DEFINED Group.</summary>
