...
{
	/// <summary> <p>Represents the VXU_V04_TIMING Group.  A Group is an ordered collection of message 
	...
	public class VXU_V04_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new VXU_V04_TIMING Group.</summary>
		public VXU_V04_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
