...
{
	/// <summary> <p>Represents the MDM_T01_TIMING Group.  A Group is an ordered collection of message 
	...
	public class MDM_T01_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new MDM_T01_TIMING Group.</summary>
		public MDM_T01_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
