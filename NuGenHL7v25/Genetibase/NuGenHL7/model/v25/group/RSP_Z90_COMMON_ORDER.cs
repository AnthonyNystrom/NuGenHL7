...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	public class RSP_Z90_COMMON_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_Z90_TIMING </summary>
		...
		/// <summary> Returns  first repetition of RSP_Z90_TIMING (a Group object) - creates it if necessary</summary>
		public virtual RSP_Z90_TIMING getTIMING()
		{
			RSP_Z90_TIMING ret = null;
			try
			{
				ret = (RSP_Z90_TIMING) this.get_Renamed("TIMING");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RSP_Z90_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_Z90_TIMING getTIMING(int rep)
		{
			return (RSP_Z90_TIMING) this.get_Renamed("TIMING", rep);
		}
