...
{
	/// <summary> <p>Represents the OUL_R21_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class OUL_R21_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new OUL_R21_OBSERVATION Group.</summary>
		public OUL_R21_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
