...
{
	/// <summary> <p>Represents the ORF_R04_TIMING_QTY Group.  A Group is an ordered collection of message 
	...
	public class ORF_R04_TIMING_QTY:AbstractGroup
	{
		...
		/// <summary> Creates a new ORF_R04_TIMING_QTY Group.</summary>
		public ORF_R04_TIMING_QTY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
