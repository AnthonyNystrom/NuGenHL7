...
{
	/// <summary> <p>Represents the RQP_I04_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RQP_I04_PROVIDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RQP_I04_PROVIDER Group.</summary>
		public RQP_I04_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
