...
{
	/// <summary> <p>Represents the PPG_PCG_PATHWAY_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPG_PCG_PATHWAY_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_PATHWAY_ROLE Group.</summary>
