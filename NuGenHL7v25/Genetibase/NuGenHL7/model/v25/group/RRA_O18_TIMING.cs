...
{
	/// <summary> <p>Represents the RRA_O18_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RRA_O18_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RRA_O18_TIMING Group.</summary>
		public RRA_O18_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
