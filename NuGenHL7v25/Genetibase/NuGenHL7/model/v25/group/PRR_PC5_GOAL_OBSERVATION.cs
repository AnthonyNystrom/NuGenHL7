...
{
	/// <summary> <p>Represents the PRR_PC5_GOAL_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PRR_PC5_GOAL_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_GOAL_OBSERVATION Group.</summary>
