...
{
	/// <summary> <p>Represents the PTR_PCF_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PTR_PCF_PROBLEM_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_PROBLEM_ROLE Group.</summary>
		public PTR_PCF_PROBLEM_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
