...
{
	/// <summary> <p>Represents the OML_O35_PATIENT_VISIT_PRIOR Group.  A Group is an ordered collection of message 
	...
	public class OML_O35_PATIENT_VISIT_PRIOR:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O35_PATIENT_VISIT_PRIOR Group.</summary>
		public OML_O35_PATIENT_VISIT_PRIOR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
