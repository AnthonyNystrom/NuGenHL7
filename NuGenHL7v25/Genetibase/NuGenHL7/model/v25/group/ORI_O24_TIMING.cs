...
{
	/// <summary> <p>Represents the ORI_O24_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORI_O24_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORI_O24_TIMING Group.</summary>
		public ORI_O24_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
