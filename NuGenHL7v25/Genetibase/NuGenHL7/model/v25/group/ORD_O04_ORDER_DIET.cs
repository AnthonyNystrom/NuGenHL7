...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	public class ORD_O04_ORDER_DIET:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORD_O04_TIMING_DIET </summary>
		...
		/// <summary> Returns  first repetition of ORD_O04_TIMING_DIET (a Group object) - creates it if necessary</summary>
		public virtual ORD_O04_TIMING_DIET getTIMING_DIET()
		{
		...
		/// <summary> Returns a specific repetition of ORD_O04_TIMING_DIET
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORD_O04_TIMING_DIET getTIMING_DIET(int rep)
		{
			return (ORD_O04_TIMING_DIET) this.get_Renamed("TIMING_DIET", rep);
		}
