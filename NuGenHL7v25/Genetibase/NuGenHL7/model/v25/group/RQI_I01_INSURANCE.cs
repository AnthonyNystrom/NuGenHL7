...
{
	/// <summary> <p>Represents the RQI_I01_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class RQI_I01_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new RQI_I01_INSURANCE Group.</summary>
		public RQI_I01_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
