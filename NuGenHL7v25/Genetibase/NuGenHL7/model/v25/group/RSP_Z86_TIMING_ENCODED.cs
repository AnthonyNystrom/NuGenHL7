...
{
	/// <summary> <p>Represents the RSP_Z86_TIMING_ENCODED Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z86_TIMING_ENCODED:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z86_TIMING_ENCODED Group.</summary>
		public RSP_Z86_TIMING_ENCODED(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
