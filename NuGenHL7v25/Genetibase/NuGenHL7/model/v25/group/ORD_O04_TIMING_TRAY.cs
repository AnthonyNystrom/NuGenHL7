...
{
	/// <summary> <p>Represents the ORD_O04_TIMING_TRAY Group.  A Group is an ordered collection of message 
	...
	public class ORD_O04_TIMING_TRAY:AbstractGroup
	{
		...
		/// <summary> Creates a new ORD_O04_TIMING_TRAY Group.</summary>
		public ORD_O04_TIMING_TRAY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
