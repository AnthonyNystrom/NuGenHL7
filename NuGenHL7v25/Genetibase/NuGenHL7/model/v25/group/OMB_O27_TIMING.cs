...
{
	/// <summary> <p>Represents the OMB_O27_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OMB_O27_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OMB_O27_TIMING Group.</summary>
		public OMB_O27_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
