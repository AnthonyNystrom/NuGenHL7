...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 1: DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) <b>optional repeating</b><br>
	/// 2: DFT_P03_FINANCIAL_ORDER (a Group object) <b>optional </b><br>
	/// 3: DFT_P03_FINANCIAL_OBSERVATION (a Group object) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class DFT_P03_FINANCIAL_COMMON_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of DFT_P03_FINANCIAL_TIMING_QUANTITY </summary>
		...
		/// <summary> Returns  first repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY (a Group object) - creates it if necessary</summary>
		public virtual DFT_P03_FINANCIAL_TIMING_QUANTITY getFINANCIAL_TIMING_QUANTITY()
		{
			DFT_P03_FINANCIAL_TIMING_QUANTITY ret = null;
			try
			{
				ret = (DFT_P03_FINANCIAL_TIMING_QUANTITY) this.get_Renamed("FINANCIAL_TIMING_QUANTITY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of DFT_P03_FINANCIAL_TIMING_QUANTITY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P03_FINANCIAL_TIMING_QUANTITY getFINANCIAL_TIMING_QUANTITY(int rep)
		{
			return (DFT_P03_FINANCIAL_TIMING_QUANTITY) this.get_Renamed("FINANCIAL_TIMING_QUANTITY", rep);
		}
