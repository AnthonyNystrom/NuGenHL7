...
{
	/// <summary> <p>Represents the RDE_O11_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RDE_O11_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O11_PATIENT_VISIT Group.</summary>
		public RDE_O11_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
