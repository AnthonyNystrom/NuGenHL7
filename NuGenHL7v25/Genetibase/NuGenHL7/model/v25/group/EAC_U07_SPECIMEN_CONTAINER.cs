...
{
	/// <summary> <p>Represents the EAC_U07_SPECIMEN_CONTAINER Group.  A Group is an ordered collection of message 
	...
	public class EAC_U07_SPECIMEN_CONTAINER:AbstractGroup
	{
		...
		/// <summary> Creates a new EAC_U07_SPECIMEN_CONTAINER Group.</summary>
