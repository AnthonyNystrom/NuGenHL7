...
{
	/// <summary> <p>Represents the OMI_O23_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OMI_O23_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OMI_O23_TIMING Group.</summary>
		public OMI_O23_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
