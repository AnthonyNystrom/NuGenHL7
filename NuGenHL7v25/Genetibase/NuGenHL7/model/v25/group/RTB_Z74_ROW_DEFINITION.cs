...
{
	/// <summary> <p>Represents the RTB_Z74_ROW_DEFINITION Group.  A Group is an ordered collection of message 
	...
	public class RTB_Z74_ROW_DEFINITION:AbstractGroup
	{
		...
		/// <summary> Creates a new RTB_Z74_ROW_DEFINITION Group.</summary>
