...
{
	/// <summary> <p>Represents the RSP_K11_ROW_DEFINITION Group.  A Group is an ordered collection of message 
	...
	public class RSP_K11_ROW_DEFINITION:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_K11_ROW_DEFINITION Group.</summary>
		public RSP_K11_ROW_DEFINITION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
