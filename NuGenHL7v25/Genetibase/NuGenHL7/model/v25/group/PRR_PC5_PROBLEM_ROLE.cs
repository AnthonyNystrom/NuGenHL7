...
{
	/// <summary> <p>Represents the PRR_PC5_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PRR_PC5_PROBLEM_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_PROBLEM_ROLE Group.</summary>
		public PRR_PC5_PROBLEM_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
