...
{
	/// <summary> <p>Represents the ORU_R30_VISIT Group.  A Group is an ordered collection of message 
	...
	public class ORU_R30_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new ORU_R30_VISIT Group.</summary>
		public ORU_R30_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
