...
{
	/// <summary> <p>Represents the RGV_O15_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RGV_O15_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O15_PATIENT_VISIT Group.</summary>
		public RGV_O15_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
