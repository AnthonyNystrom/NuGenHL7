...
{
	/// <summary> <p>Represents the RDS_O13_PATIENT Group.  A Group is an ordered collection of message 
	...
	/// 4: RDS_O13_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RDS_O13_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns RDS_O13_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public RDS_O13_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (RDS_O13_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RDS_O13_PATIENT Group.</summary>
		public RDS_O13_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
