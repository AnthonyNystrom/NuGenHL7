...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 3: ORF_R04_TIMING_QTY (a Group object) <b>optional repeating</b><br>
	/// 4: CTD (Contact Data) <b>optional </b><br>
	/// 5: ORF_R04_OBSERVATION (a Group object) <b>repeating</b><br>
	...
	public class ORF_R04_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORF_R04_TIMING_QTY </summary>
		...
		/// <summary> Returns  first repetition of ORF_R04_TIMING_QTY (a Group object) - creates it if necessary</summary>
		public virtual ORF_R04_TIMING_QTY getTIMING_QTY()
		{
			ORF_R04_TIMING_QTY ret = null;
			try
			{
				ret = (ORF_R04_TIMING_QTY) this.get_Renamed("TIMING_QTY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORF_R04_TIMING_QTY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORF_R04_TIMING_QTY getTIMING_QTY(int rep)
		{
			return (ORF_R04_TIMING_QTY) this.get_Renamed("TIMING_QTY", rep);
		}
