...
{
	/// <summary> <p>Represents the RRG_O16_GIVE Group.  A Group is an ordered collection of message 
	...
	public class RRG_O16_GIVE:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RRG_O16_TIMING_GIVE </summary>
		...
		/// <summary> Returns  first repetition of RRG_O16_TIMING_GIVE (a Group object) - creates it if necessary</summary>
		public virtual RRG_O16_TIMING_GIVE getTIMING_GIVE()
		{
		...
		/// <summary> Returns a specific repetition of RRG_O16_TIMING_GIVE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRG_O16_TIMING_GIVE getTIMING_GIVE(int rep)
		{
