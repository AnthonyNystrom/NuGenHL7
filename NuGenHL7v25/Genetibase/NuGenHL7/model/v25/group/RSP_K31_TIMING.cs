...
{
	/// <summary> <p>Represents the RSP_K31_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RSP_K31_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_K31_TIMING Group.</summary>
		public RSP_K31_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
