...
{
	/// <summary> <p>Represents the ORU_R01_TIMING_QTY Group.  A Group is an ordered collection of message 
	...
	public class ORU_R01_TIMING_QTY:AbstractGroup
	{
		...
		/// <summary> Creates a new ORU_R01_TIMING_QTY Group.</summary>
		public ORU_R01_TIMING_QTY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
