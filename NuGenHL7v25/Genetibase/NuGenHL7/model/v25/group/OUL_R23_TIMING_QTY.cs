...
{
	/// <summary> <p>Represents the OUL_R23_TIMING_QTY Group.  A Group is an ordered collection of message 
	...
	public class OUL_R23_TIMING_QTY:AbstractGroup
	{
		...
		/// <summary> Creates a new OUL_R23_TIMING_QTY Group.</summary>
		public OUL_R23_TIMING_QTY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
