...
{
	/// <summary> <p>Represents the ORL_O22_SPECIMEN Group.  A Group is an ordered collection of message 
	...
	public class ORL_O22_SPECIMEN:AbstractGroup
	{
		...
		/// <summary> Creates a new ORL_O22_SPECIMEN Group.</summary>
		public ORL_O22_SPECIMEN(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
