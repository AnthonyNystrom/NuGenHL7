...
{
	/// <summary> <p>Represents the OMB_O27_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OMB_O27_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OMB_O27_PATIENT_VISIT Group.</summary>
		public OMB_O27_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
