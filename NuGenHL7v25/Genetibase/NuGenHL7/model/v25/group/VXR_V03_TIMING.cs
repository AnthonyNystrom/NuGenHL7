...
{
	/// <summary> <p>Represents the VXR_V03_TIMING Group.  A Group is an ordered collection of message 
	...
	public class VXR_V03_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new VXR_V03_TIMING Group.</summary>
		public VXR_V03_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
