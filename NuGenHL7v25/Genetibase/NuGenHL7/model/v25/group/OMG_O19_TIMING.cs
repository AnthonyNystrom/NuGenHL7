...
{
	/// <summary> <p>Represents the OMG_O19_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OMG_O19_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OMG_O19_TIMING Group.</summary>
		public OMG_O19_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
