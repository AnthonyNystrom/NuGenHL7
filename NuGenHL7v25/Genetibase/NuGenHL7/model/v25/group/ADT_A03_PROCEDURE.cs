...
{
	/// <summary> <p>Represents the ADT_A03_PROCEDURE Group.  A Group is an ordered collection of message 
	...
	public class ADT_A03_PROCEDURE:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A03_PROCEDURE Group.</summary>
		public ADT_A03_PROCEDURE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
