...
{
	/// <summary> <p>Represents the RSP_K31_ORDER Group.  A Group is an ordered collection of message 
	...
	public class RSP_K31_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_K31_TIMING </summary>
		...
		/// <summary> Returns RSP_K31_ORDER_DETAIL (a Group object) - creates it if necessary</summary>
		virtual public RSP_K31_ORDER_DETAIL ORDER_DETAIL
		{
			get
			{
		...
		/// <summary> Returns RSP_K31_ENCODING (a Group object) - creates it if necessary</summary>
		virtual public RSP_K31_ENCODING ENCODING
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of RSP_K31_OBSERVATION </summary>
		...
		/// <summary> Creates a new RSP_K31_ORDER Group.</summary>
		...
		/// <summary> Returns  first repetition of RSP_K31_TIMING (a Group object) - creates it if necessary</summary>
		public virtual RSP_K31_TIMING getTIMING()
		{
		...
		/// <summary> Returns a specific repetition of RSP_K31_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_K31_TIMING getTIMING(int rep)
		{
			return (RSP_K31_TIMING) this.get_Renamed("TIMING", rep);
		}
		...
		/// <summary> Returns  first repetition of RSP_K31_OBSERVATION (a Group object) - creates it if necessary</summary>
		public virtual RSP_K31_OBSERVATION getOBSERVATION()
		{
		...
		/// <summary> Returns a specific repetition of RSP_K31_OBSERVATION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_K31_OBSERVATION getOBSERVATION(int rep)
		{
