...
{
	/// <summary> <p>Represents the RDE_O11_TIMING_ENCODED Group.  A Group is an ordered collection of message 
	...
	public class RDE_O11_TIMING_ENCODED:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O11_TIMING_ENCODED Group.</summary>
		public RDE_O11_TIMING_ENCODED(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
