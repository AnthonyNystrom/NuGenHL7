...
{
	/// <summary> <p>Represents the RSP_Z88_ORDER_ENCODED Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: RXE (Pharmacy/Treatment Encoded Order) <b></b><br>
	/// 1: RSP_Z88_TIMING_ENCODED (a Group object) <b>optional repeating</b><br>
	...
	public class RSP_Z88_ORDER_ENCODED:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_Z88_TIMING_ENCODED </summary>
		...
		/// <summary> Creates a new RSP_Z88_ORDER_ENCODED Group.</summary>
		public RSP_Z88_ORDER_ENCODED(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of RSP_Z88_TIMING_ENCODED (a Group object) - creates it if necessary</summary>
		public virtual RSP_Z88_TIMING_ENCODED getTIMING_ENCODED()
		{
			RSP_Z88_TIMING_ENCODED ret = null;
			try
			{
				ret = (RSP_Z88_TIMING_ENCODED) this.get_Renamed("TIMING_ENCODED");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RSP_Z88_TIMING_ENCODED
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_Z88_TIMING_ENCODED getTIMING_ENCODED(int rep)
		{
			return (RSP_Z88_TIMING_ENCODED) this.get_Renamed("TIMING_ENCODED", rep);
		}
