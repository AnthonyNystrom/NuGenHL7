...
{
	/// <summary> <p>Represents the RPA_I08_AUTHORIZATION_2 Group.  A Group is an ordered collection of message 
	...
	public class RPA_I08_AUTHORIZATION_2:AbstractGroup
	{
		...
		/// <summary> Creates a new RPA_I08_AUTHORIZATION_2 Group.</summary>
		public RPA_I08_AUTHORIZATION_2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
