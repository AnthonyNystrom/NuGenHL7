...
{
	/// <summary> <p>Represents the OML_O35_ORDER Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: ORC (Common Order) <b></b><br>
	/// 1: OML_O35_TIIMING (a Group object) <b>optional repeating</b><br>
	/// 2: OML_O35_OBSERVATION_REQUEST (a Group object) <b>optional </b><br>
	...
	public class OML_O35_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OML_O35_TIIMING </summary>
		...
		/// <summary> Returns OML_O35_OBSERVATION_REQUEST (a Group object) - creates it if necessary</summary>
		virtual public OML_O35_OBSERVATION_REQUEST OBSERVATION_REQUEST
		{
			get
			{
				...
				try
				{
					ret = (OML_O35_OBSERVATION_REQUEST) this.get_Renamed("OBSERVATION_REQUEST");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new OML_O35_ORDER Group.</summary>
		public OML_O35_ORDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OML_O35_TIIMING (a Group object) - creates it if necessary</summary>
		public virtual OML_O35_TIIMING getTIIMING()
		{
			OML_O35_TIIMING ret = null;
			try
			{
				ret = (OML_O35_TIIMING) this.get_Renamed("TIIMING");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OML_O35_TIIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O35_TIIMING getTIIMING(int rep)
		{
			return (OML_O35_TIIMING) this.get_Renamed("TIIMING", rep);
		}
