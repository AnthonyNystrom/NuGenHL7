...
{
	/// <summary> <p>Represents the RAS_O17_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RAS_O17_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RAS_O17_TIMING Group.</summary>
		public RAS_O17_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
