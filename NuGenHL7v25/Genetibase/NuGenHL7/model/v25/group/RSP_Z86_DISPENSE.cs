...
{
	/// <summary> <p>Represents the RSP_Z86_DISPENSE Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z86_DISPENSE:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z86_DISPENSE Group.</summary>
		public RSP_Z86_DISPENSE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
