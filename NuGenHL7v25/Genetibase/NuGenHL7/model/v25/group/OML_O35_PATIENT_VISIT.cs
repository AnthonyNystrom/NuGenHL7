...
{
	/// <summary> <p>Represents the OML_O35_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OML_O35_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O35_PATIENT_VISIT Group.</summary>
		public OML_O35_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
