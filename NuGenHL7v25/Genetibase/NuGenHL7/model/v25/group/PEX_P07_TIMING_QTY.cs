...
{
	/// <summary> <p>Represents the PEX_P07_TIMING_QTY Group.  A Group is an ordered collection of message 
	...
	public class PEX_P07_TIMING_QTY:AbstractGroup
	{
		...
		/// <summary> Creates a new PEX_P07_TIMING_QTY Group.</summary>
		public PEX_P07_TIMING_QTY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
