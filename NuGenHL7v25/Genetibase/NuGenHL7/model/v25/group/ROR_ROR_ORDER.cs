...
{
	/// <summary> <p>Represents the ROR_ROR_ORDER Group.  A Group is an ordered collection of message 
	...
	public class ROR_ROR_ORDER:AbstractGroup
	{
		...
		/// <summary> Creates a new ROR_ROR_ORDER Group.</summary>
		public ROR_ROR_ORDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
