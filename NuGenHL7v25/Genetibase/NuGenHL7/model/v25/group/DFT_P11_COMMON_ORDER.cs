...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	public class DFT_P11_COMMON_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of DFT_P11_TIMING_QUANTITY </summary>
		...
		/// <summary> Returns  first repetition of DFT_P11_TIMING_QUANTITY (a Group object) - creates it if necessary</summary>
		public virtual DFT_P11_TIMING_QUANTITY getTIMING_QUANTITY()
		{
		...
		/// <summary> Returns a specific repetition of DFT_P11_TIMING_QUANTITY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual DFT_P11_TIMING_QUANTITY getTIMING_QUANTITY(int rep)
		{
			return (DFT_P11_TIMING_QUANTITY) this.get_Renamed("TIMING_QUANTITY", rep);
		}
