...
{
	/// <summary> <p>Represents the PEX_P07_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PEX_P07_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PEX_P07_VISIT Group.</summary>
		public PEX_P07_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
