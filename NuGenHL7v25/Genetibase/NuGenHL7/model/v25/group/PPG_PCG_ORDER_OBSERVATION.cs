...
{
	/// <summary> <p>Represents the PPG_PCG_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPG_PCG_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_ORDER_OBSERVATION Group.</summary>
		public PPG_PCG_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
