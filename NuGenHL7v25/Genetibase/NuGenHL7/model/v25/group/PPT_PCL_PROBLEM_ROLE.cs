...
{
	/// <summary> <p>Represents the PPT_PCL_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPT_PCL_PROBLEM_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_PROBLEM_ROLE Group.</summary>
