...
{
	/// <summary> <p>Represents the PPT_PCL_GOAL_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPT_PCL_GOAL_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_GOAL_OBSERVATION Group.</summary>
