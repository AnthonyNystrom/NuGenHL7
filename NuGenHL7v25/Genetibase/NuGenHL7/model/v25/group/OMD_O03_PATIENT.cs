...
{
	/// <summary> <p>Represents the OMD_O03_PATIENT Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: PID (Patient Identification) <b></b><br>
	/// 1: PD1 (Patient Additional Demographic) <b>optional </b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: OMD_O03_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 4: OMD_O03_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class OMD_O03_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns OMD_O03_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OMD_O03_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (OMD_O03_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OMD_O03_INSURANCE </summary>
		...
		/// <summary> Creates a new OMD_O03_PATIENT Group.</summary>
		public OMD_O03_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OMD_O03_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OMD_O03_INSURANCE getINSURANCE()
		{
			OMD_O03_INSURANCE ret = null;
			try
			{
				ret = (OMD_O03_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OMD_O03_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMD_O03_INSURANCE getINSURANCE(int rep)
		{
			return (OMD_O03_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
