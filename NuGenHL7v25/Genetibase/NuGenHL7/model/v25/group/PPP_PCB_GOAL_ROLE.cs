...
{
	/// <summary> <p>Represents the PPP_PCB_GOAL_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPP_PCB_GOAL_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_GOAL_ROLE Group.</summary>
		public PPP_PCB_GOAL_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
