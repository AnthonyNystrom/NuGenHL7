...
{
	/// <summary> <p>Represents the BRT_O32_TIMING Group.  A Group is an ordered collection of message 
	...
	public class BRT_O32_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new BRT_O32_TIMING Group.</summary>
		public BRT_O32_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
