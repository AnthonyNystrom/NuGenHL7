...
{
	/// <summary> <p>Represents the RSP_Z82_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z82_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z82_TIMING Group.</summary>
		public RSP_Z82_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
