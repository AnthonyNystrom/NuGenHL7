...
{
	/// <summary> <p>Represents the RAS_O17_TIMING_ENCODED Group.  A Group is an ordered collection of message 
	...
	public class RAS_O17_TIMING_ENCODED:AbstractGroup
	{
		...
		/// <summary> Creates a new RAS_O17_TIMING_ENCODED Group.</summary>
		public RAS_O17_TIMING_ENCODED(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
