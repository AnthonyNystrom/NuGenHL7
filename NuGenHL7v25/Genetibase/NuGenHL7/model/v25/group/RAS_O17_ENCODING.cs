...
{
	/// <summary> <p>Represents the RAS_O17_ENCODING Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: RXE (Pharmacy/Treatment Encoded Order) <b></b><br>
	/// 1: RAS_O17_TIMING_ENCODED (a Group object) <b>repeating</b><br>
	...
	public class RAS_O17_ENCODING:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RAS_O17_TIMING_ENCODED </summary>
		...
		/// <summary> Creates a new RAS_O17_ENCODING Group.</summary>
		public RAS_O17_ENCODING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of RAS_O17_TIMING_ENCODED (a Group object) - creates it if necessary</summary>
		public virtual RAS_O17_TIMING_ENCODED getTIMING_ENCODED()
		{
			RAS_O17_TIMING_ENCODED ret = null;
			try
			{
				ret = (RAS_O17_TIMING_ENCODED) this.get_Renamed("TIMING_ENCODED");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RAS_O17_TIMING_ENCODED
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RAS_O17_TIMING_ENCODED getTIMING_ENCODED(int rep)
		{
			return (RAS_O17_TIMING_ENCODED) this.get_Renamed("TIMING_ENCODED", rep);
		}
