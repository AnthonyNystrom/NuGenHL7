...
{
	/// <summary> <p>Represents the PEX_P07_RX_ORDER Group.  A Group is an ordered collection of message 
	...
	public class PEX_P07_RX_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PEX_P07_TIMING_QTY </summary>
		...
		/// <summary> Creates a new PEX_P07_RX_ORDER Group.</summary>
		...
		/// <summary> Returns  first repetition of PEX_P07_TIMING_QTY (a Group object) - creates it if necessary</summary>
		public virtual PEX_P07_TIMING_QTY getTIMING_QTY()
		{
			PEX_P07_TIMING_QTY ret = null;
			try
			{
				ret = (PEX_P07_TIMING_QTY) this.get_Renamed("TIMING_QTY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of PEX_P07_TIMING_QTY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PEX_P07_TIMING_QTY getTIMING_QTY(int rep)
		{
			return (PEX_P07_TIMING_QTY) this.get_Renamed("TIMING_QTY", rep);
		}
