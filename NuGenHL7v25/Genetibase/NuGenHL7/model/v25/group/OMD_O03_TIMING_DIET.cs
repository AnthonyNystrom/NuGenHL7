...
{
	/// <summary> <p>Represents the OMD_O03_TIMING_DIET Group.  A Group is an ordered collection of message 
	...
	public class OMD_O03_TIMING_DIET:AbstractGroup
	{
		...
		/// <summary> Creates a new OMD_O03_TIMING_DIET Group.</summary>
		public OMD_O03_TIMING_DIET(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
