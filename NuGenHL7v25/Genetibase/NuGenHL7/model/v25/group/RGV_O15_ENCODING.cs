...
{
	/// <summary> <p>Represents the RGV_O15_ENCODING Group.  A Group is an ordered collection of message 
	...
	public class RGV_O15_ENCODING:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RGV_O15_TIMING_ENCODED </summary>
		...
		/// <summary> Creates a new RGV_O15_ENCODING Group.</summary>
		...
		/// <summary> Returns  first repetition of RGV_O15_TIMING_ENCODED (a Group object) - creates it if necessary</summary>
		public virtual RGV_O15_TIMING_ENCODED getTIMING_ENCODED()
		{
		...
		/// <summary> Returns a specific repetition of RGV_O15_TIMING_ENCODED
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RGV_O15_TIMING_ENCODED getTIMING_ENCODED(int rep)
		{
