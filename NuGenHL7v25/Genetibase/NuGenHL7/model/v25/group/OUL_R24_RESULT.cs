...
{
	/// <summary> <p>Represents the OUL_R24_RESULT Group.  A Group is an ordered collection of message 
	...
	public class OUL_R24_RESULT:AbstractGroup
	{
		...
		/// <summary> Creates a new OUL_R24_RESULT Group.</summary>
		public OUL_R24_RESULT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
