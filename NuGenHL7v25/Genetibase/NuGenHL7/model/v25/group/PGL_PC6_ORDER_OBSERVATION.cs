...
{
	/// <summary> <p>Represents the PGL_PC6_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_ORDER_OBSERVATION Group.</summary>
