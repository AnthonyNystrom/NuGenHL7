...
{
	/// <summary> <p>Represents the OMI_O23_PATIENT Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: PID (Patient Identification) <b></b><br>
	/// 1: PD1 (Patient Additional Demographic) <b>optional </b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: OMI_O23_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 4: OMI_O23_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class OMI_O23_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns OMI_O23_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OMI_O23_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (OMI_O23_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OMI_O23_INSURANCE </summary>
		...
		/// <summary> Creates a new OMI_O23_PATIENT Group.</summary>
		public OMI_O23_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OMI_O23_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual OMI_O23_INSURANCE getINSURANCE()
		{
			OMI_O23_INSURANCE ret = null;
			try
			{
				ret = (OMI_O23_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OMI_O23_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMI_O23_INSURANCE getINSURANCE(int rep)
		{
			return (OMI_O23_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
