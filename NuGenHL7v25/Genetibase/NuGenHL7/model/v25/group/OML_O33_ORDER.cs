...
{
	/// <summary> <p>Represents the OML_O33_ORDER Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: ORC (Common Order) <b></b><br>
	/// 1: OML_O33_TIIMING (a Group object) <b>optional repeating</b><br>
	...
	public class OML_O33_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OML_O33_TIIMING </summary>
		...
		/// <summary> Returns OML_O33_OBSERVATION_REQUEST (a Group object) - creates it if necessary</summary>
		virtual public OML_O33_OBSERVATION_REQUEST OBSERVATION_REQUEST
		{
			get
			{
				...
				try
				{
					ret = (OML_O33_OBSERVATION_REQUEST) this.get_Renamed("OBSERVATION_REQUEST");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new OML_O33_ORDER Group.</summary>
		public OML_O33_ORDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of OML_O33_TIIMING (a Group object) - creates it if necessary</summary>
		public virtual OML_O33_TIIMING getTIIMING()
		{
			OML_O33_TIIMING ret = null;
			try
			{
				ret = (OML_O33_TIIMING) this.get_Renamed("TIIMING");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OML_O33_TIIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O33_TIIMING getTIIMING(int rep)
		{
			return (OML_O33_TIIMING) this.get_Renamed("TIIMING", rep);
		}
