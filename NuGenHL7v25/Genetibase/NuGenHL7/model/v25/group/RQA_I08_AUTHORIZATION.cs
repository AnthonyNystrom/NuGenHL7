...
{
	/// <summary> <p>Represents the RQA_I08_AUTHORIZATION Group.  A Group is an ordered collection of message 
	...
	public class RQA_I08_AUTHORIZATION:AbstractGroup
	{
		...
		/// <summary> Creates a new RQA_I08_AUTHORIZATION Group.</summary>
