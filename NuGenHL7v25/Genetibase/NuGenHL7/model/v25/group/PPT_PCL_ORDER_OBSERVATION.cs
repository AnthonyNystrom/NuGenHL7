...
{
	/// <summary> <p>Represents the PPT_PCL_ORDER_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class PPT_PCL_ORDER_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_ORDER_OBSERVATION Group.</summary>
		public PPT_PCL_ORDER_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
