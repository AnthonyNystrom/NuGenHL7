...
{
	/// <summary> <p>Represents the ORM_O01_PATIENT Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: PID (Patient Identification) <b></b><br>
	/// 1: PD1 (Patient Additional Demographic) <b>optional </b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: ORM_O01_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 4: ORM_O01_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class ORM_O01_PATIENT:AbstractGroup
	{
		...
		/// <summary> Returns ORM_O01_PATIENT_VISIT (a Group object) - creates it if necessary</summary>
		virtual public ORM_O01_PATIENT_VISIT PATIENT_VISIT
		{
			get
			{
				...
				try
				{
					ret = (ORM_O01_PATIENT_VISIT) this.get_Renamed("PATIENT_VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of ORM_O01_INSURANCE </summary>
		...
		/// <summary> Creates a new ORM_O01_PATIENT Group.</summary>
		public ORM_O01_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of ORM_O01_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual ORM_O01_INSURANCE getINSURANCE()
		{
			ORM_O01_INSURANCE ret = null;
			try
			{
				ret = (ORM_O01_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORM_O01_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORM_O01_INSURANCE getINSURANCE(int rep)
		{
			return (ORM_O01_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
