...
{
	/// <summary> <p>Represents the RPR_I03_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RPR_I03_PROVIDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RPR_I03_PROVIDER Group.</summary>
		public RPR_I03_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
