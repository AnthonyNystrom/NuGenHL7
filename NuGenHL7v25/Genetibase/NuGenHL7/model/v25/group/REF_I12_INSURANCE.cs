...
{
	/// <summary> <p>Represents the REF_I12_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class REF_I12_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new REF_I12_INSURANCE Group.</summary>
		public REF_I12_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
