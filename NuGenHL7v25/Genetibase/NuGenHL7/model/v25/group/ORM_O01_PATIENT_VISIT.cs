...
{
	/// <summary> <p>Represents the ORM_O01_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class ORM_O01_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new ORM_O01_PATIENT_VISIT Group.</summary>
		public ORM_O01_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
