...
{
	/// <summary> <p>Represents the RSP_Z86_ADMINISTRATION Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z86_ADMINISTRATION:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z86_ADMINISTRATION Group.</summary>
		public RSP_Z86_ADMINISTRATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
