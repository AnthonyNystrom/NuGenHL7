...
{
	/// <summary> <p>Represents the RRE_O12_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RRE_O12_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RRE_O12_TIMING Group.</summary>
		public RRE_O12_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
