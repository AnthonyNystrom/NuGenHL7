...
{
	/// <summary> <p>Represents the PPV_PCA_GOAL_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPV_PCA_GOAL_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_GOAL_ROLE Group.</summary>
		public PPV_PCA_GOAL_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
