...
{
	/// <summary> <p>Represents the RPI_I04_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RPI_I04_PROVIDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RPI_I04_PROVIDER Group.</summary>
		public RPI_I04_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
