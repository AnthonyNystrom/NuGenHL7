...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 8: BAR_P01_PROCEDURE (a Group object) <b>optional repeating</b><br>
	/// 9: GT1 (Guarantor) <b>optional repeating</b><br>
	/// 10: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b><br>
	/// 11: BAR_P01_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class BAR_P01_VISIT:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of BAR_P01_PROCEDURE </summary>
		...
		/// <summary> Returns  first repetition of BAR_P01_PROCEDURE (a Group object) - creates it if necessary</summary>
		public virtual BAR_P01_PROCEDURE getPROCEDURE()
		{
			BAR_P01_PROCEDURE ret = null;
			try
			{
				ret = (BAR_P01_PROCEDURE) this.get_Renamed("PROCEDURE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of BAR_P01_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P01_PROCEDURE getPROCEDURE(int rep)
		{
			return (BAR_P01_PROCEDURE) this.get_Renamed("PROCEDURE", rep);
		}
