...
{
	/// <summary> <p>Represents the RDS_O13_TIMING_ENCODED Group.  A Group is an ordered collection of message 
	...
	public class RDS_O13_TIMING_ENCODED:AbstractGroup
	{
		...
		/// <summary> Creates a new RDS_O13_TIMING_ENCODED Group.</summary>
		public RDS_O13_TIMING_ENCODED(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
