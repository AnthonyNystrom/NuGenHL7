...
{
	/// <summary> <p>Represents the PGL_PC6_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PGL_PC6_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_PATIENT_VISIT Group.</summary>
		public PGL_PC6_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
