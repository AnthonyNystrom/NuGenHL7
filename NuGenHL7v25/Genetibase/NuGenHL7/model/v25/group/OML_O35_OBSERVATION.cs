...
{
	/// <summary> <p>Represents the OML_O35_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class OML_O35_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O35_OBSERVATION Group.</summary>
		public OML_O35_OBSERVATION(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
