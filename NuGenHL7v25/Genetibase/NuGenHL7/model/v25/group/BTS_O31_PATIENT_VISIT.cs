...
{
	/// <summary> <p>Represents the BTS_O31_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class BTS_O31_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new BTS_O31_PATIENT_VISIT Group.</summary>
		public BTS_O31_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
