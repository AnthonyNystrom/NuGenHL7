...
{
	/// <summary> <p>Represents the SSU_U03_SPECIMEN Group.  A Group is an ordered collection of message 
	...
	public class SSU_U03_SPECIMEN:AbstractGroup
	{
		...
		/// <summary> Creates a new SSU_U03_SPECIMEN Group.</summary>
		public SSU_U03_SPECIMEN(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
