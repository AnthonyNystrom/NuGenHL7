...
{
	/// <summary> <p>Represents the OUL_R21_VISIT Group.  A Group is an ordered collection of message 
	...
	public class OUL_R21_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new OUL_R21_VISIT Group.</summary>
		public OUL_R21_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
