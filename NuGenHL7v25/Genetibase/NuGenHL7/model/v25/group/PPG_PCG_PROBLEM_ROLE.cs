...
{
	/// <summary> <p>Represents the PPG_PCG_PROBLEM_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPG_PCG_PROBLEM_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_PROBLEM_ROLE Group.</summary>
		public PPG_PCG_PROBLEM_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
