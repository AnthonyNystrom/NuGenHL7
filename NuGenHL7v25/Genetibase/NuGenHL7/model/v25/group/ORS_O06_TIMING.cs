...
{
	/// <summary> <p>Represents the ORS_O06_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORS_O06_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORS_O06_TIMING Group.</summary>
		public ORS_O06_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
