...
{
	/// <summary> <p>Represents the RPL_I02_PROVIDER Group.  A Group is an ordered collection of message 
	...
	public class RPL_I02_PROVIDER:AbstractGroup
	{
		...
		/// <summary> Creates a new RPL_I02_PROVIDER Group.</summary>
		public RPL_I02_PROVIDER(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
