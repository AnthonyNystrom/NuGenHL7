...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 1: ORL_O22_TIMING (a Group object) <b>optional repeating</b><br>
	...
	public class ORL_O22_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORL_O22_TIMING </summary>
		...
		/// <summary> Returns  first repetition of ORL_O22_TIMING (a Group object) - creates it if necessary</summary>
		public virtual ORL_O22_TIMING getTIMING()
		{
		...
		/// <summary> Returns a specific repetition of ORL_O22_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORL_O22_TIMING getTIMING(int rep)
		{
			return (ORL_O22_TIMING) this.get_Renamed("TIMING", rep);
		}
	}
}