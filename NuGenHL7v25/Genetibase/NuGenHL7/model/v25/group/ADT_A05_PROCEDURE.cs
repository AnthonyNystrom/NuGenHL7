...
{
	/// <summary> <p>Represents the ADT_A05_PROCEDURE Group.  A Group is an ordered collection of message 
	...
	public class ADT_A05_PROCEDURE:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A05_PROCEDURE Group.</summary>
		public ADT_A05_PROCEDURE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
