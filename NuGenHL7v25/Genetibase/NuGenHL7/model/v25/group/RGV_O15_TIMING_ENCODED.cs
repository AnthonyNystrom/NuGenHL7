...
{
	/// <summary> <p>Represents the RGV_O15_TIMING_ENCODED Group.  A Group is an ordered collection of message 
	...
	public class RGV_O15_TIMING_ENCODED:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O15_TIMING_ENCODED Group.</summary>
