...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	public class VXR_V03_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of VXR_V03_TIMING </summary>
		...
		/// <summary> Returns  first repetition of VXR_V03_TIMING (a Group object) - creates it if necessary</summary>
		public virtual VXR_V03_TIMING getTIMING()
		{
		...
		/// <summary> Returns a specific repetition of VXR_V03_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXR_V03_TIMING getTIMING(int rep)
		{
			return (VXR_V03_TIMING) this.get_Renamed("TIMING", rep);
		}
