...
{
	/// <summary> <p>Represents the SIU_S12_PATIENT Group.  A Group is an ordered collection of message 
	...
	public class SIU_S12_PATIENT:AbstractGroup
	{
		...
		/// <summary> Creates a new SIU_S12_PATIENT Group.</summary>
		public SIU_S12_PATIENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
