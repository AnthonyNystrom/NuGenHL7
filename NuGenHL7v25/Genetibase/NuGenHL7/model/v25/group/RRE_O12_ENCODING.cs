...
{
	/// <summary> <p>Represents the RRE_O12_ENCODING Group.  A Group is an ordered collection of message 
	...
	public class RRE_O12_ENCODING:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RRE_O12_TIMING_ENCODED </summary>
		...
		/// <summary> Creates a new RRE_O12_ENCODING Group.</summary>
		...
		/// <summary> Returns  first repetition of RRE_O12_TIMING_ENCODED (a Group object) - creates it if necessary</summary>
		public virtual RRE_O12_TIMING_ENCODED getTIMING_ENCODED()
		{
		...
		/// <summary> Returns a specific repetition of RRE_O12_TIMING_ENCODED
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRE_O12_TIMING_ENCODED getTIMING_ENCODED(int rep)
		{
