...
{
	/// <summary> <p>Represents the RSP_Q11_QUERY_RESULT_CLUSTER Group.  A Group is an ordered collection of message 
	...
	public class RSP_Q11_QUERY_RESULT_CLUSTER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_Q11_MF_LOC_DEPT </summary>
		...
		/// <summary> Creates a new RSP_Q11_QUERY_RESULT_CLUSTER Group.</summary>
		...
		/// <summary> Returns  first repetition of RSP_Q11_MF_LOC_DEPT (a Group object) - creates it if necessary</summary>
		public virtual RSP_Q11_MF_LOC_DEPT getMF_LOC_DEPT()
		{
		...
		/// <summary> Returns a specific repetition of RSP_Q11_MF_LOC_DEPT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_Q11_MF_LOC_DEPT getMF_LOC_DEPT(int rep)
		{
