...
{
	/// <summary> <p>Represents the PRR_PC5_GOAL_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PRR_PC5_GOAL_ROLE:AbstractGroup
	{
		...
		public PRR_PC5_GOAL_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
