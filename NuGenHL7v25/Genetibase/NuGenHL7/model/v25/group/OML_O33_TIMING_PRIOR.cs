...
{
	/// <summary> <p>Represents the OML_O33_TIMING_PRIOR Group.  A Group is an ordered collection of message 
	...
	public class OML_O33_TIMING_PRIOR:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O33_TIMING_PRIOR Group.</summary>
		public OML_O33_TIMING_PRIOR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
