...
{
	/// <summary> <p>Represents the CSU_C09_STUDY_OBSERVATION Group.  A Group is an ordered collection of message 
	...
	public class CSU_C09_STUDY_OBSERVATION:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of CSU_C09_TIMING_QTY </summary>
		...
		/// <summary> Returns  first repetition of CSU_C09_TIMING_QTY (a Group object) - creates it if necessary</summary>
		public virtual CSU_C09_TIMING_QTY getTIMING_QTY()
		{
			CSU_C09_TIMING_QTY ret = null;
			try
			{
				ret = (CSU_C09_TIMING_QTY) this.get_Renamed("TIMING_QTY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of CSU_C09_TIMING_QTY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual CSU_C09_TIMING_QTY getTIMING_QTY(int rep)
		{
			return (CSU_C09_TIMING_QTY) this.get_Renamed("TIMING_QTY", rep);
		}
