...
{
	/// <summary> <p>Represents the OML_O33_PRIOR_RESULT Group.  A Group is an ordered collection of message 
	...
	{
		/// <summary> Returns OML_O33_PATIENT_PRIOR (a Group object) - creates it if necessary</summary>
		virtual public OML_O33_PATIENT_PRIOR PATIENT_PRIOR
		{
			get
			{
		...
		/// <summary> Returns OML_O33_PATIENT_VISIT_PRIOR (a Group object) - creates it if necessary</summary>
		virtual public OML_O33_PATIENT_VISIT_PRIOR PATIENT_VISIT_PRIOR
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of OML_O33_ORDER_PRIOR </summary>
		...
		/// <summary> Creates a new OML_O33_PRIOR_RESULT Group.</summary>
		...
		/// <summary> Returns  first repetition of OML_O33_ORDER_PRIOR (a Group object) - creates it if necessary</summary>
		public virtual OML_O33_ORDER_PRIOR getORDER_PRIOR()
		{
		...
		/// <summary> Returns a specific repetition of OML_O33_ORDER_PRIOR
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OML_O33_ORDER_PRIOR getORDER_PRIOR(int rep)
		{
