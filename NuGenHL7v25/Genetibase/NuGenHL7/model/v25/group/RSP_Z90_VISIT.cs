...
{
	/// <summary> <p>Represents the RSP_Z90_VISIT Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z90_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z90_VISIT Group.</summary>
		public RSP_Z90_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
