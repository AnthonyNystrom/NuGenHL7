...
{
	/// <summary> <p>Represents the SRM_S01_SERVICE Group.  A Group is an ordered collection of message 
	...
	{
		/// <summary> Returns AIS (Appointment Information) - creates it if necessary</summary>
		...
		/// <summary> Creates a new SRM_S01_SERVICE Group.</summary>
		public SRM_S01_SERVICE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
