...
{
	/// <summary> <p>Represents the OML_O35_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OML_O35_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OML_O35_INSURANCE Group.</summary>
		public OML_O35_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
