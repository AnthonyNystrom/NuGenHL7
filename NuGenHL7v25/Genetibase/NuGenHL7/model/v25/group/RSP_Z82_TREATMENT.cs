...
{
	/// <summary> <p>Represents the RSP_Z82_TREATMENT Group.  A Group is an ordered collection of message 
	...
	public class RSP_Z82_TREATMENT:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Z82_TREATMENT Group.</summary>
		public RSP_Z82_TREATMENT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
