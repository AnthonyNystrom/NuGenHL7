...
{
	/// <summary> <p>Represents the PPT_PCL_PATHWAY_ROLE Group.  A Group is an ordered collection of message 
	...
	public class PPT_PCL_PATHWAY_ROLE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_PATHWAY_ROLE Group.</summary>
		public PPT_PCL_PATHWAY_ROLE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
