...
{
	/// <summary> <p>Represents the RSP_Q11_MF_LOC_DEPT Group.  A Group is an ordered collection of message 
	...
	public class RSP_Q11_MF_LOC_DEPT:AbstractGroup
	{
		...
		/// <summary> Creates a new RSP_Q11_MF_LOC_DEPT Group.</summary>
		public RSP_Q11_MF_LOC_DEPT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
