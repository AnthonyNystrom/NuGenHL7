...
{
	/// <summary> <p>Represents the OMN_O07_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OMN_O07_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OMN_O07_TIMING Group.</summary>
		public OMN_O07_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
