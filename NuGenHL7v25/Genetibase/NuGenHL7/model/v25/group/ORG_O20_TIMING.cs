...
{
	/// <summary> <p>Represents the ORG_O20_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORG_O20_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORG_O20_TIMING Group.</summary>
		public ORG_O20_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
