...
{
	/// <summary> <p>Represents the DFT_P11_TIMING_QUANTITY Group.  A Group is an ordered collection of message 
	...
	public class DFT_P11_TIMING_QUANTITY:AbstractGroup
	{
		...
		/// <summary> Creates a new DFT_P11_TIMING_QUANTITY Group.</summary>
		public DFT_P11_TIMING_QUANTITY(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
