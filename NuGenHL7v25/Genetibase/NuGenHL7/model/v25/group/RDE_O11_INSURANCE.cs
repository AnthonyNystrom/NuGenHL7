...
{
	/// <summary> <p>Represents the RDE_O11_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class RDE_O11_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O11_INSURANCE Group.</summary>
		public RDE_O11_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
