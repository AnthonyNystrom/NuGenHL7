...
{
	/// <summary> <p>Represents the BPS_O29_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class BPS_O29_PATIENT_VISIT:AbstractGroup
	{
		...
		public BPS_O29_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
