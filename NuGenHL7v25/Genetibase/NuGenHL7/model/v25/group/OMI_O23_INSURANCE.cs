...
{
	/// <summary> <p>Represents the OMI_O23_INSURANCE Group.  A Group is an ordered collection of message 
	...
	public class OMI_O23_INSURANCE:AbstractGroup
	{
		...
		/// <summary> Creates a new OMI_O23_INSURANCE Group.</summary>
		public OMI_O23_INSURANCE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
