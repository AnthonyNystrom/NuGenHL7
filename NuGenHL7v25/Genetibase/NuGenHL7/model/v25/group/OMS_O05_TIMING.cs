...
{
	/// <summary> <p>Represents the OMS_O05_TIMING Group.  A Group is an ordered collection of message 
	...
	public class OMS_O05_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new OMS_O05_TIMING Group.</summary>
		public OMS_O05_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
