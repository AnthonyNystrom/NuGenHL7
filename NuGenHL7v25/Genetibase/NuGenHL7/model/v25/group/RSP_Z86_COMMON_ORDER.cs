...
namespace Genetibase.NuGenHL7.model.v25.group
{
	...
	/// 1: RSP_Z86_TIMING (a Group object) <b>optional repeating</b><br>
	/// 2: RSP_Z86_ORDER_DETAIL (a Group object) <b>optional </b><br>
	/// 3: RSP_Z86_ENCODED_ORDER (a Group object) <b>optional </b><br>
	/// 4: RSP_Z86_DISPENSE (a Group object) <b>optional </b><br>
	/// 5: RSP_Z86_GIVE (a Group object) <b>optional </b><br>
	/// 6: RSP_Z86_ADMINISTRATION (a Group object) <b>optional </b><br>
	/// 7: RSP_Z86_OBSERVATION (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class RSP_Z86_COMMON_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_Z86_TIMING </summary>
		...
		/// <summary> Returns  first repetition of RSP_Z86_TIMING (a Group object) - creates it if necessary</summary>
		public virtual RSP_Z86_TIMING getTIMING()
		{
			RSP_Z86_TIMING ret = null;
			try
			{
				ret = (RSP_Z86_TIMING) this.get_Renamed("TIMING");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RSP_Z86_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_Z86_TIMING getTIMING(int rep)
		{
			return (RSP_Z86_TIMING) this.get_Renamed("TIMING", rep);
		}
