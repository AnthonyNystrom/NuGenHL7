...
{
	/// <summary> <p>Represents the OSR_Q06_ORDER Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: ORC (Common Order) <b></b><br>
	/// 1: OSR_Q06_TIMING (a Group object) <b>optional repeating</b><br>
	/// 2: OBR (Observation Request) <b></b><br>
	/// 3: RQD (Requisition Detail) <b></b><br>
	/// 4: RQ1 (Requisition Detail-1) <b></b><br>
	/// 5: RXO (Pharmacy/Treatment Order) <b></b><br>
	/// 6: ODS (Dietary Orders, Supplements, and Preferences) <b></b><br>
	/// 7: ODT (Diet Tray Instructions) <b></b><br>
	/// 8: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 9: CTI (Clinical Trial Identification) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class OSR_Q06_ORDER:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of OSR_Q06_TIMING </summary>
		...
		/// <summary> Creates a new OSR_Q06_ORDER Group.</summary>
		...
		/// <summary> Returns  first repetition of OSR_Q06_TIMING (a Group object) - creates it if necessary</summary>
		public virtual OSR_Q06_TIMING getTIMING()
		{
			OSR_Q06_TIMING ret = null;
			try
			{
				ret = (OSR_Q06_TIMING) this.get_Renamed("TIMING");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OSR_Q06_TIMING
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OSR_Q06_TIMING getTIMING(int rep)
		{
			return (OSR_Q06_TIMING) this.get_Renamed("TIMING", rep);
		}
