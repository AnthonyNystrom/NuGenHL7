...
{
	/// <summary> <p>Represents the ORB_O28_TIMING Group.  A Group is an ordered collection of message 
	...
	public class ORB_O28_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new ORB_O28_TIMING Group.</summary>
		public ORB_O28_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
