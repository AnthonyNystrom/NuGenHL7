...
{
	/// <summary> <p>Represents the RDE_O11_TIMING Group.  A Group is an ordered collection of message 
	...
	public class RDE_O11_TIMING:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O11_TIMING Group.</summary>
		public RDE_O11_TIMING(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
