...
{
	/// <summary> <p>Represents the ORD_O04_TIMING_DIET Group.  A Group is an ordered collection of message 
	...
	public class ORD_O04_TIMING_DIET:AbstractGroup
	{
		...
		/// <summary> Creates a new ORD_O04_TIMING_DIET Group.</summary>
		public ORD_O04_TIMING_DIET(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
