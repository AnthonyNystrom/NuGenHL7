...
{
	/// <summary> <p>Represents the REF_I12_PROVIDER_CONTACT Group.  A Group is an ordered collection of message 
	...
	public class REF_I12_PROVIDER_CONTACT:AbstractGroup
	{
		...
		/// <summary> Creates a new REF_I12_PROVIDER_CONTACT Group.</summary>
