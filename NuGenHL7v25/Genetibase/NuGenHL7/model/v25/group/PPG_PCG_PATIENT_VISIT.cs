...
{
	/// <summary> <p>Represents the PPG_PCG_PATIENT_VISIT Group.  A Group is an ordered collection of message 
	...
	public class PPG_PCG_PATIENT_VISIT:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_PATIENT_VISIT Group.</summary>
		public PPG_PCG_PATIENT_VISIT(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
