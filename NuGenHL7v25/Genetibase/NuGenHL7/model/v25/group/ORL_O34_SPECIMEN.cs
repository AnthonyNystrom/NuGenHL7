...
{
	/// <summary> <p>Represents the ORL_O34_SPECIMEN Group.  A Group is an ordered collection of message 
	...
	public class ORL_O34_SPECIMEN:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORL_O34_ORDER </summary>
		...
		/// <summary> Creates a new ORL_O34_SPECIMEN Group.</summary>
		...
		/// <summary> Returns  first repetition of ORL_O34_ORDER (a Group object) - creates it if necessary</summary>
		public virtual ORL_O34_ORDER getORDER()
		{
		...
		/// <summary> Returns a specific repetition of ORL_O34_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORL_O34_ORDER getORDER(int rep)
		{
			return (ORL_O34_ORDER) this.get_Renamed("ORDER", rep);
		}
	}
}