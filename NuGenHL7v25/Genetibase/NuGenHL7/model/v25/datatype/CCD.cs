...
namespace Genetibase.NuGenHL7.model.v25.datatype
{
	...
	/// <summary> <p>The HL7 CCD (Charge Code and Date) data type.  Consists of the following components: </p><ol>
	...
	public class CCD:AbstractType, Composite
	{
		...
		/// <summary> Returns Invocation Event (component #0).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ID InvocationEvent
		{
			get
			{
				ID ret = null;
