...
namespace Genetibase.NuGenHL7.model.v25.datatype
{
	...
	/// <summary> <p>The HL7 XCN (Extended Composite ID Number and Name for Persons) data type.  Consists of the following components: </p><ol>
	/// <li>ID Number (ST)</li>
	...
	public class XCN:AbstractType, Composite
	{
		...
		/// <summary> Returns Name Representation Code (component #14).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Name Context (component #15).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Name Validity Range (component #16).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Name Assembly Order (component #17).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Effective Date (component #18).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Expiration Date (component #19).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Professional Suffix (component #20).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Assigning Jurisdiction (component #21).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		...
		/// <summary> Returns Assigning Agency or Department (component #22).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
