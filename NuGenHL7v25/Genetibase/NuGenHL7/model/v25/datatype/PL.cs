...
namespace Genetibase.NuGenHL7.model.v25.datatype
{
	...
	public class PL:AbstractType, Composite
	{
		...
		/// <summary> Returns Comprehensive Location Identifier (component #9).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public EI ComprehensiveLocationIdentifier
		{
			get
			{
				EI ret = null;
		...
		/// <summary> Returns Assigning Authority for Location (component #10).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public HD AssigningAuthorityForLocation
		{
			get
			{
				HD ret = null;
