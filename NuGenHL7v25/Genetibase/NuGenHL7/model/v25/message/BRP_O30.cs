...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a BRP_O30 message structure (see chapter 4.20.4). This structure contains the 
	...
	/// 5: BRP_O30_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class BRP_O30:AbstractMessage
	{
		...
		/// <summary> Returns BRP_O30_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public BRP_O30_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (BRP_O30_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new BRP_O30 Group with custom ModelClassFactory.</summary>
		public BRP_O30(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new BRP_O30 Group with DefaultModelClassFactory. </summary>
