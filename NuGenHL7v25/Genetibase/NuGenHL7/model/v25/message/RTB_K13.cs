...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RTB_K13 message structure (see chapter 5.3.3.1). This structure contains the 
	...
	/// 6: RTB_K13_ROW_DEFINITION (a Group object) <b>optional </b><br>
	...
	public class RTB_K13:AbstractMessage
	{
		...
		/// <summary> Returns RTB_K13_ROW_DEFINITION (a Group object) - creates it if necessary</summary>
		virtual public RTB_K13_ROW_DEFINITION ROW_DEFINITION
		{
			get
			{
				...
				try
				{
					ret = (RTB_K13_ROW_DEFINITION) this.get_Renamed("ROW_DEFINITION");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RTB_K13 Group with custom ModelClassFactory.</summary>
		public RTB_K13(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RTB_K13 Group with DefaultModelClassFactory. </summary>
