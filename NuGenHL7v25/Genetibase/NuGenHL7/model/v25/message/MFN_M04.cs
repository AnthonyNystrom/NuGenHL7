...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFN_M04 message structure (see chapter 8.10.1). This structure contains the 
	...
	public class MFN_M04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_M04_MF_CDM </summary>
		virtual public int MF_CDMReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns  first repetition of MFN_M04_MF_CDM (a Group object) - creates it if necessary</summary>
		public virtual MFN_M04_MF_CDM getMF_CDM()
		{
		...
		/// <summary> Returns a specific repetition of MFN_M04_MF_CDM
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_M04_MF_CDM getMF_CDM(int rep)
		{
