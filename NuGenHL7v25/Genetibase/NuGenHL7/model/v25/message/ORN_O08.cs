...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORN_O08 message structure (see chapter 4.10.4). This structure contains the 
	...
	/// 5: ORN_O08_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORN_O08:AbstractMessage
	{
		...
		/// <summary> Returns ORN_O08_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORN_O08_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (ORN_O08_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORN_O08 Group with custom ModelClassFactory.</summary>
		public ORN_O08(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ORN_O08 Group with DefaultModelClassFactory. </summary>
