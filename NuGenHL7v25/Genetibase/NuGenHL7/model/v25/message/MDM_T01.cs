...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MDM_T01 message structure (see chapter 9.5.1). This structure contains the 
	...
	/// 5: MDM_T01_COMMON_ORDER (a Group object) <b>optional repeating</b><br>
	...
	public class MDM_T01:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MDM_T01_COMMON_ORDER </summary>
		...
		/// <summary> Returns  first repetition of MDM_T01_COMMON_ORDER (a Group object) - creates it if necessary</summary>
		public virtual MDM_T01_COMMON_ORDER getCOMMON_ORDER()
		{
			MDM_T01_COMMON_ORDER ret = null;
			try
			{
				ret = (MDM_T01_COMMON_ORDER) this.get_Renamed("COMMON_ORDER");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of MDM_T01_COMMON_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MDM_T01_COMMON_ORDER getCOMMON_ORDER(int rep)
		{
			return (MDM_T01_COMMON_ORDER) this.get_Renamed("COMMON_ORDER", rep);
		}
	}
}