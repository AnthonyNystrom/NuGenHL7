...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORB_O28 message structure (see chapter 4.20.2). This structure contains the 
	...
	/// 5: ORB_O28_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORB_O28:AbstractMessage
	{
		...
		/// <summary> Returns ORB_O28_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORB_O28_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (ORB_O28_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORB_O28 Group with custom ModelClassFactory.</summary>
		public ORB_O28(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ORB_O28 Group with DefaultModelClassFactory. </summary>
