...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a SQR_S25 message structure (see chapter 10.5.3). This structure contains the 
	...
	public class SQR_S25:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of SQR_S25_SCHEDULE </summary>
		virtual public int SCHEDULEReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns a specific repetition of SQR_S25_SCHEDULE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual SQR_S25_SCHEDULE getSCHEDULE(int rep)
		{
