...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QRY_PC4 message structure (see chapter 12.3.5). This structure contains the 
	...
	public class QRY_PC4:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_PC4 Group with custom ModelClassFactory.</summary>
		public QRY_PC4(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
