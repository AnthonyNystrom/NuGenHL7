...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RQI_I01 message structure (see chapter 11.3.1). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: RQI_I01_PROVIDER (a Group object) <b>repeating</b><br>
	/// 3: PID (Patient Identification) <b></b><br>
	/// 4: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b><br>
	/// 5: RQI_I01_GUARANTOR_INSURANCE (a Group object) <b>optional </b><br>
	...
	public class RQI_I01:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RQI_I01_PROVIDER </summary>
		...
		/// <summary> Returns RQI_I01_GUARANTOR_INSURANCE (a Group object) - creates it if necessary</summary>
		virtual public RQI_I01_GUARANTOR_INSURANCE GUARANTOR_INSURANCE
		{
			get
			{
		...
		/// <summary> Returns  first repetition of RQI_I01_PROVIDER (a Group object) - creates it if necessary</summary>
		public virtual RQI_I01_PROVIDER getPROVIDER()
		{
		...
		/// <summary> Returns a specific repetition of RQI_I01_PROVIDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RQI_I01_PROVIDER getPROVIDER(int rep)
		{
