...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A60 message structure (see chapter 3.3.60). This structure contains the 
	...
	/// 6: IAM (Patient Adverse Reaction Information) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class ADT_A60:AbstractMessage
	{
		...
		/// <summary> Returns  first repetition of IAM (Patient Adverse Reaction Information) - creates it if necessary</summary>
