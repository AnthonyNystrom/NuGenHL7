...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFR_M07 message structure (see chapter 8.11.1). This structure contains the 
	...
	/// 8: MFR_M07_MF_QUERY (a Group object) <b>repeating</b><br>
	...
	public class MFR_M07:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFR_M07_MF_QUERY </summary>
		...
		/// <summary> Creates a new MFR_M07 Group with custom ModelClassFactory.</summary>
		public MFR_M07(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFR_M07 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of MFR_M07_MF_QUERY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFR_M07_MF_QUERY getMF_QUERY(int rep)
		{
			return (MFR_M07_MF_QUERY) this.get_Renamed("MF_QUERY", rep);
		}
	}
}