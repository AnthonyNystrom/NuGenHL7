...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a INU_U05 message structure (see chapter 13.3.5). This structure contains the 
	...
	public class INU_U05:AbstractMessage
	{
		...
		/// <summary> Creates a new INU_U05 Group with custom ModelClassFactory.</summary>
		public INU_U05(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new INU_U05 Group with DefaultModelClassFactory. </summary>
