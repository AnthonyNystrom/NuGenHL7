...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a PGL_PC6 message structure (see chapter 12.3.1). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: PID (Patient Identification) <b></b><br>
	/// 3: PGL_PC6_PATIENT_VISIT (a Group object) <b>optional </b><br>
	/// 4: PGL_PC6_GOAL (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
