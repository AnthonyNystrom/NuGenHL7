...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORS_O06 message structure (see chapter 4.10.2). This structure contains the 
	...
	/// 5: ORS_O06_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORS_O06:AbstractMessage
	{
		...
		/// <summary> Returns ORS_O06_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORS_O06_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (ORS_O06_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORS_O06 Group with custom ModelClassFactory.</summary>
		public ORS_O06(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ORS_O06 Group with DefaultModelClassFactory. </summary>
