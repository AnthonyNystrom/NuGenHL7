...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFN_M12 message structure (see chapter 8.8.7). This structure contains the 
	...
	public class MFN_M12:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_M12_MF_OBS_ATTRIBUTES </summary>
		virtual public int MF_OBS_ATTRIBUTESReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Creates a new MFN_M12 Group with custom ModelClassFactory.</summary>
		public MFN_M12(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFN_M12 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of MFN_M12_MF_OBS_ATTRIBUTES (a Group object) - creates it if necessary</summary>
		public virtual MFN_M12_MF_OBS_ATTRIBUTES getMF_OBS_ATTRIBUTES()
		{
		...
		/// <summary> Returns a specific repetition of MFN_M12_MF_OBS_ATTRIBUTES
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_M12_MF_OBS_ATTRIBUTES getMF_OBS_ATTRIBUTES(int rep)
		{
