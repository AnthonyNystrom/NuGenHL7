...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a BPS_O29 message structure (see chapter 4.20.3). This structure contains the 
	...
	public class BPS_O29:AbstractMessage
	{
		...
		/// <summary> Returns BPS_O29_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public BPS_O29_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of BPS_O29_ORDER </summary>
		...
		/// <summary> Creates a new BPS_O29 Group with custom ModelClassFactory.</summary>
		public BPS_O29(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new BPS_O29 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of BPS_O29_ORDER (a Group object) - creates it if necessary</summary>
		public virtual BPS_O29_ORDER getORDER()
		{
		...
		/// <summary> Returns a specific repetition of BPS_O29_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BPS_O29_ORDER getORDER(int rep)
		{
