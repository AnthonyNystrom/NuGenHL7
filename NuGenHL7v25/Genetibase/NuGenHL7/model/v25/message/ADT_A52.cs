...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A52 message structure (see chapter 3.3.52). This structure contains the 
	...
	public class ADT_A52:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A52 Group with custom ModelClassFactory.</summary>
		public ADT_A52(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A52 Group with DefaultModelClassFactory. </summary>
