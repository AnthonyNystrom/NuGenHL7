...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFN_M09 message structure (see chapter 8.8.4). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: MFI (Master File Identification) <b></b><br>
	/// 3: MFN_M09_MF_TEST_CATEGORICAL (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class MFN_M09:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_M09_MF_TEST_CATEGORICAL </summary>
		virtual public int MF_TEST_CATEGORICALReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns  first repetition of MFN_M09_MF_TEST_CATEGORICAL (a Group object) - creates it if necessary</summary>
		public virtual MFN_M09_MF_TEST_CATEGORICAL getMF_TEST_CATEGORICAL()
		{
		...
		/// <summary> Returns a specific repetition of MFN_M09_MF_TEST_CATEGORICAL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_M09_MF_TEST_CATEGORICAL getMF_TEST_CATEGORICAL(int rep)
		{
