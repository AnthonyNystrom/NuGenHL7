...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORR_O02 message structure (see chapter 4.4.2). This structure contains the 
	...
	public class ORR_O02:AbstractMessage
	{
		...
		/// <summary> Returns ORR_O02_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORR_O02_RESPONSE RESPONSE
		{
			get
			{
