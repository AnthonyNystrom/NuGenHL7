...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RSP_K21 message structure (see chapter 3.3.56). This structure contains the 
	...
	public class RSP_K21:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_K21_QUERY_RESPONSE </summary>
		...
		/// <summary> Creates a new RSP_K21 Group with custom ModelClassFactory.</summary>
		public RSP_K21(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_K21 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of RSP_K21_QUERY_RESPONSE (a Group object) - creates it if necessary</summary>
		public virtual RSP_K21_QUERY_RESPONSE getQUERY_RESPONSE()
		{
			RSP_K21_QUERY_RESPONSE ret = null;
			try
			{
				ret = (RSP_K21_QUERY_RESPONSE) this.get_Renamed("QUERY_RESPONSE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RSP_K21_QUERY_RESPONSE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_K21_QUERY_RESPONSE getQUERY_RESPONSE(int rep)
		{
			return (RSP_K21_QUERY_RESPONSE) this.get_Renamed("QUERY_RESPONSE", rep);
		}
	}
}