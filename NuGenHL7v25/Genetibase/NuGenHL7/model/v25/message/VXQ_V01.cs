...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a VXQ_V01 message structure (see chapter 4.17.3). This structure contains the 
	...
	public class VXQ_V01:AbstractMessage
	{
		...
		/// <summary> Creates a new VXQ_V01 Group with custom ModelClassFactory.</summary>
		public VXQ_V01(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new VXQ_V01 Group with DefaultModelClassFactory. </summary>
