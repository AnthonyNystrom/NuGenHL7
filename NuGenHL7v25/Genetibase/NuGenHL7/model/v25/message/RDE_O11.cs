...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RDE_O11 message structure (see chapter 4.13.5). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: RDE_O11_PATIENT (a Group object) <b>optional </b><br>
	/// 4: RDE_O11_ORDER (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
