...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a OUL_R23 message structure (see chapter 7.3.8). This structure contains the 
	...
	public class OUL_R23:AbstractMessage
	{
		...
		/// <summary> Returns OUL_R23_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public OUL_R23_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Returns OUL_R23_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OUL_R23_VISIT VISIT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI </summary>
		virtual public int SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTIReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Creates a new OUL_R23 Group with custom ModelClassFactory.</summary>
		public OUL_R23(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new OUL_R23 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI (a Group object) - creates it if necessary</summary>
		public virtual OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI getSPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI()
		{
		...
		/// <summary> Returns a specific repetition of OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OUL_R23_SPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI getSPMOBXSACINVOBRORCNTETQ1TQ2OBXTCDSIDNTECTI(int rep)
		{
