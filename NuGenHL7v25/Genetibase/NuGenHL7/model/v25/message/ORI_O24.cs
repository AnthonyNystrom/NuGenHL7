...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORI_O24 message structure (see chapter 4.4.13). This structure contains the 
	...
	/// 5: ORI_O24_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORI_O24:AbstractMessage
	{
		...
		/// <summary> Returns ORI_O24_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORI_O24_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (ORI_O24_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORI_O24 Group with custom ModelClassFactory.</summary>
		public ORI_O24(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ORI_O24 Group with DefaultModelClassFactory. </summary>
