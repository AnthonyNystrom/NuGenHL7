...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a PMU_B08 message structure (see chapter 15.3.9). This structure contains the 
	...
	public class PMU_B08:AbstractMessage
	{
		...
		/// <summary> Creates a new PMU_B08 Group with custom ModelClassFactory.</summary>
		public PMU_B08(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new PMU_B08 Group with DefaultModelClassFactory. </summary>
