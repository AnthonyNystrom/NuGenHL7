...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QRY_R02 message structure (see chapter 7.3.3). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: QRD (Original-Style Query Definition) <b></b><br>
	/// 3: QRF (Original style query filter) <b></b><br>
	/// </summary>
	[Serializable]
	public class QRY_R02:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_R02 Group with custom ModelClassFactory.</summary>
