...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QBP_Q21 message structure (see chapter 3.3.56). This structure contains the 
	...
	public class QBP_Q21:AbstractMessage
	{
		...
		/// <summary> Creates a new QBP_Q21 Group with custom ModelClassFactory.</summary>
		public QBP_Q21(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QBP_Q21 Group with DefaultModelClassFactory. </summary>
