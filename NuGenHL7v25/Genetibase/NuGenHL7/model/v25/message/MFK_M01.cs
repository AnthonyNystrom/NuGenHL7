...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFK_M01 message structure (see chapter 8.4.1). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: MSA (Message Acknowledgment) <b></b><br>
	/// 3: ERR (Error) <b>optional repeating</b><br>
	/// 4: MFI (Master File Identification) <b></b><br>
	/// 5: MFA (Master File Acknowledgment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class MFK_M01:AbstractMessage
	{
		...
		/// <summary> Creates a new MFK_M01 Group with custom ModelClassFactory.</summary>
		...
		/// <summary> Returns  first repetition of MFA (Master File Acknowledgment) - creates it if necessary</summary>
