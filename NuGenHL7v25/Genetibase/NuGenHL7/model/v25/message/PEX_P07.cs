...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a PEX_P07 message structure (see chapter 7.11.1). This structure contains the 
	...
	/// 6: PEX_P07_VISIT (a Group object) <b>optional </b><br>
	/// 7: PEX_P07_EXPERIENCE (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class PEX_P07:AbstractMessage
	{
		...
		virtual public PEX_P07_VISIT VISIT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of PEX_P07_EXPERIENCE </summary>
		virtual public int EXPERIENCEReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns a specific repetition of PEX_P07_EXPERIENCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PEX_P07_EXPERIENCE getEXPERIENCE(int rep)
		{
