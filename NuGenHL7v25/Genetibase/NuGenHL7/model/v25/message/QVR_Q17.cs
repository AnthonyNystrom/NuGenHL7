...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QVR_Q17 message structure (see chapter 5.4.5). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: QPD (Query Parameter Definition) <b></b><br>
	/// 3: QVR_Q17_QBP (a Group object) <b>optional </b><br>
	...
	public class QVR_Q17:AbstractMessage
	{
		...
		/// <summary> Returns QVR_Q17_QBP (a Group object) - creates it if necessary</summary>
		virtual public QVR_Q17_QBP QBP
		{
			get
			{
				...
				try
				{
					ret = (QVR_Q17_QBP) this.get_Renamed("QBP");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
