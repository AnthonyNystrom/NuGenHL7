...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A03 message structure (see chapter 3.3.3). This structure contains the 
	...
	/// 14: ADT_A03_PROCEDURE (a Group object) <b>optional repeating</b><br>
	/// 15: OBX (Observation/Result) <b>optional repeating</b><br>
	/// 16: GT1 (Guarantor) <b>optional repeating</b><br>
	/// 17: ADT_A03_INSURANCE (a Group object) <b>optional repeating</b><br>
	/// 18: ACC (Accident) <b>optional </b><br>
	/// 19: PDA (Patient Death and Autopsy) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ADT_A03:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A03_PROCEDURE </summary>
		...
		/// <summary> Returns the number of existing repetitions of ADT_A03_INSURANCE </summary>
		...
		/// <summary> Creates a new ADT_A03 Group with custom ModelClassFactory.</summary>
		...
		/// <summary> Returns  first repetition of ADT_A03_PROCEDURE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A03_PROCEDURE getPROCEDURE()
		{
		...
		/// <summary> Returns a specific repetition of ADT_A03_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A03_PROCEDURE getPROCEDURE(int rep)
		{
		...
		/// <summary> Returns  first repetition of ADT_A03_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A03_INSURANCE getINSURANCE()
		{
			ADT_A03_INSURANCE ret = null;
			try
			{
				ret = (ADT_A03_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A03_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A03_INSURANCE getINSURANCE(int rep)
		{
			return (ADT_A03_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
	}
}