...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RRG_O16 message structure (see chapter 4.13.10). This structure contains the 
	...
	/// 5: RRG_O16_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RRG_O16:AbstractMessage
	{
		...
		/// <summary> Returns RRG_O16_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public RRG_O16_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (RRG_O16_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RRG_O16 Group with DefaultModelClassFactory. </summary>
