...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RRD_O14 message structure (see chapter 4.13.8). This structure contains the 
	...
	/// 5: RRD_O14_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RRD_O14:AbstractMessage
	{
		...
		/// <summary> Returns RRD_O14_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public RRD_O14_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (RRD_O14_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RRD_O14 Group with custom ModelClassFactory.</summary>
		public RRD_O14(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RRD_O14 Group with DefaultModelClassFactory. </summary>
