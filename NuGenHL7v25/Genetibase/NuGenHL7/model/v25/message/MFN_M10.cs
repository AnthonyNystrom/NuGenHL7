...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFN_M10 message structure (see chapter 8.8.5). This structure contains the 
	...
	public class MFN_M10:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_M10_MF_TEST_BATTERIES </summary>
		virtual public int MF_TEST_BATTERIESReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns a specific repetition of MFN_M10_MF_TEST_BATTERIES
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_M10_MF_TEST_BATTERIES getMF_TEST_BATTERIES(int rep)
		{
