...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RAS_O17 message structure (see chapter 4.13.11). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: RAS_O17_PATIENT (a Group object) <b>optional </b><br>
	/// 4: RAS_O17_ORDER (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class RAS_O17:AbstractMessage
	{
		...
		/// <summary> Returns RAS_O17_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public RAS_O17_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of RAS_O17_ORDER </summary>
		...
		/// <summary> Creates a new RAS_O17 Group with custom ModelClassFactory.</summary>
		public RAS_O17(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RAS_O17 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of RAS_O17_ORDER (a Group object) - creates it if necessary</summary>
		public virtual RAS_O17_ORDER getORDER()
		{
		...
		/// <summary> Returns a specific repetition of RAS_O17_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RAS_O17_ORDER getORDER(int rep)
		{
