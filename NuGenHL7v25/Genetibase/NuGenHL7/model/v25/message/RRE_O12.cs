...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RRE_O12 message structure (see chapter 4.13.6). This structure contains the 
	...
	/// 5: RRE_O12_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RRE_O12:AbstractMessage
	{
		...
		/// <summary> Returns RRE_O12_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public RRE_O12_RESPONSE RESPONSE
		{
			get
			{
		...
		/// <summary> Creates a new RRE_O12 Group with custom ModelClassFactory.</summary>
		public RRE_O12(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RRE_O12 Group with DefaultModelClassFactory. </summary>
