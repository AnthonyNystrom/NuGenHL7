...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A50 message structure (see chapter 3.3.50). This structure contains the 
	...
	public class ADT_A50:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A50 Group with custom ModelClassFactory.</summary>
		public ADT_A50(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A50 Group with DefaultModelClassFactory. </summary>
