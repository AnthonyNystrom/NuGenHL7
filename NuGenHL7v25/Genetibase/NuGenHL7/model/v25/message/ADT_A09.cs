...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A09 message structure (see chapter 3.3.9). This structure contains the 
	...
	public class ADT_A09:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A09 Group with custom ModelClassFactory.</summary>
