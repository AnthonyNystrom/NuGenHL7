...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RPI_I04 message structure (see chapter 11.3.4). This structure contains the 
	...
	public class RPI_I04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RPI_I04_PROVIDER </summary>
		...
		/// <summary> Returns RPI_I04_GUARANTOR_INSURANCE (a Group object) - creates it if necessary</summary>
		virtual public RPI_I04_GUARANTOR_INSURANCE GUARANTOR_INSURANCE
		{
			get
			{
		...
		/// <summary> Returns  first repetition of RPI_I04_PROVIDER (a Group object) - creates it if necessary</summary>
		public virtual RPI_I04_PROVIDER getPROVIDER()
		{
		...
		/// <summary> Returns a specific repetition of RPI_I04_PROVIDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RPI_I04_PROVIDER getPROVIDER(int rep)
		{
