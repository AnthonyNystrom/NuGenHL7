...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFN_M15 message structure (see chapter 8.12.1). This structure contains the 
	...
	public class MFN_M15:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_M15_MF_INV_ITEM </summary>
		virtual public int MF_INV_ITEMReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Creates a new MFN_M15 Group with custom ModelClassFactory.</summary>
		public MFN_M15(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFN_M15 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of MFN_M15_MF_INV_ITEM
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_M15_MF_INV_ITEM getMF_INV_ITEM(int rep)
		{
