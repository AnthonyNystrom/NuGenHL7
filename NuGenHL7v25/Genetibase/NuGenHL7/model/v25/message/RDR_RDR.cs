...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RDR_RDR message structure (see chapter 4.13.17). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: MSA (Message Acknowledgment) <b></b><br>
	/// 2: ERR (Error) <b>optional repeating</b><br>
	/// 3: SFT (Software Segment) <b>optional repeating</b><br>
	/// 4: RDR_RDR_DEFINITION (a Group object) <b>repeating</b><br>
	...
	public class RDR_RDR:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RDR_RDR_DEFINITION </summary>
		...
		/// <summary> Returns a specific repetition of RDR_RDR_DEFINITION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RDR_RDR_DEFINITION getDEFINITION(int rep)
		{
