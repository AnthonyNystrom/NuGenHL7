...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORL_O34 message structure (see chapter 4.4.9). This structure contains the 
	...
	/// 5: ORL_O34_PATIENT (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORL_O34:AbstractMessage
	{
		...
		/// <summary> Returns ORL_O34_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public ORL_O34_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Creates a new ORL_O34 Group with custom ModelClassFactory.</summary>
		public ORL_O34(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ORL_O34 Group with DefaultModelClassFactory. </summary>
