...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a OUL_R24 message structure (see chapter 7.3.9). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: NTE (Notes and Comments) <b>optional </b><br>
	/// 3: OUL_R24_PATIENT (a Group object) <b>optional </b><br>
	/// 4: OUL_R24_VISIT (a Group object) <b>optional </b><br>
	/// 5: OUL_R24_ORDER (a Group object) <b>repeating</b><br>
	...
	public class OUL_R24:AbstractMessage
	{
		...
		/// <summary> Returns OUL_R24_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public OUL_R24_PATIENT PATIENT
		{
			get
			{
				...
				try
				{
					ret = (OUL_R24_PATIENT) this.get_Renamed("PATIENT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns OUL_R24_VISIT (a Group object) - creates it if necessary</summary>
		virtual public OUL_R24_VISIT VISIT
		{
			get
			{
				...
				try
				{
					ret = (OUL_R24_VISIT) this.get_Renamed("VISIT");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OUL_R24_ORDER </summary>
		...
		/// <summary> Creates a new OUL_R24 Group with custom ModelClassFactory.</summary>
		public OUL_R24(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new OUL_R24 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of OUL_R24_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OUL_R24_ORDER getORDER(int rep)
		{
			return (OUL_R24_ORDER) this.get_Renamed("ORDER", rep);
		}
	}
}