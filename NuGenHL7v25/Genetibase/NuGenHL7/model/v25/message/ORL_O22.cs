...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORL_O22 message structure (see chapter 4.4.7). This structure contains the 
	...
	/// 5: ORL_O22_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORL_O22:AbstractMessage
	{
		...
		/// <summary> Returns ORL_O22_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORL_O22_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (ORL_O22_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORL_O22 Group with custom ModelClassFactory.</summary>
		public ORL_O22(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ORL_O22 Group with DefaultModelClassFactory. </summary>
