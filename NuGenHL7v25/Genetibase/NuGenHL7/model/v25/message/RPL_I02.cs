...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RPL_I02 message structure (see chapter 11.3.2). This structure contains the 
	...
	public class RPL_I02:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RPL_I02_PROVIDER </summary>
		...
		/// <summary> Returns  first repetition of RPL_I02_PROVIDER (a Group object) - creates it if necessary</summary>
		public virtual RPL_I02_PROVIDER getPROVIDER()
		{
		...
		/// <summary> Returns a specific repetition of RPL_I02_PROVIDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RPL_I02_PROVIDER getPROVIDER(int rep)
		{
