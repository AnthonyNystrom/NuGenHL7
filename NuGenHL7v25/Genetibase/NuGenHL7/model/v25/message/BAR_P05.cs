...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a BAR_P05 message structure (see chapter 6.4.5). This structure contains the 
	...
	/// 6: BAR_P05_VISIT (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class BAR_P05:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of BAR_P05_VISIT </summary>
		...
		/// <summary> Returns a specific repetition of BAR_P05_VISIT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P05_VISIT getVISIT(int rep)
		{
