...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QRY_Q02 message structure (see chapter ?). This structure contains the 
	...
	public class QRY_Q02:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_Q02 Group with custom ModelClassFactory.</summary>
		public QRY_Q02(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QRY_Q02 Group with DefaultModelClassFactory. </summary>
