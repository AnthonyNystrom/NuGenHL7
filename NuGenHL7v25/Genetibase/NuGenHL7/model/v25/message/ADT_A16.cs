...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A16 message structure (see chapter 3.3.16). This structure contains the 
	...
	/// 15: ADT_A16_PROCEDURE (a Group object) <b>optional repeating</b><br>
	/// 16: GT1 (Guarantor) <b>optional repeating</b><br>
	/// 17: ADT_A16_INSURANCE (a Group object) <b>optional repeating</b><br>
	...
	public class ADT_A16:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A16_PROCEDURE </summary>
		...
		/// <summary> Returns the number of existing repetitions of ADT_A16_INSURANCE </summary>
		...
		/// <summary> Returns  first repetition of ADT_A16_PROCEDURE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A16_PROCEDURE getPROCEDURE()
		{
			ADT_A16_PROCEDURE ret = null;
			try
			{
				ret = (ADT_A16_PROCEDURE) this.get_Renamed("PROCEDURE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A16_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A16_PROCEDURE getPROCEDURE(int rep)
		{
			return (ADT_A16_PROCEDURE) this.get_Renamed("PROCEDURE", rep);
		}
		...
		/// <summary> Returns  first repetition of ADT_A16_INSURANCE (a Group object) - creates it if necessary</summary>
		public virtual ADT_A16_INSURANCE getINSURANCE()
		{
			ADT_A16_INSURANCE ret = null;
			try
			{
				ret = (ADT_A16_INSURANCE) this.get_Renamed("INSURANCE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A16_INSURANCE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A16_INSURANCE getINSURANCE(int rep)
		{
			return (ADT_A16_INSURANCE) this.get_Renamed("INSURANCE", rep);
		}
	}
}