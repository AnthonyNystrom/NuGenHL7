...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a PPT_PCL message structure (see chapter 12.3.12). This structure contains the 
	...
	/// 6: PPT_PCL_PATIENT (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class PPT_PCL:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of PPT_PCL_PATIENT </summary>
		...
		/// <summary> Returns  first repetition of PPT_PCL_PATIENT (a Group object) - creates it if necessary</summary>
		public virtual PPT_PCL_PATIENT getPATIENT()
		{
			PPT_PCL_PATIENT ret = null;
			try
			{
				ret = (PPT_PCL_PATIENT) this.get_Renamed("PATIENT");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of PPT_PCL_PATIENT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPT_PCL_PATIENT getPATIENT(int rep)
		{
			return (PPT_PCL_PATIENT) this.get_Renamed("PATIENT", rep);
		}
	}
}