...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QBP_Q15 message structure (see chapter 5.3.3.3). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: QPD (Query Parameter Definition) <b></b><br>
	/// 3: Hxx (any HL7 segment) <b>optional </b><br>
	...
	public class QBP_Q15:AbstractMessage
	{
		...
		/// <summary> Creates a new QBP_Q15 Group with custom ModelClassFactory.</summary>
		public QBP_Q15(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QBP_Q15 Group with DefaultModelClassFactory. </summary>
