...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a PTR_PCF message structure (see chapter 12.3.10). This structure contains the 
	...
	/// 6: PTR_PCF_PATIENT (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class PTR_PCF:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of PTR_PCF_PATIENT </summary>
		...
		/// <summary> Returns  first repetition of PTR_PCF_PATIENT (a Group object) - creates it if necessary</summary>
		public virtual PTR_PCF_PATIENT getPATIENT()
		{
		...
		/// <summary> Returns a specific repetition of PTR_PCF_PATIENT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PTR_PCF_PATIENT getPATIENT(int rep)
		{
