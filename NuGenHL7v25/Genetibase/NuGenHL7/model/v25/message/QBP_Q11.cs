...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QBP_Q11 message structure (see chapter 5.3.3.2). This structure contains the 
	...
	public class QBP_Q11:AbstractMessage
	{
		...
		/// <summary> Creates a new QBP_Q11 Group with custom ModelClassFactory.</summary>
		public QBP_Q11(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QBP_Q11 Group with DefaultModelClassFactory. </summary>
