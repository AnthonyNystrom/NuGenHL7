...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ESU_U01 message structure (see chapter 13.3.1). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: EQU (Equipment Detail) <b></b><br>
	/// 3: ISD (Interaction Status Detail) <b>optional repeating</b><br>
