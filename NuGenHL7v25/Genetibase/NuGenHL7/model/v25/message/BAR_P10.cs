...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a BAR_P10 message structure (see chapter 6.4.7). This structure contains the 
	...
	public class BAR_P10:AbstractMessage
	{
		...
		/// <summary> Returns GP1 (Grouping/Reimbursement - Visit) - creates it if necessary</summary>
		virtual public GP1 GP1
		{
			get
			{
				GP1 ret = null;
		...
		/// <summary> Returns the number of existing repetitions of BAR_P10_PROCEDURE </summary>
		...
		/// <summary> Creates a new BAR_P10 Group with custom ModelClassFactory.</summary>
		public BAR_P10(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new BAR_P10 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns a specific repetition of BAR_P10_PROCEDURE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P10_PROCEDURE getPROCEDURE(int rep)
		{
