...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a PRR_PC5 message structure (see chapter 12.3.6). This structure contains the 
	...
	/// 6: PRR_PC5_PATIENT (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class PRR_PC5:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of PRR_PC5_PATIENT </summary>
		...
		/// <summary> Returns  first repetition of PRR_PC5_PATIENT (a Group object) - creates it if necessary</summary>
		public virtual PRR_PC5_PATIENT getPATIENT()
		{
		...
		/// <summary> Returns a specific repetition of PRR_PC5_PATIENT
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PRR_PC5_PATIENT getPATIENT(int rep)
		{
