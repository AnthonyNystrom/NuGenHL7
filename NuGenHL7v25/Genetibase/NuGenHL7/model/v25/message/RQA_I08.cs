...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RQA_I08 message structure (see chapter 11.4.1). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: RF1 (Referral Information) <b>optional </b><br>
	/// 3: RQA_I08_AUTHORIZATION (a Group object) <b>optional </b><br>
	/// 4: RQA_I08_PROVIDER (a Group object) <b>repeating</b><br>
	/// 5: PID (Patient Identification) <b></b><br>
	/// 6: NK1 (Next of Kin / Associated Parties) <b>optional repeating</b><br>
	/// 7: RQA_I08_GUARANTOR_INSURANCE (a Group object) <b>optional </b><br>
	...
	/// 12: RQA_I08_PROCEDURE (a Group object) <b>optional repeating</b><br>
	/// 13: RQA_I08_OBSERVATION (a Group object) <b>optional repeating</b><br>
	/// 14: RQA_I08_VISIT (a Group object) <b>optional </b><br>
