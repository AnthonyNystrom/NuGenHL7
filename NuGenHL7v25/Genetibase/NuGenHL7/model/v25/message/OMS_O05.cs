...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a OMS_O05 message structure (see chapter 4.10.1). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: OMS_O05_PATIENT (a Group object) <b>optional </b><br>
	/// 4: OMS_O05_ORDER (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
