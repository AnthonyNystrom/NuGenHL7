...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFR_M06 message structure (see chapter 8.11.1). This structure contains the 
	...
	/// 8: MFR_M06_MF_QUERY (a Group object) <b>repeating</b><br>
	...
	public class MFR_M06:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFR_M06_MF_QUERY </summary>
		...
		/// <summary> Creates a new MFR_M06 Group with custom ModelClassFactory.</summary>
		public MFR_M06(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFR_M06 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of MFR_M06_MF_QUERY (a Group object) - creates it if necessary</summary>
		public virtual MFR_M06_MF_QUERY getMF_QUERY()
		{
			MFR_M06_MF_QUERY ret = null;
			try
			{
				ret = (MFR_M06_MF_QUERY) this.get_Renamed("MF_QUERY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of MFR_M06_MF_QUERY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFR_M06_MF_QUERY getMF_QUERY(int rep)
		{
			return (MFR_M06_MF_QUERY) this.get_Renamed("MF_QUERY", rep);
		}
	}
}