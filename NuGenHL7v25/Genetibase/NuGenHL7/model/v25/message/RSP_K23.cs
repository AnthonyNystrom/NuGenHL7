...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RSP_K23 message structure (see chapter 3.3.58). This structure contains the 
	...
	/// 6: RSP_K23_QUERY_RESPONSE (a Group object) <b>optional </b><br>
	...
	public class RSP_K23:AbstractMessage
	{
		...
		/// <summary> Returns RSP_K23_QUERY_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public RSP_K23_QUERY_RESPONSE QUERY_RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (RSP_K23_QUERY_RESPONSE) this.get_Renamed("QUERY_RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RSP_K23 Group with custom ModelClassFactory.</summary>
		public RSP_K23(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_K23 Group with DefaultModelClassFactory. </summary>
