...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a SIU_S12 message structure (see chapter 10.4). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SCH (Scheduling Activity Information) <b></b><br>
	/// 2: TQ1 (Timing/Quantity) <b>optional repeating</b><br>
	/// 3: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 4: SIU_S12_PATIENT (a Group object) <b>optional repeating</b><br>
	/// 5: SIU_S12_RESOURCES (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
