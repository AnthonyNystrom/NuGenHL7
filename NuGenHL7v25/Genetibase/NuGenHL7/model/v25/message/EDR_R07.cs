...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a EDR_R07 message structure (see chapter ?). This structure contains the 
	...
	public class EDR_R07:AbstractMessage
	{
		...
		/// <summary> Creates a new EDR_R07 Group with custom ModelClassFactory.</summary>
		public EDR_R07(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new EDR_R07 Group with DefaultModelClassFactory. </summary>
