...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a OMG_O19 message structure (see chapter 4.4.4). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: SFT (Software Segment) <b>optional repeating</b><br>
	/// 2: NTE (Notes and Comments) <b>optional repeating</b><br>
	/// 3: OMG_O19_PATIENT (a Group object) <b>optional </b><br>
	/// 4: OMG_O19_ORDER (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class OMG_O19:AbstractMessage
	{
		...
		/// <summary> Returns OMG_O19_PATIENT (a Group object) - creates it if necessary</summary>
		virtual public OMG_O19_PATIENT PATIENT
		{
			get
			{
		...
		/// <summary> Returns the number of existing repetitions of OMG_O19_ORDER </summary>
		...
		/// <summary> Creates a new OMG_O19 Group with custom ModelClassFactory.</summary>
		public OMG_O19(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new OMG_O19 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of OMG_O19_ORDER (a Group object) - creates it if necessary</summary>
		public virtual OMG_O19_ORDER getORDER()
		{
		...
		/// <summary> Returns a specific repetition of OMG_O19_ORDER
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMG_O19_ORDER getORDER(int rep)
		{
