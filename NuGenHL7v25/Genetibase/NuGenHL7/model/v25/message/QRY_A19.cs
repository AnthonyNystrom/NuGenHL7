...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QRY_A19 message structure (see chapter 3.3.19). This structure contains the 
	...
	public class QRY_A19:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_A19 Group with custom ModelClassFactory.</summary>
		public QRY_A19(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
