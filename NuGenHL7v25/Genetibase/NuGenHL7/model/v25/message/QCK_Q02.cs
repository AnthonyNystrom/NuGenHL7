...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a QCK_Q02 message structure (see chapter ?). This structure contains the 
	...
	public class QCK_Q02:AbstractMessage
	{
		...
		/// <summary> Creates a new QCK_Q02 Group with custom ModelClassFactory.</summary>
