...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFR_M04 message structure (see chapter 8.10.1). This structure contains the 
	...
	/// 8: MFR_M04_MF_QUERY (a Group object) <b>repeating</b><br>
	...
	public class MFR_M04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFR_M04_MF_QUERY </summary>
		...
		/// <summary> Creates a new MFR_M04 Group with custom ModelClassFactory.</summary>
		public MFR_M04(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFR_M04 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of MFR_M04_MF_QUERY (a Group object) - creates it if necessary</summary>
		public virtual MFR_M04_MF_QUERY getMF_QUERY()
		{
			MFR_M04_MF_QUERY ret = null;
			try
			{
				ret = (MFR_M04_MF_QUERY) this.get_Renamed("MF_QUERY");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of MFR_M04_MF_QUERY
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFR_M04_MF_QUERY getMF_QUERY(int rep)
		{
			return (MFR_M04_MF_QUERY) this.get_Renamed("MF_QUERY", rep);
		}
	}
}