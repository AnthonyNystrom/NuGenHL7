...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RTB_Knn message structure (see chapter 5.3.2.4). This structure contains the 
	...
	public class RTB_Knn:AbstractMessage
	{
		...
		/// <summary> Returns Hxx2 (any HL7 segment) - creates it if necessary</summary>
		virtual public Hxx Hxx2
		{
			get
			{
				Hxx ret = null;
		...
		/// <summary> Creates a new RTB_Knn Group with custom ModelClassFactory.</summary>
		public RTB_Knn(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RTB_Knn Group with DefaultModelClassFactory. </summary>
