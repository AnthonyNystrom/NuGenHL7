...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ORP_O10 message structure (see chapter 4.13.4). This structure contains the 
	...
	/// 5: ORP_O10_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORP_O10:AbstractMessage
	{
		...
		/// <summary> Returns ORP_O10_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public ORP_O10_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (ORP_O10_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORP_O10 Group with DefaultModelClassFactory. </summary>
