...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a ADT_A21 message structure (see chapter 3.3.21). This structure contains the 
	...
	public class ADT_A21:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A21 Group with custom ModelClassFactory.</summary>
		public ADT_A21(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A21 Group with DefaultModelClassFactory. </summary>
