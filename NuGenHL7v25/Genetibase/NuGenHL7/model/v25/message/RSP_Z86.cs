...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RSP_Z86 message structure (see chapter 5.9.1.2.1). This structure contains the 
	...
	/// 6: RSP_Z86_QUERY_RESPONSE (a Group object) <b>repeating</b><br>
	...
	public class RSP_Z86:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RSP_Z86_QUERY_RESPONSE </summary>
		...
		/// <summary> Creates a new RSP_Z86 Group with custom ModelClassFactory.</summary>
		public RSP_Z86(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RSP_Z86 Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of RSP_Z86_QUERY_RESPONSE (a Group object) - creates it if necessary</summary>
		public virtual RSP_Z86_QUERY_RESPONSE getQUERY_RESPONSE()
		{
		...
		/// <summary> Returns a specific repetition of RSP_Z86_QUERY_RESPONSE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RSP_Z86_QUERY_RESPONSE getQUERY_RESPONSE(int rep)
		{
