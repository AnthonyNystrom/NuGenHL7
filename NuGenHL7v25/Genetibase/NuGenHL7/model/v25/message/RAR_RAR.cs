...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a RAR_RAR message structure (see chapter 4.13.16). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (Message Header) <b></b><br>
	/// 1: MSA (Message Acknowledgment) <b></b><br>
	/// 2: ERR (Error) <b>optional repeating</b><br>
	/// 3: SFT (Software Segment) <b>optional repeating</b><br>
	/// 4: RAR_RAR_DEFINITION (a Group object) <b>repeating</b><br>
	...
	public class RAR_RAR:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RAR_RAR_DEFINITION </summary>
		...
		/// <summary> Returns  first repetition of RAR_RAR_DEFINITION (a Group object) - creates it if necessary</summary>
		public virtual RAR_RAR_DEFINITION getDEFINITION()
		{
		...
		/// <summary> Returns a specific repetition of RAR_RAR_DEFINITION
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RAR_RAR_DEFINITION getDEFINITION(int rep)
		{
