...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a BRT_O32 message structure (see chapter 4.20.6). This structure contains the 
	...
	/// 5: BRT_O32_RESPONSE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class BRT_O32:AbstractMessage
	{
		...
		/// <summary> Returns BRT_O32_RESPONSE (a Group object) - creates it if necessary</summary>
		virtual public BRT_O32_RESPONSE RESPONSE
		{
			get
			{
				...
				try
				{
					ret = (BRT_O32_RESPONSE) this.get_Renamed("RESPONSE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new BRT_O32 Group with custom ModelClassFactory.</summary>
		public BRT_O32(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new BRT_O32 Group with DefaultModelClassFactory. </summary>
