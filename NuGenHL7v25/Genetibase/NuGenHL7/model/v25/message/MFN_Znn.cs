...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a MFN_Znn message structure (see chapter 8.4.3). This structure contains the 
	...
	public class MFN_Znn:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_Znn_MF_SITE_DEFINED </summary>
		virtual public int MF_SITE_DEFINEDReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Creates a new MFN_Znn Group with custom ModelClassFactory.</summary>
		public MFN_Znn(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFN_Znn Group with DefaultModelClassFactory. </summary>
		...
		/// <summary> Returns  first repetition of MFN_Znn_MF_SITE_DEFINED (a Group object) - creates it if necessary</summary>
		public virtual MFN_Znn_MF_SITE_DEFINED getMF_SITE_DEFINED()
		{
		...
		/// <summary> Returns a specific repetition of MFN_Znn_MF_SITE_DEFINED
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_Znn_MF_SITE_DEFINED getMF_SITE_DEFINED(int rep)
		{
