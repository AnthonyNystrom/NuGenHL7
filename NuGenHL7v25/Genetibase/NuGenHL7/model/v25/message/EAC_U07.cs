...
namespace Genetibase.NuGenHL7.model.v25.message
{
	...
	/// <summary> <p>Represents a EAC_U07 message structure (see chapter 13.3.7). This structure contains the 
	...
	public class EAC_U07:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of EAC_U07_COMMAND </summary>
		virtual public int COMMANDReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Returns  first repetition of EAC_U07_COMMAND (a Group object) - creates it if necessary</summary>
		public virtual EAC_U07_COMMAND getCOMMAND()
		{
		...
		/// <summary> Returns a specific repetition of EAC_U07_COMMAND
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual EAC_U07_COMMAND getCOMMAND(int rep)
		{
