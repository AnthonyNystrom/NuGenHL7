...
namespace Genetibase.NuGenHL7.model.v21.message
{
	...
	/// <summary> <p>Represents a ADT_A10 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A10:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A10 Group with custom ModelClassFactory.</summary>
		public ADT_A10(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A10 Group with DefaultModelClassFactory. </summary>
