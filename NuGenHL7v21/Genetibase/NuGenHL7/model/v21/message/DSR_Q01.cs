...
namespace Genetibase.NuGenHL7.model.v21.message
{
	...
	/// <summary> <p>Represents a DSR_Q01 message structure (see chapter ?). This structure contains the 
	...
	/// 5: DSC (CONTINUATION POINTER) <b></b><br>
	/// </summary>
	[Serializable]
	public class DSR_Q01:AbstractMessage
	{
		...
		/// <summary> Creates a new DSR_Q01 Group with custom ModelClassFactory.</summary>
		public DSR_Q01(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new DSR_Q01 Group with DefaultModelClassFactory. </summary>
