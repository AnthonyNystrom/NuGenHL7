...
namespace Genetibase.NuGenHL7.model.v21.datatype
{
	...
	public class PN:AbstractType, Composite
	{
		...
		/// <summary> Returns suffix (component #3).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ST Suffix
		{
			get
			{
				ST ret = null;
		...
		/// <summary> Returns prefix (component #4).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ST Prefix
		{
			get
			{
				ST ret = null;
		...
		/// <summary> Returns degree (component #5).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
