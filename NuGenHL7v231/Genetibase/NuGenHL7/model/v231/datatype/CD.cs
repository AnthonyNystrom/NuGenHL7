...
namespace Genetibase.NuGenHL7.model.v231.datatype
{
	...
	public class CD:AbstractType, Composite
	{
		...
		/// <summary> Returns electrode names (component #1).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public WVS ElectrodeNames
		{
			get
			{
				WVS ret = null;
		...
		/// <summary> Returns calibration parameters (component #3).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public CCP CalibrationParameters
		{
			get
			{
				CCP ret = null;
		...
		/// <summary> Returns sampling frequency (component #4).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public NM SamplingFrequency
		{
			get
			{
				NM ret = null;
