...
namespace Genetibase.NuGenHL7.model.v231.datatype
{
	...
	/// <summary> <p>The HL7 CNS (Composite ID number and Name simplified) data type.  Consists of the following components: </p><ol>
	...
	public class CNS:AbstractType, Composite
	{
		...
		/// </param>
		public CNS(Message message):base(message)
		{
			data = new Type[11];
