...
namespace Genetibase.NuGenHL7.model.v231.datatype
{
	...
	/// <summary> <p>The HL7 FN (family + last name prefix) data type.  Consists of the following components: </p><ol>
	...
	public class FN:AbstractType, Composite
	{
		...
		/// <summary> Returns last name prefix (component #1).  This is a convenience method that saves you from 
		/// casting and handling an exception.
		/// </summary>
		virtual public ST LastNamePrefix
		{
			get
			{
				ST ret = null;
