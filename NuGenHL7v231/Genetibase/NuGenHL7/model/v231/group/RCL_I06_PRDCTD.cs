...
{
	/// <summary> <p>Represents the RCL_I06_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RCL_I06_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RCL_I06_PRDCTD Group.</summary>
		public RCL_I06_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
