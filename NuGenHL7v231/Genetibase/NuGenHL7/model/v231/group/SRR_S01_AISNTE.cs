...
{
	/// <summary> <p>Represents the SRR_S01_AISNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRR_S01_AISNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRR_S01_AISNTE Group.</summary>
		public SRR_S01_AISNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
