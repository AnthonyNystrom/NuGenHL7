...
{
	/// <summary> <p>Represents the SRR_S01_AIPNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRR_S01_AIPNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRR_S01_AIPNTE Group.</summary>
		public SRR_S01_AIPNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
