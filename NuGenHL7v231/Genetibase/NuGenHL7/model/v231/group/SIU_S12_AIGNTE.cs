...
{
	/// <summary> <p>Represents the SIU_S12_AIGNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SIU_S12_AIGNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SIU_S12_AIGNTE Group.</summary>
		public SIU_S12_AIGNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
