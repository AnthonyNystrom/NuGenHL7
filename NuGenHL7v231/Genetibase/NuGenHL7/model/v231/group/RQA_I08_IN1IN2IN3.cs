...
{
	/// <summary> <p>Represents the RQA_I08_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQA_I08_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RQA_I08_IN1IN2IN3 Group.</summary>
		public RQA_I08_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
