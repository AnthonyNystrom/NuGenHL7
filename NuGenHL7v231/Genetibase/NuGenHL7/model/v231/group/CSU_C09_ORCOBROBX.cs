...
{
	/// <summary> <p>Represents the CSU_C09_ORCOBROBX Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class CSU_C09_ORCOBROBX:AbstractGroup
	{
		...
		/// <summary> Creates a new CSU_C09_ORCOBROBX Group.</summary>
		public CSU_C09_ORCOBROBX(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
