...
{
	/// <summary> <p>Represents the SIU_S12_AISNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SIU_S12_AISNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SIU_S12_AISNTE Group.</summary>
		public SIU_S12_AISNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
