...
{
	/// <summary> <p>Represents the RGV_O01_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RGV_O01_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O01_RXERXRRXC Group.</summary>
		public RGV_O01_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
