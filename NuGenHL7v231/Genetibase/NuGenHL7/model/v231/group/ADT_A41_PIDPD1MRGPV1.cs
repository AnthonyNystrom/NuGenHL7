...
{
	/// <summary> <p>Represents the ADT_A41_PIDPD1MRGPV1 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ADT_A41_PIDPD1MRGPV1:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A41_PIDPD1MRGPV1 Group.</summary>
		public ADT_A41_PIDPD1MRGPV1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
