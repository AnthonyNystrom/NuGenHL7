...
{
	/// <summary> <p>Represents the RGV_O01_RXCNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RGV_O01_RXCNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O01_RXCNTE Group.</summary>
		public RGV_O01_RXCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
