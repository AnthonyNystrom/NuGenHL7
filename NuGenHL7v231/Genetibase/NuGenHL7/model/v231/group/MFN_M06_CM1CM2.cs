...
{
	/// <summary> <p>Represents the MFN_M06_CM1CM2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class MFN_M06_CM1CM2:AbstractGroup
	{
		/// <summary> Returns CM1 (CM1 - clinical study phase master segment) - creates it if necessary</summary>
		...
		/// <summary> Creates a new MFN_M06_CM1CM2 Group.</summary>
		public MFN_M06_CM1CM2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of CM2 (CM2 - clinical study schedule master segment) - creates it if necessary</summary>
