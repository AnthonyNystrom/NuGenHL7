...
{
	/// <summary> <p>Represents the PRR_PC5_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PRR_PC5_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_ROLVAR Group.</summary>
		public PRR_PC5_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
