...
{
	/// <summary> <p>Represents the PTR_PCF_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PTR_PCF_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_OBXNTEVAR Group.</summary>
		public PTR_PCF_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
