...
{
	/// <summary> <p>Represents the MFR_M01_MFEZxx Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class MFR_M01_MFEZxx:AbstractGroup
	{
		...
		/// <summary> Creates a new MFR_M01_MFEZxx Group.</summary>
		public MFR_M01_MFEZxx(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
