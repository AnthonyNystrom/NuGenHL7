...
{
	/// <summary> <p>Represents the PGL_PC6_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PGL_PC6_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_OBXNTEVAR Group.</summary>
		public PGL_PC6_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
