...
{
	/// <summary> <p>Represents the ORM_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORM_O01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new ORM_O01_IN1IN2IN3 Group.</summary>
		public ORM_O01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
