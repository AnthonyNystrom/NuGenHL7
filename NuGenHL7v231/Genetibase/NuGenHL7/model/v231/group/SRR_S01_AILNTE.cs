...
{
	/// <summary> <p>Represents the SRR_S01_AILNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRR_S01_AILNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRR_S01_AILNTE Group.</summary>
		public SRR_S01_AILNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
