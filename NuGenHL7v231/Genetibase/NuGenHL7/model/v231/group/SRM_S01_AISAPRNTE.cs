...
{
	/// <summary> <p>Represents the SRM_S01_AISAPRNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRM_S01_AISAPRNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRM_S01_AISAPRNTE Group.</summary>
		public SRM_S01_AISAPRNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
