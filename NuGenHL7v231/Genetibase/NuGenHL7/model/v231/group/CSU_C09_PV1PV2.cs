...
{
	/// <summary> <p>Represents the CSU_C09_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class CSU_C09_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new CSU_C09_PV1PV2 Group.</summary>
		public CSU_C09_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
