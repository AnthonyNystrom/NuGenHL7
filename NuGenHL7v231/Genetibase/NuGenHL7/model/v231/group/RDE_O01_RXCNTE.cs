...
{
	/// <summary> <p>Represents the RDE_O01_RXCNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDE_O01_RXCNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O01_RXCNTE Group.</summary>
		public RDE_O01_RXCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
