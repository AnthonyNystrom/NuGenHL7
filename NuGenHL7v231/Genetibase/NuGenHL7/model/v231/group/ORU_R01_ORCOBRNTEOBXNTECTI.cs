...
{
	/// <summary> <p>Represents the ORU_R01_ORCOBRNTEOBXNTECTI Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORU_R01_ORCOBRNTEOBXNTECTI:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of ORU_R01_OBXNTE </summary>
		...
		/// <summary> Creates a new ORU_R01_ORCOBRNTEOBXNTECTI Group.</summary>
		public ORU_R01_ORCOBRNTEOBXNTECTI(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(ORU_R01_OBXNTE), true, true);
		...
		/// <summary> Returns  first repetition of ORU_R01_OBXNTE (a Group object) - creates it if necessary</summary>
		public virtual ORU_R01_OBXNTE getOBXNTE()
		{
			ORU_R01_OBXNTE ret = null;
			try
			{
				ret = (ORU_R01_OBXNTE) this.get_Renamed("OBXNTE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORU_R01_OBXNTE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORU_R01_OBXNTE getOBXNTE(int rep)
		{
			return (ORU_R01_OBXNTE) this.get_Renamed("OBXNTE", rep);
		}
