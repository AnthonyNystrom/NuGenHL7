...
{
	/// <summary> <p>Represents the RQI_I02_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQI_I02_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQI_I02_PRDCTD Group.</summary>
		public RQI_I02_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
