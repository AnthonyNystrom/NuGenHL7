...
{
	/// <summary> <p>Represents the PPR_PC1_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPR_PC1_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_PV1PV2 Group.</summary>
		public PPR_PC1_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
