...
{
	/// <summary> <p>Represents the SQR_S25_AILNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SQR_S25_AILNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SQR_S25_AILNTE Group.</summary>
		public SQR_S25_AILNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
