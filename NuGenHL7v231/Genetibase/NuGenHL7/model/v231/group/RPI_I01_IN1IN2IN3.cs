...
{
	/// <summary> <p>Represents the RPI_I01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPI_I01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RPI_I01_IN1IN2IN3 Group.</summary>
		public RPI_I01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
