...
{
	/// <summary> <p>Represents the PPV_PCA_PRBNTEVARROLVAROBXNTE Group.  A Group is an ordered collection of message 
	...
	/// 4: PPV_PCA_OBXNTE (a Group object) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class PPV_PCA_PRBNTEVARROLVAROBXNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_PRBNTEVARROLVAROBXNTE Group.</summary>
		public PPV_PCA_PRBNTEVARROLVAROBXNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
