...
{
	/// <summary> <p>Represents the PTR_PCF_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PTR_PCF_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_PV1PV2 Group.</summary>
		public PTR_PCF_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
