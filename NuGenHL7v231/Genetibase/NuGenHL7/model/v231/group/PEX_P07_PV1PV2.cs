...
{
	/// <summary> <p>Represents the PEX_P07_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PEX_P07_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PEX_P07_PV1PV2 Group.</summary>
		public PEX_P07_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
