...
{
	/// <summary> <p>Represents the BAR_P01_PR1ROL Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class BAR_P01_PR1ROL:AbstractGroup
	{
		...
		/// <summary> Creates a new BAR_P01_PR1ROL Group.</summary>
		public BAR_P01_PR1ROL(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
