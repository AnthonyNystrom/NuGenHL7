...
{
	/// <summary> <p>Represents the RAS_O01_RXCNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RAS_O01_RXCNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new RAS_O01_RXCNTE Group.</summary>
		public RAS_O01_RXCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
