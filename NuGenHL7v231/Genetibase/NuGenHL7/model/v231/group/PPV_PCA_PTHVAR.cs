...
{
	/// <summary> <p>Represents the PPV_PCA_PTHVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPV_PCA_PTHVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_PTHVAR Group.</summary>
		public PPV_PCA_PTHVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
