...
{
	/// <summary> <p>Represents the ORR_O02_ORCOBRRQDRQ1RXOODSODTNTECTI Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORR_O02_ORCOBRRQDRQ1RXOODSODTNTECTI:AbstractGroup
	{
		...
		/// <summary> Creates a new ORR_O02_ORCOBRRQDRQ1RXOODSODTNTECTI Group.</summary>
		public ORR_O02_ORCOBRRQDRQ1RXOODSODTNTECTI(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
