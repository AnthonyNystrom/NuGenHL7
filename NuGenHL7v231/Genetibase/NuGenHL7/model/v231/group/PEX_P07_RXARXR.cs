...
{
	/// <summary> <p>Represents the PEX_P07_RXARXR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PEX_P07_RXARXR:AbstractGroup
	{
		...
		/// <summary> Creates a new PEX_P07_RXARXR Group.</summary>
		public PEX_P07_RXARXR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
