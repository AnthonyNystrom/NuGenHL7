...
{
	/// <summary> <p>Represents the PPT_PCL_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPT_PCL_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_PV1PV2 Group.</summary>
		public PPT_PCL_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
