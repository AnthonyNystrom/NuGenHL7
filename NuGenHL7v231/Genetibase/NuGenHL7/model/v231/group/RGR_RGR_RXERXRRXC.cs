...
{
	/// <summary> <p>Represents the RGR_RGR_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RGR_RGR_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RGR_RGR_RXERXRRXC Group.</summary>
		public RGR_RGR_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
