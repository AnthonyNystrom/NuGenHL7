...
{
	/// <summary> <p>Represents the NMR_N01_NCKNTENSTNTENSCNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class NMR_N01_NCKNTENSTNTENSCNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new NMR_N01_NCKNTENSTNTENSCNTE Group.</summary>
		public NMR_N01_NCKNTENSTNTENSCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of NTE3 (NTE - notes and comments segment) - creates it if necessary</summary>
