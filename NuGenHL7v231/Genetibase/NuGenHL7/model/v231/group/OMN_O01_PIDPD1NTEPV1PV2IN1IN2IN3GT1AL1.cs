...
{
	/// <summary> <p>Represents the OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 Group.  A Group is an ordered collection of message 
	...
	/// 3: OMN_O01_PV1PV2 (a Group object) <b>optional </b><br>
	/// 4: OMN_O01_IN1IN2IN3 (a Group object) <b>optional repeating</b><br>
	/// 5: GT1 (GT1 - guarantor segment) <b>optional </b><br>
	/// 6: AL1 (AL1 - patient allergy information segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1:AbstractGroup
	{
		...
		/// <summary> Returns OMN_O01_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public OMN_O01_PV1PV2 PV1PV2
		{
			get
			{
				OMN_O01_PV1PV2 ret = null;
				try
				{
					ret = (OMN_O01_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of OMN_O01_IN1IN2IN3 </summary>
		...
		/// <summary> Creates a new OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 Group.</summary>
		public OMN_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(OMN_O01_PV1PV2), false, false);
				this.add(typeof(OMN_O01_IN1IN2IN3), false, true);
		...
		/// <summary> Returns  first repetition of OMN_O01_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual OMN_O01_IN1IN2IN3 getIN1IN2IN3()
		{
			OMN_O01_IN1IN2IN3 ret = null;
			try
			{
				ret = (OMN_O01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of OMN_O01_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual OMN_O01_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (OMN_O01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
