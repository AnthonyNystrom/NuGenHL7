...
{
	/// <summary> <p>Represents the RAS_O01_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RAS_O01_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RAS_O01_RXERXRRXC Group.</summary>
		public RAS_O01_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
