...
{
	/// <summary> <p>Represents the ADT_A44_PIDPD1MRG Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ADT_A44_PIDPD1MRG:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A44_PIDPD1MRG Group.</summary>
		public ADT_A44_PIDPD1MRG(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
