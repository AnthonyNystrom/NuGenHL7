...
{
	/// <summary> <p>Represents the PPP_PCB_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPP_PCB_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_PV1PV2 Group.</summary>
		public PPP_PCB_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
