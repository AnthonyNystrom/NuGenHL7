...
{
	/// <summary> <p>Represents the RQP_I04_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQP_I04_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQP_I04_PRDCTD Group.</summary>
		public RQP_I04_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
