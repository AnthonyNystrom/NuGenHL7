...
{
	/// <summary> <p>Represents the RPA_I08_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPA_I08_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RPA_I08_IN1IN2IN3 Group.</summary>
		public RPA_I08_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
