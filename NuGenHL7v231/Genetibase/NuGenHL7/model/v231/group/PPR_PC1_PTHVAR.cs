...
{
	/// <summary> <p>Represents the PPR_PC1_PTHVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPR_PC1_PTHVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_PTHVAR Group.</summary>
		public PPR_PC1_PTHVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
