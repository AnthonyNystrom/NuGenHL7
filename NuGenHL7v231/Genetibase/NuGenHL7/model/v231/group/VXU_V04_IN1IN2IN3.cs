...
{
	/// <summary> <p>Represents the VXU_V04_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class VXU_V04_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new VXU_V04_IN1IN2IN3 Group.</summary>
		public VXU_V04_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
