...
{
	/// <summary> <p>Represents the RPI_I04_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPI_I04_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RPI_I04_IN1IN2IN3 Group.</summary>
		public RPI_I04_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
