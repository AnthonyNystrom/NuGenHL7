...
{
	/// <summary> <p>Represents the RDO_O01_RXCNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDO_O01_RXCNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new RDO_O01_RXCNTE Group.</summary>
		public RDO_O01_RXCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
