...
{
	/// <summary> <p>Represents the RDO_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDO_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RDO_O01_PV1PV2 Group.</summary>
		public RDO_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
