...
{
	/// <summary> <p>Represents the PPP_PCB_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPP_PCB_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_ROLVAR Group.</summary>
		public PPP_PCB_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
