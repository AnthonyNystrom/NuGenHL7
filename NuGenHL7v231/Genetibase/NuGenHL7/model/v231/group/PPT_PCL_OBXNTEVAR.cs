...
{
	/// <summary> <p>Represents the PPT_PCL_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPT_PCL_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_OBXNTEVAR Group.</summary>
		public PPT_PCL_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
