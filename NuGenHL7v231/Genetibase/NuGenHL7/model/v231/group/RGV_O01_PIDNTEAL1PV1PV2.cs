...
{
	/// <summary> <p>Represents the RGV_O01_PIDNTEAL1PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// 3: RGV_O01_PV1PV2 (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RGV_O01_PIDNTEAL1PV1PV2:AbstractGroup
	{
		...
		/// <summary> Returns RGV_O01_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public RGV_O01_PV1PV2 PV1PV2
		{
			get
			{
				RGV_O01_PV1PV2 ret = null;
				try
				{
					ret = (RGV_O01_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RGV_O01_PIDNTEAL1PV1PV2 Group.</summary>
		public RGV_O01_PIDNTEAL1PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(RGV_O01_PV1PV2), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
