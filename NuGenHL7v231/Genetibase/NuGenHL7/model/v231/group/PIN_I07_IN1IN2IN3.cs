...
{
	/// <summary> <p>Represents the PIN_I07_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PIN_I07_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new PIN_I07_IN1IN2IN3 Group.</summary>
		public PIN_I07_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
