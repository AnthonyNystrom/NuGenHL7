...
{
	/// <summary> <p>Represents the NMD_N02_NSTNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class NMD_N02_NSTNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new NMD_N02_NSTNTE Group.</summary>
		public NMD_N02_NSTNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
