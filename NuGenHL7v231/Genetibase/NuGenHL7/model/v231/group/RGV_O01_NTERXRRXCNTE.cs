...
{
	/// <summary> <p>Represents the RGV_O01_NTERXRRXCNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RGV_O01_NTERXRRXCNTE:AbstractGroup
	{
		...
		/// <summary> Returns RGV_O01_RXCNTE (a Group object) - creates it if necessary</summary>
		virtual public RGV_O01_RXCNTE RXCNTE
		{
			get
			{
				...
				try
				{
					ret = (RGV_O01_RXCNTE) this.get_Renamed("RXCNTE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RGV_O01_NTERXRRXCNTE Group.</summary>
		public RGV_O01_NTERXRRXCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				this.add(typeof(NTE), true, true);
				this.add(typeof(RXR), true, true);
				this.add(typeof(RGV_O01_RXCNTE), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
