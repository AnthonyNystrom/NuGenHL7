...
{
	/// <summary> <p>Represents the ORU_R01_PIDPD1NK1NTEPV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// 4: ORU_R01_PV1PV2 (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORU_R01_PIDPD1NK1NTEPV1PV2:AbstractGroup
	{
		...
		/// <summary> Returns ORU_R01_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public ORU_R01_PV1PV2 PV1PV2
		{
			get
			{
				ORU_R01_PV1PV2 ret = null;
				try
				{
					ret = (ORU_R01_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORU_R01_PIDPD1NK1NTEPV1PV2 Group.</summary>
		public ORU_R01_PIDPD1NK1NTEPV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(ORU_R01_PV1PV2), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
