...
{
	/// <summary> <p>Represents the RRE_O02_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RRE_O02_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RRE_O02_RXERXRRXC Group.</summary>
		public RRE_O02_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
