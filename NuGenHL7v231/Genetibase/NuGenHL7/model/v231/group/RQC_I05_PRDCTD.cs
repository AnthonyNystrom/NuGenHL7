...
{
	/// <summary> <p>Represents the RQC_I05_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQC_I05_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQC_I05_PRDCTD Group.</summary>
		public RQC_I05_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
