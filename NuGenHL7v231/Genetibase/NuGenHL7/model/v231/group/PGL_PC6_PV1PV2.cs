...
{
	/// <summary> <p>Represents the PGL_PC6_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PGL_PC6_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_PV1PV2 Group.</summary>
		public PGL_PC6_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
