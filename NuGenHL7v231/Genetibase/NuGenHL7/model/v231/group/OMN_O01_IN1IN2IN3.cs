...
{
	/// <summary> <p>Represents the OMN_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class OMN_O01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new OMN_O01_IN1IN2IN3 Group.</summary>
		public OMN_O01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
