...
{
	/// <summary> <p>Represents the RPA_I08_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPA_I08_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RPA_I08_PV1PV2 Group.</summary>
		public RPA_I08_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
