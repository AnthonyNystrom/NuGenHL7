...
{
	/// <summary> <p>Represents the RDR_RDR_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDR_RDR_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RDR_RDR_RXERXRRXC Group.</summary>
		public RDR_RDR_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
