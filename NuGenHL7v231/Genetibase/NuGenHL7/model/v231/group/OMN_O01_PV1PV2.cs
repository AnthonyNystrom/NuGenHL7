...
{
	/// <summary> <p>Represents the OMN_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class OMN_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new OMN_O01_PV1PV2 Group.</summary>
		public OMN_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
