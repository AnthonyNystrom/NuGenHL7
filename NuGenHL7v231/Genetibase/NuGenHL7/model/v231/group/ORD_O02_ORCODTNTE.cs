...
{
	/// <summary> <p>Represents the ORD_O02_ORCODTNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORD_O02_ORCODTNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new ORD_O02_ORCODTNTE Group.</summary>
		public ORD_O02_ORCODTNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
		...
		/// <summary> Returns  first repetition of ODT (ODT - diet tray instructions segment) - creates it if necessary</summary>
