...
{
	/// <summary> <p>Represents the PTR_PCF_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PTR_PCF_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PTR_PCF_ROLVAR Group.</summary>
		public PTR_PCF_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
