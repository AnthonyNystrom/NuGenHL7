...
{
	/// <summary> <p>Represents the ADR_A19_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ADR_A19_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new ADR_A19_IN1IN2IN3 Group.</summary>
		public ADR_A19_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
