...
{
	/// <summary> <p>Represents the ORM_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 Group.  A Group is an ordered collection of message 
	...
	/// 3: ORM_O01_PV1PV2 (a Group object) <b>optional </b><br>
	/// 4: ORM_O01_IN1IN2IN3 (a Group object) <b>optional repeating</b><br>
	/// 5: GT1 (GT1 - guarantor segment) <b>optional </b><br>
	/// 6: AL1 (AL1 - patient allergy information segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class ORM_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1:AbstractGroup
	{
		...
		/// <summary> Returns ORM_O01_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public ORM_O01_PV1PV2 PV1PV2
		{
			get
			{
				ORM_O01_PV1PV2 ret = null;
				try
				{
					ret = (ORM_O01_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of ORM_O01_IN1IN2IN3 </summary>
		...
		/// <summary> Creates a new ORM_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 Group.</summary>
		public ORM_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(ORM_O01_PV1PV2), false, false);
				this.add(typeof(ORM_O01_IN1IN2IN3), false, true);
		...
		/// <summary> Returns  first repetition of ORM_O01_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual ORM_O01_IN1IN2IN3 getIN1IN2IN3()
		{
			ORM_O01_IN1IN2IN3 ret = null;
			try
			{
				ret = (ORM_O01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORM_O01_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORM_O01_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (ORM_O01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
