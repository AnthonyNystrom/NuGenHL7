...
{
	/// <summary> <p>Represents the RPA_I08_AUTCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPA_I08_AUTCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RPA_I08_AUTCTD Group.</summary>
		public RPA_I08_AUTCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
