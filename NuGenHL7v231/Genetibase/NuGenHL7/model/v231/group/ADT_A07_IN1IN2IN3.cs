...
{
	/// <summary> <p>Represents the ADT_A07_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ADT_A07_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A07_IN1IN2IN3 Group.</summary>
		public ADT_A07_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
