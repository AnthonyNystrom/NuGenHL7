...
{
	/// <summary> <p>Represents the OMD_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class OMD_O01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new OMD_O01_IN1IN2IN3 Group.</summary>
		public OMD_O01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
