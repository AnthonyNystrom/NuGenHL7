...
{
	/// <summary> <p>Represents the DFT_P03_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class DFT_P03_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new DFT_P03_IN1IN2IN3 Group.</summary>
		public DFT_P03_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
