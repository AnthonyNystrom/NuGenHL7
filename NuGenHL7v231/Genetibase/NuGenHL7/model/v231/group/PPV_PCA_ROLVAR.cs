...
{
	/// <summary> <p>Represents the PPV_PCA_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPV_PCA_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_ROLVAR Group.</summary>
		public PPV_PCA_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
