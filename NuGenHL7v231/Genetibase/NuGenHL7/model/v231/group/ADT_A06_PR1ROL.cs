...
{
	/// <summary> <p>Represents the ADT_A06_PR1ROL Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ADT_A06_PR1ROL:AbstractGroup
	{
		...
		/// <summary> Creates a new ADT_A06_PR1ROL Group.</summary>
		public ADT_A06_PR1ROL(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
