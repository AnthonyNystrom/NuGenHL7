...
{
	/// <summary> <p>Represents the OMS_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class OMS_O01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new OMS_O01_IN1IN2IN3 Group.</summary>
		public OMS_O01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
