...
{
	/// <summary> <p>Represents the VXR_V03_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class VXR_V03_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new VXR_V03_PV1PV2 Group.</summary>
		public VXR_V03_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
