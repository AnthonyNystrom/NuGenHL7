...
{
	/// <summary> <p>Represents the PRR_PC5_PTHVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PRR_PC5_PTHVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_PTHVAR Group.</summary>
		public PRR_PC5_PTHVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
