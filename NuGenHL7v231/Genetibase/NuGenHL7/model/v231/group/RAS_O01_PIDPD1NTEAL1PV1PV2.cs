...
{
	/// <summary> <p>Represents the RAS_O01_PIDPD1NTEAL1PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// 4: RAS_O01_PV1PV2 (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RAS_O01_PIDPD1NTEAL1PV1PV2:AbstractGroup
	{
		...
		/// <summary> Returns RAS_O01_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public RAS_O01_PV1PV2 PV1PV2
		{
			get
			{
				RAS_O01_PV1PV2 ret = null;
				try
				{
					ret = (RAS_O01_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RAS_O01_PIDPD1NTEAL1PV1PV2 Group.</summary>
		public RAS_O01_PIDPD1NTEAL1PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(RAS_O01_PV1PV2), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
