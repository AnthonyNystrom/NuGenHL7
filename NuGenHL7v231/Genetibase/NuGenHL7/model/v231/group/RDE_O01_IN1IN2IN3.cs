...
{
	/// <summary> <p>Represents the RDE_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDE_O01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O01_IN1IN2IN3 Group.</summary>
		public RDE_O01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
