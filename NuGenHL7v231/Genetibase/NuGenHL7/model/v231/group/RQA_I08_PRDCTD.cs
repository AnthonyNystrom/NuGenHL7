...
{
	/// <summary> <p>Represents the RQA_I08_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQA_I08_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQA_I08_PRDCTD Group.</summary>
		public RQA_I08_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
