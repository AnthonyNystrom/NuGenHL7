...
{
	/// <summary> <p>Represents the ORM_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORM_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new ORM_O01_PV1PV2 Group.</summary>
		public ORM_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
