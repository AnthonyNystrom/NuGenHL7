...
{
	/// <summary> <p>Represents the RDO_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 Group.  A Group is an ordered collection of message 
	...
	/// 3: RDO_O01_PV1PV2 (a Group object) <b>optional </b><br>
	/// 4: RDO_O01_IN1IN2IN3 (a Group object) <b>optional repeating</b><br>
	/// 5: GT1 (GT1 - guarantor segment) <b>optional </b><br>
	/// 6: AL1 (AL1 - patient allergy information segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class RDO_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1:AbstractGroup
	{
		...
		/// <summary> Returns RDO_O01_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public RDO_O01_PV1PV2 PV1PV2
		{
			get
			{
				RDO_O01_PV1PV2 ret = null;
				try
				{
					ret = (RDO_O01_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of RDO_O01_IN1IN2IN3 </summary>
		...
		/// <summary> Creates a new RDO_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1 Group.</summary>
		public RDO_O01_PIDPD1NTEPV1PV2IN1IN2IN3GT1AL1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(RDO_O01_PV1PV2), false, false);
				this.add(typeof(RDO_O01_IN1IN2IN3), false, true);
		...
		/// <summary> Returns  first repetition of RDO_O01_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual RDO_O01_IN1IN2IN3 getIN1IN2IN3()
		{
			RDO_O01_IN1IN2IN3 ret = null;
			try
			{
				ret = (RDO_O01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RDO_O01_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RDO_O01_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (RDO_O01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
