...
{
	/// <summary> <p>Represents the SQR_S25_AISNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SQR_S25_AISNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SQR_S25_AISNTE Group.</summary>
		public SQR_S25_AISNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
