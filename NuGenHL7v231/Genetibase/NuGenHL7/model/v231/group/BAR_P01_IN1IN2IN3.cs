...
{
	/// <summary> <p>Represents the BAR_P01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class BAR_P01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new BAR_P01_IN1IN2IN3 Group.</summary>
		public BAR_P01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
