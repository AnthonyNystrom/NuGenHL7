...
{
	/// <summary> <p>Represents the PPG_PCG_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPG_PCG_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_OBXNTEVAR Group.</summary>
		public PPG_PCG_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
