...
{
	/// <summary> <p>Represents the RDO_O01_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDO_O01_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RDO_O01_IN1IN2IN3 Group.</summary>
		public RDO_O01_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
