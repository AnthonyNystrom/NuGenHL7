...
{
	/// <summary> <p>Represents the RAR_RAR_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RAR_RAR_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RAR_RAR_RXERXRRXC Group.</summary>
		public RAR_RAR_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
