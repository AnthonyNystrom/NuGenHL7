...
{
	/// <summary> <p>Represents the PPG_PCG_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPG_PCG_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_ROLVAR Group.</summary>
		public PPG_PCG_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
