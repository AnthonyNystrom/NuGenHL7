...
{
	/// <summary> <p>Represents the RDE_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDE_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RDE_O01_PV1PV2 Group.</summary>
		public RDE_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
