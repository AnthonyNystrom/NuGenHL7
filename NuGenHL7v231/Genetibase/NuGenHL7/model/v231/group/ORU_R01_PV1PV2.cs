...
{
	/// <summary> <p>Represents the ORU_R01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORU_R01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new ORU_R01_PV1PV2 Group.</summary>
		public ORU_R01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
