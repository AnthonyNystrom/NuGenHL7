...
{
	/// <summary> <p>Represents the PPP_PCB_GOLNTEVARROLVAROBXNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPP_PCB_GOLNTEVARROLVAROBXNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_GOLNTEVARROLVAROBXNTE Group.</summary>
		public PPP_PCB_GOLNTEVARROLVAROBXNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
