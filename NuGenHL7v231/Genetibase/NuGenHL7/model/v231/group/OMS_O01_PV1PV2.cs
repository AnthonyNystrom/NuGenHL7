...
{
	/// <summary> <p>Represents the OMS_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class OMS_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new OMS_O01_PV1PV2 Group.</summary>
		public OMS_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
