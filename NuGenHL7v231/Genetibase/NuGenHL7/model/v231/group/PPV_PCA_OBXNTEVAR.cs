...
{
	/// <summary> <p>Represents the PPV_PCA_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPV_PCA_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_OBXNTEVAR Group.</summary>
		public PPV_PCA_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
