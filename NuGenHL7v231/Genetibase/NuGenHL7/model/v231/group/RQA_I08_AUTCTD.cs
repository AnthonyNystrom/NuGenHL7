...
{
	/// <summary> <p>Represents the RQA_I08_AUTCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQA_I08_AUTCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQA_I08_AUTCTD Group.</summary>
		public RQA_I08_AUTCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
