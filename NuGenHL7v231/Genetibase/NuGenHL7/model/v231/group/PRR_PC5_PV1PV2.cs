...
{
	/// <summary> <p>Represents the PRR_PC5_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PRR_PC5_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_PV1PV2 Group.</summary>
		public PRR_PC5_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
