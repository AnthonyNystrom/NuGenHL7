...
{
	/// <summary> <p>Represents the MFN_M09_OM3OM4 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class MFN_M09_OM3OM4:AbstractGroup
	{
		...
		/// <summary> Creates a new MFN_M09_OM3OM4 Group.</summary>
		public MFN_M09_OM3OM4(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
