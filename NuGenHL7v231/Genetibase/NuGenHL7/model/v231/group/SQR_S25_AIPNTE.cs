...
{
	/// <summary> <p>Represents the SQR_S25_AIPNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SQR_S25_AIPNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SQR_S25_AIPNTE Group.</summary>
		public SQR_S25_AIPNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
