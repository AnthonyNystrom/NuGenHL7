...
{
	/// <summary> <p>Represents the SRM_S01_AILAPRNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRM_S01_AILAPRNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRM_S01_AILAPRNTE Group.</summary>
		public SRM_S01_AILAPRNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
