...
{
	/// <summary> <p>Represents the PPV_PCA_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPV_PCA_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PPV_PCA_PV1PV2 Group.</summary>
		public PPV_PCA_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
