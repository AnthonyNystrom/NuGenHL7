...
{
	/// <summary> <p>Represents the RAS_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RAS_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RAS_O01_PV1PV2 Group.</summary>
		public RAS_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
