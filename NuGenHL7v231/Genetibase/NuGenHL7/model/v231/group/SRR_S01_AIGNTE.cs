...
{
	/// <summary> <p>Represents the SRR_S01_AIGNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRR_S01_AIGNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRR_S01_AIGNTE Group.</summary>
		public SRR_S01_AIGNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
