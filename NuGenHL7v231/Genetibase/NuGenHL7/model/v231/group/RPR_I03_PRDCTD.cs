...
{
	/// <summary> <p>Represents the RPR_I03_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPR_I03_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RPR_I03_PRDCTD Group.</summary>
		public RPR_I03_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
