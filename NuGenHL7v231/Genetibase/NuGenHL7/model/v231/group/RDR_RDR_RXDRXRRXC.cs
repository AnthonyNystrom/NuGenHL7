...
{
	/// <summary> <p>Represents the RDR_RDR_RXDRXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDR_RDR_RXDRXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RDR_RDR_RXDRXRRXC Group.</summary>
		public RDR_RDR_RXDRXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
