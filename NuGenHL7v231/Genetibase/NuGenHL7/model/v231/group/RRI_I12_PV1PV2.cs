...
{
	/// <summary> <p>Represents the RRI_I12_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RRI_I12_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RRI_I12_PV1PV2 Group.</summary>
		public RRI_I12_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
