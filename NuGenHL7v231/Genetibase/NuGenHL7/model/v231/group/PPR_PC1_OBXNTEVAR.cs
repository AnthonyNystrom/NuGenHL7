...
{
	/// <summary> <p>Represents the PPR_PC1_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPR_PC1_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_OBXNTEVAR Group.</summary>
		public PPR_PC1_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
