...
{
	/// <summary> <p>Represents the RDS_O01_NTERXRRXCNTE Group.  A Group is an ordered collection of message 
	...
	/// 2: RDS_O01_RXCNTE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class RDS_O01_NTERXRRXCNTE:AbstractGroup
	{
		...
		/// <summary> Returns RDS_O01_RXCNTE (a Group object) - creates it if necessary</summary>
		virtual public RDS_O01_RXCNTE RXCNTE
		{
			get
			{
				RDS_O01_RXCNTE ret = null;
				try
				{
					ret = (RDS_O01_RXCNTE) this.get_Renamed("RXCNTE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RDS_O01_NTERXRRXCNTE Group.</summary>
		public RDS_O01_NTERXRRXCNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				this.add(typeof(NTE), true, true);
				this.add(typeof(RXR), true, true);
				this.add(typeof(RDS_O01_RXCNTE), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
