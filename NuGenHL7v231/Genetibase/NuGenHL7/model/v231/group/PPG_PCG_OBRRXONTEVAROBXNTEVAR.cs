...
{
	/// <summary> <p>Represents the PPG_PCG_OBRRXONTEVAROBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPG_PCG_OBRRXONTEVAROBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PPG_PCG_OBXNTEVAR </summary>
		...
		/// <summary> Creates a new PPG_PCG_OBRRXONTEVAROBXNTEVAR Group.</summary>
		public PPG_PCG_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(PPG_PCG_OBXNTEVAR), false, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of PPG_PCG_OBXNTEVAR (a Group object) - creates it if necessary</summary>
		public virtual PPG_PCG_OBXNTEVAR getOBXNTEVAR()
		{
			PPG_PCG_OBXNTEVAR ret = null;
			try
			{
				ret = (PPG_PCG_OBXNTEVAR) this.get_Renamed("OBXNTEVAR");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of PPG_PCG_OBXNTEVAR
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPG_PCG_OBXNTEVAR getOBXNTEVAR(int rep)
		{
			return (PPG_PCG_OBXNTEVAR) this.get_Renamed("OBXNTEVAR", rep);
		}
	}
}