...
{
	/// <summary> <p>Represents the DFT_P03_PR1ROL Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class DFT_P03_PR1ROL:AbstractGroup
	{
		...
		/// <summary> Creates a new DFT_P03_PR1ROL Group.</summary>
		public DFT_P03_PR1ROL(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
