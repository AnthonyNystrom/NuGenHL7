...
{
	/// <summary> <p>Represents the PGL_PC6_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PGL_PC6_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PGL_PC6_ROLVAR Group.</summary>
		public PGL_PC6_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
