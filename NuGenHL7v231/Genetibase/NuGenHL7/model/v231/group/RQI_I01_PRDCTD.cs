...
{
	/// <summary> <p>Represents the RQI_I01_PRDCTD Group.  A Group is an ordered collection of message 
	...
	public class RQI_I01_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQI_I01_PRDCTD Group.</summary>
		public RQI_I01_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
