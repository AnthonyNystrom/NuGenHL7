...
{
	/// <summary> <p>Represents the RRI_I12_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RRI_I12_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RRI_I12_PRDCTD Group.</summary>
		public RRI_I12_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
