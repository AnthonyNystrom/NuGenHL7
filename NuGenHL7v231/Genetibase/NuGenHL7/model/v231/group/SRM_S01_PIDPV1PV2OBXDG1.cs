...
{
	/// <summary> <p>Represents the SRM_S01_PIDPV1PV2OBXDG1 Group.  A Group is an ordered collection of message 
	...
	/// 4: DG1 (DG1 - diagnosis segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class SRM_S01_PIDPV1PV2OBXDG1:AbstractGroup
	{
		...
		/// <summary> Creates a new SRM_S01_PIDPV1PV2OBXDG1 Group.</summary>
		public SRM_S01_PIDPV1PV2OBXDG1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
