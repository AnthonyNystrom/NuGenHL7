...
{
	/// <summary> <p>Represents the OMD_O01_ORCODTNTE Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: ORC (ORC - common order segment) <b></b><br>
	/// 1: ODT (ODT - diet tray instructions segment) <b>repeating</b><br>
	/// 2: NTE (NTE - notes and comments segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class OMD_O01_ORCODTNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new OMD_O01_ORCODTNTE Group.</summary>
		public OMD_O01_ORCODTNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
