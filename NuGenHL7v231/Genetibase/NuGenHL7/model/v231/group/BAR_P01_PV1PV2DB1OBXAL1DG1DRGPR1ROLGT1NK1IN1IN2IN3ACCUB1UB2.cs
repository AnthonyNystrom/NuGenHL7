...
{
	/// <summary> <p>Represents the BAR_P01_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2 Group.  A Group is an ordered collection of message 
	...
	/// 7: BAR_P01_PR1ROL (a Group object) <b>optional repeating</b><br>
	...
	/// 10: BAR_P01_IN1IN2IN3 (a Group object) <b>optional repeating</b><br>
	...
	/// </summary>
	[Serializable]
	public class BAR_P01_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of BAR_P01_PR1ROL </summary>
		...
		/// <summary> Returns the number of existing repetitions of BAR_P01_IN1IN2IN3 </summary>
		...
		/// <summary> Creates a new BAR_P01_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2 Group.</summary>
		public BAR_P01_PV1PV2DB1OBXAL1DG1DRGPR1ROLGT1NK1IN1IN2IN3ACCUB1UB2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(BAR_P01_PR1ROL), false, true);
				this.add(typeof(GT1), false, true);
				this.add(typeof(NK1), false, true);
				this.add(typeof(BAR_P01_IN1IN2IN3), false, true);
		...
		/// <summary> Returns  first repetition of BAR_P01_PR1ROL (a Group object) - creates it if necessary</summary>
		public virtual BAR_P01_PR1ROL getPR1ROL()
		{
			BAR_P01_PR1ROL ret = null;
			try
			{
				ret = (BAR_P01_PR1ROL) this.get_Renamed("PR1ROL");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of BAR_P01_PR1ROL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P01_PR1ROL getPR1ROL(int rep)
		{
			return (BAR_P01_PR1ROL) this.get_Renamed("PR1ROL", rep);
		}
		...
		/// <summary> Returns  first repetition of BAR_P01_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual BAR_P01_IN1IN2IN3 getIN1IN2IN3()
		{
			BAR_P01_IN1IN2IN3 ret = null;
			try
			{
				ret = (BAR_P01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of BAR_P01_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P01_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (BAR_P01_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
	}
}