...
{
	/// <summary> <p>Represents the PRR_PC5_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PRR_PC5_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PRR_PC5_OBXNTEVAR Group.</summary>
		public PRR_PC5_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
