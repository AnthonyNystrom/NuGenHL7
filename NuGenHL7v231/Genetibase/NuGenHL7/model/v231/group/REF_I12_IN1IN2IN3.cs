...
{
	/// <summary> <p>Represents the REF_I12_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class REF_I12_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new REF_I12_IN1IN2IN3 Group.</summary>
		public REF_I12_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
