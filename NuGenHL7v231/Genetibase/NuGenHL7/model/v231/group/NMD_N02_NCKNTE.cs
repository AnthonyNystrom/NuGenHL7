...
{
	/// <summary> <p>Represents the NMD_N02_NCKNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class NMD_N02_NCKNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new NMD_N02_NCKNTE Group.</summary>
		public NMD_N02_NCKNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
