...
{
	/// <summary> <p>Represents the ADR_A19_PR1ROL Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ADR_A19_PR1ROL:AbstractGroup
	{
		...
		/// <summary> Creates a new ADR_A19_PR1ROL Group.</summary>
		public ADR_A19_PR1ROL(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
