...
{
	/// <summary> <p>Represents the REF_I12_AUTCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class REF_I12_AUTCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new REF_I12_AUTCTD Group.</summary>
		public REF_I12_AUTCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
