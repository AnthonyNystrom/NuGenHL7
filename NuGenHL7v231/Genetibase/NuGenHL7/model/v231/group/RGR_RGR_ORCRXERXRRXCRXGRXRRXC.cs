...
{
	/// <summary> <p>Represents the RGR_RGR_ORCRXERXRRXCRXGRXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RGR_RGR_ORCRXERXRRXCRXGRXRRXC:AbstractGroup
	{
		...
		/// <summary> Returns RGR_RGR_RXERXRRXC (a Group object) - creates it if necessary</summary>
		virtual public RGR_RGR_RXERXRRXC RXERXRRXC
		{
			get
			{
				...
				try
				{
					ret = (RGR_RGR_RXERXRRXC) this.get_Renamed("RXERXRRXC");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of RXG </summary>
		virtual public int RXGReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Creates a new RGR_RGR_ORCRXERXRRXCRXGRXRRXC Group.</summary>
		public RGR_RGR_ORCRXERXRRXCRXGRXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				this.add(typeof(ORC), true, false);
				this.add(typeof(RGR_RGR_RXERXRRXC), false, false);
		...
		/// <summary> Returns  first repetition of RXG (RXG - pharmacy/treatment give segment) - creates it if necessary</summary>
		public virtual RXG getRXG()
		{
			RXG ret = null;
			try
			{
