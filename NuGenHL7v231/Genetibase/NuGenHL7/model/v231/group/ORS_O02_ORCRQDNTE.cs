...
{
	/// <summary> <p>Represents the ORS_O02_ORCRQDNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class ORS_O02_ORCRQDNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new ORS_O02_ORCRQDNTE Group.</summary>
		public ORS_O02_ORCRQDNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
