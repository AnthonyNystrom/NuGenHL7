...
{
	/// <summary> <p>Represents the REF_I12_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class REF_I12_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new REF_I12_PRDCTD Group.</summary>
		public REF_I12_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
