...
{
	/// <summary> <p>Represents the PPT_PCL_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPT_PCL_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPT_PCL_ROLVAR Group.</summary>
		public PPT_PCL_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
