...
{
	/// <summary> <p>Represents the RQI_I02_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQI_I02_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new RQI_I02_IN1IN2IN3 Group.</summary>
		public RQI_I02_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
