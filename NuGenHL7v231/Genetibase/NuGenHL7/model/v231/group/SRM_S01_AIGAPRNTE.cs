...
{
	/// <summary> <p>Represents the SRM_S01_AIGAPRNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRM_S01_AIGAPRNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRM_S01_AIGAPRNTE Group.</summary>
		public SRM_S01_AIGAPRNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
