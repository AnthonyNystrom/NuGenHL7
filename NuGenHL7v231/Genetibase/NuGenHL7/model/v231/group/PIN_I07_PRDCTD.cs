...
{
	/// <summary> <p>Represents the PIN_I07_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PIN_I07_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new PIN_I07_PRDCTD Group.</summary>
		public PIN_I07_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
