...
{
	/// <summary> <p>Represents the RGV_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RGV_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RGV_O01_PV1PV2 Group.</summary>
		public RGV_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
