...
{
	/// <summary> <p>Represents the VXX_V02_PIDNK1 Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: PID (PID - patient identification segment) <b></b><br>
	/// 1: NK1 (NK1 - next of kin / associated parties segment-) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class VXX_V02_PIDNK1:AbstractGroup
	{
		...
		/// <summary> Creates a new VXX_V02_PIDNK1 Group.</summary>
		public VXX_V02_PIDNK1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
