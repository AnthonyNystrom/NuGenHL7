...
{
	/// <summary> <p>Represents the SRM_S01_AIPAPRNTE Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class SRM_S01_AIPAPRNTE:AbstractGroup
	{
		...
		/// <summary> Creates a new SRM_S01_AIPAPRNTE Group.</summary>
		public SRM_S01_AIPAPRNTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
