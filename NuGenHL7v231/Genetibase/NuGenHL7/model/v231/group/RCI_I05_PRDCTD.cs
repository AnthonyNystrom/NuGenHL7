...
{
	/// <summary> <p>Represents the RCI_I05_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RCI_I05_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RCI_I05_PRDCTD Group.</summary>
		public RCI_I05_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
