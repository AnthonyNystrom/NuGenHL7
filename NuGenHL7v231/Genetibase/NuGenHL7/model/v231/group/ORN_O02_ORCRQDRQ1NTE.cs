...
{
	/// <summary> <p>Represents the ORN_O02_ORCRQDRQ1NTE Group.  A Group is an ordered collection of message 
	/// segments that can repeat together or be optionally in/excluded together.
	/// This Group contains the following elements: </p>
	/// 0: ORC (ORC - common order segment) <b></b><br>
	/// 1: RQD (RQD - requisition detail segment) <b></b><br>
	/// 2: RQ1 (RQ1 - requisition detail-1 segment) <b>optional </b><br>
	/// 3: NTE (NTE - notes and comments segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class ORN_O02_ORCRQDRQ1NTE:AbstractGroup
	{
		...
		/// <summary> Creates a new ORN_O02_ORCRQDRQ1NTE Group.</summary>
		public ORN_O02_ORCRQDRQ1NTE(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
