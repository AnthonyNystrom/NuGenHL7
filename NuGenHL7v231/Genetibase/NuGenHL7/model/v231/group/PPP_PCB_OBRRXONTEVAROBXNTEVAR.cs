...
{
	/// <summary> <p>Represents the PPP_PCB_OBRRXONTEVAROBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// 4: PPP_PCB_OBXNTEVAR (a Group object) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class PPP_PCB_OBRRXONTEVAROBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Returns the number of existing repetitions of PPP_PCB_OBXNTEVAR </summary>
		...
		/// <summary> Creates a new PPP_PCB_OBRRXONTEVAROBXNTEVAR Group.</summary>
		public PPP_PCB_OBRRXONTEVAROBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
				...
				this.add(typeof(PPP_PCB_OBXNTEVAR), false, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of PPP_PCB_OBXNTEVAR (a Group object) - creates it if necessary</summary>
		public virtual PPP_PCB_OBXNTEVAR getOBXNTEVAR()
		{
			PPP_PCB_OBXNTEVAR ret = null;
			try
			{
				ret = (PPP_PCB_OBXNTEVAR) this.get_Renamed("OBXNTEVAR");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of PPP_PCB_OBXNTEVAR
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PPP_PCB_OBXNTEVAR getOBXNTEVAR(int rep)
		{
			return (PPP_PCB_OBXNTEVAR) this.get_Renamed("OBXNTEVAR", rep);
		}
	}
}