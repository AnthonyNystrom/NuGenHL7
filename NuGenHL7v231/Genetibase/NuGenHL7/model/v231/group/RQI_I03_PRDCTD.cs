...
{
	/// <summary> <p>Represents the RQI_I03_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQI_I03_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RQI_I03_PRDCTD Group.</summary>
		public RQI_I03_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
