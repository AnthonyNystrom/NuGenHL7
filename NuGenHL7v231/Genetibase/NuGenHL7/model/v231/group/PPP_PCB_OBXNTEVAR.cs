...
{
	/// <summary> <p>Represents the PPP_PCB_OBXNTEVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPP_PCB_OBXNTEVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPP_PCB_OBXNTEVAR Group.</summary>
		public PPP_PCB_OBXNTEVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
