...
{
	/// <summary> <p>Represents the RQA_I08_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RQA_I08_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new RQA_I08_PV1PV2 Group.</summary>
		public RQA_I08_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
