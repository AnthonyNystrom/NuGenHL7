...
{
	/// <summary> <p>Represents the RRG_O02_RXGRXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RRG_O02_RXGRXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RRG_O02_RXGRXRRXC Group.</summary>
		public RRG_O02_RXGRXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
