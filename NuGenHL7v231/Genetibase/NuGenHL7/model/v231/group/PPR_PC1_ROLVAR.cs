...
{
	/// <summary> <p>Represents the PPR_PC1_ROLVAR Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPR_PC1_ROLVAR:AbstractGroup
	{
		...
		/// <summary> Creates a new PPR_PC1_ROLVAR Group.</summary>
		public PPR_PC1_ROLVAR(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
