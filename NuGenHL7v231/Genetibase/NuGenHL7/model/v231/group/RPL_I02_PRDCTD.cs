...
{
	/// <summary> <p>Represents the RPL_I02_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPL_I02_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RPL_I02_PRDCTD Group.</summary>
		public RPL_I02_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
