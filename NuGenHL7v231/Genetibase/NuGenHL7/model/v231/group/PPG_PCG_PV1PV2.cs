...
{
	/// <summary> <p>Represents the PPG_PCG_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class PPG_PCG_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new PPG_PCG_PV1PV2 Group.</summary>
		public PPG_PCG_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
