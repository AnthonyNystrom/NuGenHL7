...
{
	/// <summary> <p>Represents the RDS_O01_RXERXRRXC Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RDS_O01_RXERXRRXC:AbstractGroup
	{
		...
		/// <summary> Creates a new RDS_O01_RXERXRRXC Group.</summary>
		public RDS_O01_RXERXRRXC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
