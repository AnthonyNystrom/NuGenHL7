...
{
	/// <summary> <p>Represents the VXR_V03_IN1IN2IN3 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class VXR_V03_IN1IN2IN3:AbstractGroup
	{
		...
		/// <summary> Creates a new VXR_V03_IN1IN2IN3 Group.</summary>
		public VXR_V03_IN1IN2IN3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
