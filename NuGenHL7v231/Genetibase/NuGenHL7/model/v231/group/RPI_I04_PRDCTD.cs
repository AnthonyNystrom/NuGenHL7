...
{
	/// <summary> <p>Represents the RPI_I04_PRDCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RPI_I04_PRDCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RPI_I04_PRDCTD Group.</summary>
		public RPI_I04_PRDCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
