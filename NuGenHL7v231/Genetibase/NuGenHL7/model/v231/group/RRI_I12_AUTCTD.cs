...
{
	/// <summary> <p>Represents the RRI_I12_AUTCTD Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class RRI_I12_AUTCTD:AbstractGroup
	{
		...
		/// <summary> Creates a new RRI_I12_AUTCTD Group.</summary>
		public RRI_I12_AUTCTD(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
