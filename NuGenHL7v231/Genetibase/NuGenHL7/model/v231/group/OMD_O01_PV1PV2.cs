...
{
	/// <summary> <p>Represents the OMD_O01_PV1PV2 Group.  A Group is an ordered collection of message 
	...
	/// </summary>
	[Serializable]
	public class OMD_O01_PV1PV2:AbstractGroup
	{
		...
		/// <summary> Creates a new OMD_O01_PV1PV2 Group.</summary>
		public OMD_O01_PV1PV2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			try
			{
