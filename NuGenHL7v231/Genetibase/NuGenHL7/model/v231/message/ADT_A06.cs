...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A06 message structure (see chapter ?). This structure contains the 
	...
	/// 4: MRG (MRG - merge patient information segment-) <b>optional </b><br>
	/// 5: NK1 (NK1 - next of kin / associated parties segment-) <b>optional repeating</b><br>
	/// 6: PV1 (PV1 - patient visit segment-) <b></b><br>
	/// 7: PV2 (PV2 - patient visit - additional information segment) <b>optional </b><br>
	/// 8: DB1 (DB1 - Disability segment) <b>optional repeating</b><br>
	/// 9: OBX (OBX - observation/result segment) <b>optional repeating</b><br>
	/// 10: AL1 (AL1 - patient allergy information segment) <b>optional repeating</b><br>
	/// 11: DG1 (DG1 - diagnosis segment) <b>optional repeating</b><br>
	/// 12: DRG (DRG - diagnosis related group segment) <b>optional </b><br>
	/// 13: ADT_A06_PR1ROL (a Group object) <b>optional repeating</b><br>
	/// 14: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
	/// 15: ADT_A06_IN1IN2IN3 (a Group object) <b>optional repeating</b><br>
	/// 16: ACC (ACC - accident segment) <b>optional </b><br>
	/// 17: UB1 (UB1 - UB82 data segment) <b>optional </b><br>
	/// 18: UB2 (UB2 - UB92 data segment) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ADT_A06:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A06_PR1ROL </summary>
		...
		/// <summary> Returns the number of existing repetitions of ADT_A06_IN1IN2IN3 </summary>
		...
		/// <summary> Creates a new ADT_A06 Group with custom ModelClassFactory.</summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ADT_A06_PR1ROL), false, true);
				this.add(typeof(GT1), false, true);
				this.add(typeof(ADT_A06_IN1IN2IN3), false, true);
		...
		/// <summary> Returns  first repetition of ADT_A06_PR1ROL (a Group object) - creates it if necessary</summary>
		public virtual ADT_A06_PR1ROL getPR1ROL()
		{
			ADT_A06_PR1ROL ret = null;
			try
			{
				ret = (ADT_A06_PR1ROL) this.get_Renamed("PR1ROL");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A06_PR1ROL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A06_PR1ROL getPR1ROL(int rep)
		{
			return (ADT_A06_PR1ROL) this.get_Renamed("PR1ROL", rep);
		}
		...
		/// <summary> Returns  first repetition of ADT_A06_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual ADT_A06_IN1IN2IN3 getIN1IN2IN3()
		{
			ADT_A06_IN1IN2IN3 ret = null;
			try
			{
				ret = (ADT_A06_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A06_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A06_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (ADT_A06_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
	}
}