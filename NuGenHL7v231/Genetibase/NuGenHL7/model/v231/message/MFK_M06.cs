...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a MFK_M06 message structure (see chapter ?). This structure contains the 
	...
	public class MFK_M06:AbstractMessage
	{
		...
		/// <summary> Creates a new MFK_M06 Group with custom ModelClassFactory.</summary>
		public MFK_M06(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MFK_M06 Group with DefaultModelClassFactory. </summary>
