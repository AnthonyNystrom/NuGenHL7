...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a REF_I12 message structure (see chapter null). This structure contains the 
	...
	public class REF_I12:AbstractMessage
	{
		...
		/// <summary> Returns REF_I12_AUTCTD (a Group object) - creates it if necessary</summary>
		virtual public REF_I12_AUTCTD AUTCTD
		{
			get
			{
				...
				try
				{
					ret = (REF_I12_AUTCTD) this.get_Renamed("AUTCTD");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of REF_I12_PRDCTD </summary>
		...
		/// <summary> Returns the number of existing repetitions of REF_I12_IN1IN2IN3 </summary>
		...
		/// <summary> Returns the number of existing repetitions of REF_I12_PR1AUTCTD </summary>
		...
		/// <summary> Returns the number of existing repetitions of REF_I12_OBRNTEOBXNTE </summary>
		...
		/// <summary> Returns REF_I12_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public REF_I12_PV1PV2 PV1PV2
		{
			get
			{
				...
				try
				{
					ret = (REF_I12_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(REF_I12_AUTCTD), false, false);
				this.add(typeof(REF_I12_PRDCTD), true, true);
				this.add(typeof(PID), true, false);
				this.add(typeof(NK1), false, true);
				this.add(typeof(GT1), false, true);
				this.add(typeof(REF_I12_IN1IN2IN3), false, true);
				this.add(typeof(ACC), false, false);
				this.add(typeof(DG1), false, true);
				this.add(typeof(DRG), false, true);
				this.add(typeof(AL1), false, true);
				this.add(typeof(REF_I12_PR1AUTCTD), false, true);
				this.add(typeof(REF_I12_OBRNTEOBXNTE), false, true);
				this.add(typeof(REF_I12_PV1PV2), false, false);
		...
		/// <summary> Returns  first repetition of REF_I12_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual REF_I12_PRDCTD getPRDCTD()
		{
			REF_I12_PRDCTD ret = null;
			try
			{
				ret = (REF_I12_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of REF_I12_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual REF_I12_PRDCTD getPRDCTD(int rep)
		{
			return (REF_I12_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
		...
		/// <summary> Returns  first repetition of REF_I12_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual REF_I12_IN1IN2IN3 getIN1IN2IN3()
		{
			REF_I12_IN1IN2IN3 ret = null;
			try
			{
				ret = (REF_I12_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of REF_I12_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual REF_I12_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (REF_I12_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
		...
		/// <summary> Returns  first repetition of REF_I12_PR1AUTCTD (a Group object) - creates it if necessary</summary>
		public virtual REF_I12_PR1AUTCTD getPR1AUTCTD()
		{
			REF_I12_PR1AUTCTD ret = null;
			try
			{
				ret = (REF_I12_PR1AUTCTD) this.get_Renamed("PR1AUTCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of REF_I12_PR1AUTCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual REF_I12_PR1AUTCTD getPR1AUTCTD(int rep)
		{
			return (REF_I12_PR1AUTCTD) this.get_Renamed("PR1AUTCTD", rep);
		}
		
		/// <summary> Returns  first repetition of REF_I12_OBRNTEOBXNTE (a Group object) - creates it if necessary</summary>
		public virtual REF_I12_OBRNTEOBXNTE getOBRNTEOBXNTE()
		{
			REF_I12_OBRNTEOBXNTE ret = null;
			try
			{
				ret = (REF_I12_OBRNTEOBXNTE) this.get_Renamed("OBRNTEOBXNTE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of REF_I12_OBRNTEOBXNTE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual REF_I12_OBRNTEOBXNTE getOBRNTEOBXNTE(int rep)
		{
			return (REF_I12_OBRNTEOBXNTE) this.get_Renamed("OBRNTEOBXNTE", rep);
		}
