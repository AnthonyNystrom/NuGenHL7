...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a MDM_T06 message structure (see chapter ?). This structure contains the 
	...
	/// 5: OBX (OBX - observation/result segment) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class MDM_T06:AbstractMessage
	{
		...
		/// <summary> Creates a new MDM_T06 Group with custom ModelClassFactory.</summary>
		public MDM_T06(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MDM_T06 Group with DefaultModelClassFactory. </summary>
