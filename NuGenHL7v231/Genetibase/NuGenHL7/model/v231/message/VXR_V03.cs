...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a VXR_V03 message structure (see chapter ?). This structure contains the 
	...
	public class VXR_V03:AbstractMessage
	{
		...
		/// <summary> Returns VXR_V03_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public VXR_V03_PV1PV2 PV1PV2
		{
			get
			{
				...
				try
				{
					ret = (VXR_V03_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of VXR_V03_IN1IN2IN3 </summary>
		...
		/// <summary> Returns the number of existing repetitions of VXR_V03_ORCRXARXROBXNTE </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(VXR_V03_PV1PV2), false, false);
				this.add(typeof(VXR_V03_IN1IN2IN3), false, true);
				this.add(typeof(VXR_V03_ORCRXARXROBXNTE), false, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of VXR_V03_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual VXR_V03_IN1IN2IN3 getIN1IN2IN3()
		{
			VXR_V03_IN1IN2IN3 ret = null;
			try
			{
				ret = (VXR_V03_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of VXR_V03_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXR_V03_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (VXR_V03_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
		
		/// <summary> Returns  first repetition of VXR_V03_ORCRXARXROBXNTE (a Group object) - creates it if necessary</summary>
		public virtual VXR_V03_ORCRXARXROBXNTE getORCRXARXROBXNTE()
		{
			VXR_V03_ORCRXARXROBXNTE ret = null;
			try
			{
				ret = (VXR_V03_ORCRXARXROBXNTE) this.get_Renamed("ORCRXARXROBXNTE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of VXR_V03_ORCRXARXROBXNTE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXR_V03_ORCRXARXROBXNTE getORCRXARXROBXNTE(int rep)
		{
			return (VXR_V03_ORCRXARXROBXNTE) this.get_Renamed("ORCRXARXROBXNTE", rep);
		}
	}
}