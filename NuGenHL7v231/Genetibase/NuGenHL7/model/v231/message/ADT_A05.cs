...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A05 message structure (see chapter ?). This structure contains the 
	...
	/// 12: ADT_A05_PR1ROL (a Group object) <b>optional repeating</b><br>
	/// 13: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
	/// 14: ADT_A05_IN1IN2IN3 (a Group object) <b>optional repeating</b><br>
	...
	public class ADT_A05:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A05_PR1ROL </summary>
		...
		/// <summary> Returns the number of existing repetitions of ADT_A05_IN1IN2IN3 </summary>
		...
		/// <summary> Creates a new ADT_A05 Group with custom ModelClassFactory.</summary>
		public ADT_A05(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A05 Group with DefaultModelClassFactory. </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ADT_A05_PR1ROL), false, true);
				this.add(typeof(GT1), false, true);
				this.add(typeof(ADT_A05_IN1IN2IN3), false, true);
		...
		/// <summary> Returns  first repetition of ADT_A05_PR1ROL (a Group object) - creates it if necessary</summary>
		public virtual ADT_A05_PR1ROL getPR1ROL()
		{
			ADT_A05_PR1ROL ret = null;
			try
			{
				ret = (ADT_A05_PR1ROL) this.get_Renamed("PR1ROL");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A05_PR1ROL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A05_PR1ROL getPR1ROL(int rep)
		{
			return (ADT_A05_PR1ROL) this.get_Renamed("PR1ROL", rep);
		}
		...
		/// <summary> Returns  first repetition of ADT_A05_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual ADT_A05_IN1IN2IN3 getIN1IN2IN3()
		{
			ADT_A05_IN1IN2IN3 ret = null;
			try
			{
				ret = (ADT_A05_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A05_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A05_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (ADT_A05_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
	}
}