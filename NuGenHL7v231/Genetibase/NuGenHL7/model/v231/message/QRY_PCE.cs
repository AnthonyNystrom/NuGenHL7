...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a QRY_PCE message structure (see chapter ?). This structure contains the 
	...
	public class QRY_PCE:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_PCE Group with custom ModelClassFactory.</summary>
		public QRY_PCE(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
