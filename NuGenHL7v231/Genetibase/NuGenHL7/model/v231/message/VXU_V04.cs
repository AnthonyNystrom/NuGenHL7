...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a VXU_V04 message structure (see chapter ?). This structure contains the 
	...
	public class VXU_V04:AbstractMessage
	{
		...
		/// <summary> Returns VXU_V04_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public VXU_V04_PV1PV2 PV1PV2
		{
			get
			{
				...
				try
				{
					ret = (VXU_V04_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Returns the number of existing repetitions of VXU_V04_IN1IN2IN3 </summary>
		...
		/// <summary> Returns the number of existing repetitions of VXU_V04_ORCRXARXROBXNTE </summary>
		virtual public int ORCRXARXROBXNTEReps
		{
			get
			{
				int reps = - 1;
		...
		/// <summary> Creates a new VXU_V04 Group with custom ModelClassFactory.</summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(VXU_V04_PV1PV2), false, false);
				this.add(typeof(VXU_V04_IN1IN2IN3), false, true);
				this.add(typeof(VXU_V04_ORCRXARXROBXNTE), false, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of VXU_V04_IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		public virtual VXU_V04_IN1IN2IN3 getIN1IN2IN3()
		{
			VXU_V04_IN1IN2IN3 ret = null;
			try
			{
				ret = (VXU_V04_IN1IN2IN3) this.get_Renamed("IN1IN2IN3");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of VXU_V04_IN1IN2IN3
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXU_V04_IN1IN2IN3 getIN1IN2IN3(int rep)
		{
			return (VXU_V04_IN1IN2IN3) this.get_Renamed("IN1IN2IN3", rep);
		}
		
		/// <summary> Returns  first repetition of VXU_V04_ORCRXARXROBXNTE (a Group object) - creates it if necessary</summary>
		public virtual VXU_V04_ORCRXARXROBXNTE getORCRXARXROBXNTE()
		{
			VXU_V04_ORCRXARXROBXNTE ret = null;
			try
			{
				ret = (VXU_V04_ORCRXARXROBXNTE) this.get_Renamed("ORCRXARXROBXNTE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of VXU_V04_ORCRXARXROBXNTE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual VXU_V04_ORCRXARXROBXNTE getORCRXARXROBXNTE(int rep)
		{
			return (VXU_V04_ORCRXARXROBXNTE) this.get_Renamed("ORCRXARXROBXNTE", rep);
		}
	}
}