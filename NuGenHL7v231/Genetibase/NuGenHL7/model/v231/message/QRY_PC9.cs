...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a QRY_PC9 message structure (see chapter ?). This structure contains the 
	...
	public class QRY_PC9:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_PC9 Group with custom ModelClassFactory.</summary>
		public QRY_PC9(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QRY_PC9 Group with DefaultModelClassFactory. </summary>
