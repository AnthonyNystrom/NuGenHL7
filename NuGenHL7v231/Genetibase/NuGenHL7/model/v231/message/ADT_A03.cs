...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A03 message structure (see chapter ?). This structure contains the 
	...
	/// 9: ADT_A03_PR1ROL (a Group object) <b>optional repeating</b><br>
	...
	public class ADT_A03:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A03_PR1ROL </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ADT_A03_PR1ROL), false, true);
		...
		/// <summary> Returns  first repetition of ADT_A03_PR1ROL (a Group object) - creates it if necessary</summary>
		public virtual ADT_A03_PR1ROL getPR1ROL()
		{
			ADT_A03_PR1ROL ret = null;
			try
			{
				ret = (ADT_A03_PR1ROL) this.get_Renamed("PR1ROL");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A03_PR1ROL
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A03_PR1ROL getPR1ROL(int rep)
		{
			return (ADT_A03_PR1ROL) this.get_Renamed("PR1ROL", rep);
		}
