...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a PIN_I07 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: PIN_I07_PRDCTD (a Group object) <b>repeating</b><br>
	...
	/// 4: PIN_I07_GT1IN1IN2IN3 (a Group object) <b>optional </b><br>
	...
	public class PIN_I07:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of PIN_I07_PRDCTD </summary>
		...
		/// <summary> Returns PIN_I07_GT1IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		virtual public PIN_I07_GT1IN1IN2IN3 GT1IN1IN2IN3
		{
			get
			{
				PIN_I07_GT1IN1IN2IN3 ret = null;
				try
				{
					ret = (PIN_I07_GT1IN1IN2IN3) this.get_Renamed("GT1IN1IN2IN3");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new PIN_I07 Group with custom ModelClassFactory.</summary>
		public PIN_I07(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new PIN_I07 Group with DefaultModelClassFactory. </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(PIN_I07_PRDCTD), true, true);
				this.add(typeof(PID), true, false);
				this.add(typeof(NK1), false, true);
				this.add(typeof(PIN_I07_GT1IN1IN2IN3), false, false);
		...
		/// <summary> Returns  first repetition of PIN_I07_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual PIN_I07_PRDCTD getPRDCTD()
		{
			PIN_I07_PRDCTD ret = null;
			try
			{
				ret = (PIN_I07_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of PIN_I07_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual PIN_I07_PRDCTD getPRDCTD(int rep)
		{
			return (PIN_I07_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
