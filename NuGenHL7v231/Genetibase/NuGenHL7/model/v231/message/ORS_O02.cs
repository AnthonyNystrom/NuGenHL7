...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ORS_O02 message structure (see chapter 4.7). This structure contains the 
	...
	/// 4: ORS_O02_PIDNTEORCRQDNTE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORS_O02:AbstractMessage
	{
		...
		/// <summary> Returns ORS_O02_PIDNTEORCRQDNTE (a Group object) - creates it if necessary</summary>
		virtual public ORS_O02_PIDNTEORCRQDNTE PIDNTEORCRQDNTE
		{
			get
			{
				ORS_O02_PIDNTEORCRQDNTE ret = null;
				try
				{
					ret = (ORS_O02_PIDNTEORCRQDNTE) this.get_Renamed("PIDNTEORCRQDNTE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORS_O02 Group with DefaultModelClassFactory. </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ORS_O02_PIDNTEORCRQDNTE), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
