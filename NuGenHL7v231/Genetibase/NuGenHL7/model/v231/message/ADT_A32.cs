...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A32 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A32:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A32 Group with custom ModelClassFactory.</summary>
		public ADT_A32(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A32 Group with DefaultModelClassFactory. </summary>
