...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A38 message structure (see chapter ?). This structure contains the 
	...
	/// 9: DRG (DRG - diagnosis related group segment) <b></b><br>
	/// </summary>
	[Serializable]
	public class ADT_A38:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A38 Group with custom ModelClassFactory.</summary>
		public ADT_A38(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A38 Group with DefaultModelClassFactory. </summary>
