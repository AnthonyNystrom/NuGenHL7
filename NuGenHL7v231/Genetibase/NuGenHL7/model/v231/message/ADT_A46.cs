...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A46 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A46:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A46 Group with custom ModelClassFactory.</summary>
		public ADT_A46(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A46 Group with DefaultModelClassFactory. </summary>
