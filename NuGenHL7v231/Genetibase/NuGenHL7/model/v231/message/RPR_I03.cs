...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RPR_I03 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: MSA (MSA - message acknowledgment segment) <b></b><br>
	/// 2: RPR_I03_PRDCTD (a Group object) <b>repeating</b><br>
	...
	public class RPR_I03:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RPR_I03_PRDCTD </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RPR_I03_PRDCTD), true, true);
		...
		/// <summary> Returns  first repetition of RPR_I03_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RPR_I03_PRDCTD getPRDCTD()
		{
			RPR_I03_PRDCTD ret = null;
			try
			{
				ret = (RPR_I03_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RPR_I03_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RPR_I03_PRDCTD getPRDCTD(int rep)
		{
			return (RPR_I03_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
		
		/// <summary> Returns  first repetition of PID (PID - patient identification segment) - creates it if necessary</summary>
