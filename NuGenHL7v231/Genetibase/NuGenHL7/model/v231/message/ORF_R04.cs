...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// 4: ORF_R04_PIDNTEORCOBRNTEOBXNTECTI (a Group object) <b>repeating</b><br>
	...
	public class ORF_R04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ORF_R04_PIDNTEORCOBRNTEOBXNTECTI </summary>
		virtual public int PIDNTEORCOBRNTEOBXNTECTIReps
		{
			get
			{
				int reps = - 1;
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ORF_R04_PIDNTEORCOBRNTEOBXNTECTI), true, true);
		...
		/// <summary> Returns  first repetition of ORF_R04_PIDNTEORCOBRNTEOBXNTECTI (a Group object) - creates it if necessary</summary>
		public virtual ORF_R04_PIDNTEORCOBRNTEOBXNTECTI getPIDNTEORCOBRNTEOBXNTECTI()
		{
			ORF_R04_PIDNTEORCOBRNTEOBXNTECTI ret = null;
			try
			{
				ret = (ORF_R04_PIDNTEORCOBRNTEOBXNTECTI) this.get_Renamed("PIDNTEORCOBRNTEOBXNTECTI");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ORF_R04_PIDNTEORCOBRNTEOBXNTECTI
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ORF_R04_PIDNTEORCOBRNTEOBXNTECTI getPIDNTEORCOBRNTEOBXNTECTI(int rep)
		{
			return (ORF_R04_PIDNTEORCOBRNTEOBXNTECTI) this.get_Renamed("PIDNTEORCOBRNTEOBXNTECTI", rep);
		}
	}
}