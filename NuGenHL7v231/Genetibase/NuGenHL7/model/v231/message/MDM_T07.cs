...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a MDM_T07 message structure (see chapter ?). This structure contains the 
	...
	public class MDM_T07:AbstractMessage
	{
		...
		/// <summary> Creates a new MDM_T07 Group with custom ModelClassFactory.</summary>
		public MDM_T07(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
