...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	public class BAR_P02:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of BAR_P02_PIDPD1PV1DB1 </summary>
		virtual public int PIDPD1PV1DB1Reps
		{
			get
			{
				int reps = - 1;
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(BAR_P02_PIDPD1PV1DB1), true, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of BAR_P02_PIDPD1PV1DB1 (a Group object) - creates it if necessary</summary>
		public virtual BAR_P02_PIDPD1PV1DB1 getPIDPD1PV1DB1()
		{
			BAR_P02_PIDPD1PV1DB1 ret = null;
			try
			{
				ret = (BAR_P02_PIDPD1PV1DB1) this.get_Renamed("PIDPD1PV1DB1");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of BAR_P02_PIDPD1PV1DB1
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual BAR_P02_PIDPD1PV1DB1 getPIDPD1PV1DB1(int rep)
		{
			return (BAR_P02_PIDPD1PV1DB1) this.get_Renamed("PIDPD1PV1DB1", rep);
		}
	}
}