...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RRI_I12 message structure (see chapter null). This structure contains the 
	...
	public class RRI_I12:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RRI_I12_PRDCTD </summary>
		...
		/// <summary> Returns the number of existing repetitions of RRI_I12_PR1AUTCTD </summary>
		...
		/// <summary> Returns the number of existing repetitions of RRI_I12_OBRNTEOBXNTE </summary>
		...
		/// <summary> Returns RRI_I12_PV1PV2 (a Group object) - creates it if necessary</summary>
		virtual public RRI_I12_PV1PV2 PV1PV2
		{
			get
			{
				...
				try
				{
					ret = (RRI_I12_PV1PV2) this.get_Renamed("PV1PV2");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RRI_I12 Group with DefaultModelClassFactory. </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RRI_I12_PRDCTD), true, true);
				this.add(typeof(PID), true, false);
				this.add(typeof(ACC), false, false);
				this.add(typeof(DG1), false, true);
				this.add(typeof(DRG), false, true);
				this.add(typeof(AL1), false, true);
				this.add(typeof(RRI_I12_PR1AUTCTD), false, true);
				this.add(typeof(RRI_I12_OBRNTEOBXNTE), false, true);
				this.add(typeof(RRI_I12_PV1PV2), false, false);
		...
		/// <summary> Returns  first repetition of RRI_I12_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RRI_I12_PRDCTD getPRDCTD()
		{
			RRI_I12_PRDCTD ret = null;
			try
			{
				ret = (RRI_I12_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RRI_I12_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRI_I12_PRDCTD getPRDCTD(int rep)
		{
			return (RRI_I12_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
		...
		/// <summary> Returns  first repetition of RRI_I12_PR1AUTCTD (a Group object) - creates it if necessary</summary>
		public virtual RRI_I12_PR1AUTCTD getPR1AUTCTD()
		{
			RRI_I12_PR1AUTCTD ret = null;
			try
			{
				ret = (RRI_I12_PR1AUTCTD) this.get_Renamed("PR1AUTCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RRI_I12_PR1AUTCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRI_I12_PR1AUTCTD getPR1AUTCTD(int rep)
		{
			return (RRI_I12_PR1AUTCTD) this.get_Renamed("PR1AUTCTD", rep);
		}
		
		/// <summary> Returns  first repetition of RRI_I12_OBRNTEOBXNTE (a Group object) - creates it if necessary</summary>
		public virtual RRI_I12_OBRNTEOBXNTE getOBRNTEOBXNTE()
		{
			RRI_I12_OBRNTEOBXNTE ret = null;
			try
			{
				ret = (RRI_I12_OBRNTEOBXNTE) this.get_Renamed("OBRNTEOBXNTE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RRI_I12_OBRNTEOBXNTE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RRI_I12_OBRNTEOBXNTE getOBRNTEOBXNTE(int rep)
		{
			return (RRI_I12_OBRNTEOBXNTE) this.get_Renamed("OBRNTEOBXNTE", rep);
		}
