...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A39 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A39:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of ADT_A39_PIDPD1MRGPV1 </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ADT_A39_PIDPD1MRGPV1), true, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of ADT_A39_PIDPD1MRGPV1 (a Group object) - creates it if necessary</summary>
		public virtual ADT_A39_PIDPD1MRGPV1 getPIDPD1MRGPV1()
		{
			ADT_A39_PIDPD1MRGPV1 ret = null;
			try
			{
				ret = (ADT_A39_PIDPD1MRGPV1) this.get_Renamed("PIDPD1MRGPV1");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of ADT_A39_PIDPD1MRGPV1
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual ADT_A39_PIDPD1MRGPV1 getPIDPD1MRGPV1(int rep)
		{
			return (ADT_A39_PIDPD1MRGPV1) this.get_Renamed("PIDPD1MRGPV1", rep);
		}
	}
}