...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	public class UDM_Q05:AbstractMessage
	{
		...
		/// <summary> Returns URD (URD - results/update definition segment) - creates it if necessary</summary>
		...
		/// <summary> Returns URS (URS - unsolicited selection segment) - creates it if necessary</summary>
