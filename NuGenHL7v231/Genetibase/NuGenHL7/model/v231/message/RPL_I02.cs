...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RPL_I02 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: MSA (MSA - message acknowledgment segment) <b></b><br>
	/// 2: RPL_I02_PRDCTD (a Group object) <b>repeating</b><br>
	...
	public class RPL_I02:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RPL_I02_PRDCTD </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RPL_I02_PRDCTD), true, true);
		...
		/// <summary> Returns  first repetition of RPL_I02_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RPL_I02_PRDCTD getPRDCTD()
		{
			RPL_I02_PRDCTD ret = null;
			try
			{
				ret = (RPL_I02_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RPL_I02_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RPL_I02_PRDCTD getPRDCTD(int rep)
		{
			return (RPL_I02_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
