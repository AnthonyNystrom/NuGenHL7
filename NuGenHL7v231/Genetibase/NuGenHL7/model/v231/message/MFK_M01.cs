...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a MFK_M01 message structure (see chapter null). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: MSA (MSA - message acknowledgment segment) <b></b><br>
	/// 2: ERR (ERR - error segment) <b>optional </b><br>
	/// 3: MFI (MFI - master file identification segment) <b></b><br>
	/// 4: MFA (MFA - master file acknowledgment segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
