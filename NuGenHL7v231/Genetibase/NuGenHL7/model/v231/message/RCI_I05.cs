...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RCI_I05 message structure (see chapter ?). This structure contains the 
	...
	public class RCI_I05:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RCI_I05_PRDCTD </summary>
		...
		/// <summary> Returns the number of existing repetitions of RCI_I05_OBRNTEOBXNTE </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RCI_I05_PRDCTD), true, true);
				this.add(typeof(PID), true, false);
				this.add(typeof(DG1), false, true);
				this.add(typeof(DRG), false, true);
				this.add(typeof(AL1), false, true);
				this.add(typeof(RCI_I05_OBRNTEOBXNTE), false, true);
		...
		/// <summary> Returns  first repetition of RCI_I05_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RCI_I05_PRDCTD getPRDCTD()
		{
			RCI_I05_PRDCTD ret = null;
			try
			{
				ret = (RCI_I05_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RCI_I05_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RCI_I05_PRDCTD getPRDCTD(int rep)
		{
			return (RCI_I05_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
		...
		/// <summary> Returns  first repetition of RCI_I05_OBRNTEOBXNTE (a Group object) - creates it if necessary</summary>
		public virtual RCI_I05_OBRNTEOBXNTE getOBRNTEOBXNTE()
		{
			RCI_I05_OBRNTEOBXNTE ret = null;
			try
			{
				ret = (RCI_I05_OBRNTEOBXNTE) this.get_Renamed("OBRNTEOBXNTE");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RCI_I05_OBRNTEOBXNTE
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RCI_I05_OBRNTEOBXNTE getOBRNTEOBXNTE(int rep)
		{
			return (RCI_I05_OBRNTEOBXNTE) this.get_Renamed("OBRNTEOBXNTE", rep);
		}
