...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a MFK_M05 message structure (see chapter ?). This structure contains the 
	...
	public class MFK_M05:AbstractMessage
	{
		...
		/// <summary> Creates a new MFK_M05 Group with custom ModelClassFactory.</summary>
