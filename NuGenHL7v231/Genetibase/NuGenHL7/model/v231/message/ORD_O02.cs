...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ORD_O02 message structure (see chapter 4.6). This structure contains the 
	...
	/// 4: ORD_O02_PIDNTEORCODSNTEORCODTNTE (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORD_O02:AbstractMessage
	{
		...
		/// <summary> Returns ORD_O02_PIDNTEORCODSNTEORCODTNTE (a Group object) - creates it if necessary</summary>
		virtual public ORD_O02_PIDNTEORCODSNTEORCODTNTE PIDNTEORCODSNTEORCODTNTE
		{
			get
			{
				ORD_O02_PIDNTEORCODSNTEORCODTNTE ret = null;
				try
				{
					ret = (ORD_O02_PIDNTEORCODSNTEORCODTNTE) this.get_Renamed("PIDNTEORCODSNTEORCODTNTE");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new ORD_O02 Group with custom ModelClassFactory.</summary>
		public ORD_O02(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ORD_O02_PIDNTEORCODSNTEORCODTNTE), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
