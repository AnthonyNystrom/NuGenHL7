...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a SQM_S25 message structure (see chapter ?). This structure contains the 
	...
	public class SQM_S25:AbstractMessage
	{
		...
		/// <summary> Returns SQM_S25_ARQAPRPIDRGSAISAPRAIGAPRAIPAPRAILAPR (a Group object) - creates it if necessary</summary>
		virtual public SQM_S25_ARQAPRPIDRGSAISAPRAIGAPRAIPAPRAILAPR ARQAPRPIDRGSAISAPRAIGAPRAIPAPRAILAPR
		{
			get
			{
				...
				try
				{
					ret = (SQM_S25_ARQAPRPIDRGSAISAPRAIGAPRAIPAPRAILAPR) this.get_Renamed("ARQAPRPIDRGSAISAPRAIGAPRAIPAPRAILAPR");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(SQM_S25_ARQAPRPIDRGSAISAPRAIGAPRAIPAPRAILAPR), false, false);
