...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a QRY_PCK message structure (see chapter ?). This structure contains the 
	...
	public class QRY_PCK:AbstractMessage
	{
		...
		/// <summary> Creates a new QRY_PCK Group with custom ModelClassFactory.</summary>
		public QRY_PCK(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new QRY_PCK Group with DefaultModelClassFactory. </summary>
