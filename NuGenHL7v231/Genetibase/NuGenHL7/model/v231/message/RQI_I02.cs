...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RQI_I02 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: RQI_I02_PRDCTD (a Group object) <b>repeating</b><br>
	...
	/// 4: RQI_I02_GT1IN1IN2IN3 (a Group object) <b>optional </b><br>
	...
	public class RQI_I02:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RQI_I02_PRDCTD </summary>
		...
		/// <summary> Returns RQI_I02_GT1IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		virtual public RQI_I02_GT1IN1IN2IN3 GT1IN1IN2IN3
		{
			get
			{
				RQI_I02_GT1IN1IN2IN3 ret = null;
				try
				{
					ret = (RQI_I02_GT1IN1IN2IN3) this.get_Renamed("GT1IN1IN2IN3");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RQI_I02 Group with custom ModelClassFactory.</summary>
		public RQI_I02(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new RQI_I02 Group with DefaultModelClassFactory. </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RQI_I02_PRDCTD), true, true);
				this.add(typeof(PID), true, false);
				this.add(typeof(NK1), false, true);
				this.add(typeof(RQI_I02_GT1IN1IN2IN3), false, false);
		...
		/// <summary> Returns  first repetition of RQI_I02_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RQI_I02_PRDCTD getPRDCTD()
		{
			RQI_I02_PRDCTD ret = null;
			try
			{
				ret = (RQI_I02_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RQI_I02_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RQI_I02_PRDCTD getPRDCTD(int rep)
		{
			return (RQI_I02_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
