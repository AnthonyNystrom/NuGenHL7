...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RPI_I01 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: MSA (MSA - message acknowledgment segment) <b></b><br>
	/// 2: RPI_I01_PRDCTD (a Group object) <b>repeating</b><br>
	...
	/// 5: RPI_I01_GT1IN1IN2IN3 (a Group object) <b>optional </b><br>
	...
	public class RPI_I01:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RPI_I01_PRDCTD </summary>
		...
		/// <summary> Returns RPI_I01_GT1IN1IN2IN3 (a Group object) - creates it if necessary</summary>
		virtual public RPI_I01_GT1IN1IN2IN3 GT1IN1IN2IN3
		{
			get
			{
				RPI_I01_GT1IN1IN2IN3 ret = null;
				try
				{
					ret = (RPI_I01_GT1IN1IN2IN3) this.get_Renamed("GT1IN1IN2IN3");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		/// <summary> Creates a new RPI_I01 Group with custom ModelClassFactory.</summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RPI_I01_PRDCTD), true, true);
				this.add(typeof(PID), true, false);
				this.add(typeof(NK1), false, true);
				this.add(typeof(RPI_I01_GT1IN1IN2IN3), false, false);
		...
		/// <summary> Returns  first repetition of RPI_I01_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RPI_I01_PRDCTD getPRDCTD()
		{
			RPI_I01_PRDCTD ret = null;
			try
			{
				ret = (RPI_I01_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RPI_I01_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RPI_I01_PRDCTD getPRDCTD(int rep)
		{
			return (RPI_I01_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
