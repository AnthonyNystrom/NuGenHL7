...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// 8: PID (PID - patient identification segment) <b></b><br>
	/// 9: PD1 (PD1 - patient additional demographic segment) <b>optional </b><br>
	/// 10: PV1 (PV1 - patient visit segment-) <b></b><br>
	/// 11: PV2 (PV2 - patient visit - additional information segment) <b>optional </b><br>
	/// 12: DB1 (DB1 - Disability segment) <b>optional repeating</b><br>
	/// 13: OBX (OBX - observation/result segment) <b>optional repeating</b><br>
	/// </summary>
	[Serializable]
	public class ADT_A17:AbstractMessage
	{
		...
		/// <summary> Returns PID2 (PID - patient identification segment) - creates it if necessary</summary>
		...
		/// <summary> Returns PD12 (PD1 - patient additional demographic segment) - creates it if necessary</summary>
		...
		/// <summary> Returns PV12 (PV1 - patient visit segment-) - creates it if necessary</summary>
		...
		/// <summary> Returns PV22 (PV2 - patient visit - additional information segment) - creates it if necessary</summary>
		...
		/// <summary> Returns  first repetition of DB12 (DB1 - Disability segment) - creates it if necessary</summary>
		...
		/// <summary> Returns  first repetition of OBX2 (OBX - observation/result segment) - creates it if necessary</summary>
