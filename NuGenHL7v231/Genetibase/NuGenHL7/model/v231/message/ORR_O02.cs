...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ORR_O02 message structure (see chapter 4.2.2). This structure contains the 
	...
	/// 4: ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI (a Group object) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ORR_O02:AbstractMessage
	{
		...
		/// <summary> Returns ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI (a Group object) - creates it if necessary</summary>
		virtual public ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI
		{
			get
			{
				ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI ret = null;
				try
				{
					ret = (ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI) this.get_Renamed("PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI");
				}
				catch (NuGenHL7Exception)
				{
					throw new Exception();
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(ORR_O02_PIDNTEORCOBRRQDRQ1RXOODSODTNTECTI), false, false);
			}
			catch (NuGenHL7Exception)
			{
			}
