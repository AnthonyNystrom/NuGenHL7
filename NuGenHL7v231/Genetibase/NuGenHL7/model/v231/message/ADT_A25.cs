...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A25 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A25:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A25 Group with custom ModelClassFactory.</summary>
		public ADT_A25(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A25 Group with DefaultModelClassFactory. </summary>
