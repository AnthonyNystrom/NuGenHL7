...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RQP_I04 message structure (see chapter ?). This structure contains the 
	/// following elements: </p>
	/// 0: MSH (MSH - message header segment) <b></b><br>
	/// 1: RQP_I04_PRDCTD (a Group object) <b>repeating</b><br>
	...
	/// 4: GT1 (GT1 - guarantor segment) <b>optional repeating</b><br>
	...
	public class RQP_I04:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RQP_I04_PRDCTD </summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RQP_I04_PRDCTD), true, true);
		...
		/// <summary> Returns  first repetition of RQP_I04_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RQP_I04_PRDCTD getPRDCTD()
		{
			RQP_I04_PRDCTD ret = null;
			try
			{
				ret = (RQP_I04_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RQP_I04_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RQP_I04_PRDCTD getPRDCTD(int rep)
		{
			return (RQP_I04_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
