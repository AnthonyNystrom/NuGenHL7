...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a MDM_T05 message structure (see chapter ?). This structure contains the 
	...
	public class MDM_T05:AbstractMessage
	{
		...
		/// <summary> Creates a new MDM_T05 Group with custom ModelClassFactory.</summary>
		public MDM_T05(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new MDM_T05 Group with DefaultModelClassFactory. </summary>
