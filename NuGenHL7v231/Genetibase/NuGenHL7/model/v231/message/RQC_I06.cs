...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a RQC_I06 message structure (see chapter ?). This structure contains the 
	...
	/// 3: RQC_I06_PRDCTD (a Group object) <b>repeating</b><br>
	...
	public class RQC_I06:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of RQC_I06_PRDCTD </summary>
		...
		/// <summary> Creates a new RQC_I06 Group with custom ModelClassFactory.</summary>
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(RQC_I06_PRDCTD), true, true);
		...
		/// <summary> Returns  first repetition of RQC_I06_PRDCTD (a Group object) - creates it if necessary</summary>
		public virtual RQC_I06_PRDCTD getPRDCTD()
		{
			RQC_I06_PRDCTD ret = null;
			try
			{
				ret = (RQC_I06_PRDCTD) this.get_Renamed("PRDCTD");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of RQC_I06_PRDCTD
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual RQC_I06_PRDCTD getPRDCTD(int rep)
		{
			return (RQC_I06_PRDCTD) this.get_Renamed("PRDCTD", rep);
		}
