...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A12 message structure (see chapter ?). This structure contains the 
	...
	/// 8: DG1 (DG1 - diagnosis segment) <b>optional </b><br>
	/// </summary>
	[Serializable]
	public class ADT_A12:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A12 Group with custom ModelClassFactory.</summary>
		public ADT_A12(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A12 Group with DefaultModelClassFactory. </summary>
