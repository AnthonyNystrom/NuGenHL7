...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A35 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A35:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A35 Group with custom ModelClassFactory.</summary>
		public ADT_A35(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
