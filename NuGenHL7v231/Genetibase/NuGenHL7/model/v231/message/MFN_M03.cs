...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// 2: MFN_M03_MFEOM1Hxx (a Group object) <b>repeating</b><br>
	/// </summary>
	[Serializable]
	public class MFN_M03:AbstractMessage
	{
		...
		/// <summary> Returns the number of existing repetitions of MFN_M03_MFEOM1Hxx </summary>
		virtual public int MFEOM1HxxReps
		{
			get
			{
				int reps = - 1;
		...
		private void  init(ModelClassFactory factory)
		{
			try
			{
				...
				this.add(typeof(MFN_M03_MFEOM1Hxx), true, true);
			}
			catch (NuGenHL7Exception)
			{
			}
		...
		/// <summary> Returns  first repetition of MFN_M03_MFEOM1Hxx (a Group object) - creates it if necessary</summary>
		public virtual MFN_M03_MFEOM1Hxx getMFEOM1Hxx()
		{
			MFN_M03_MFEOM1Hxx ret = null;
			try
			{
				ret = (MFN_M03_MFEOM1Hxx) this.get_Renamed("MFEOM1Hxx");
			}
			catch (NuGenHL7Exception)
			{
				throw new Exception();
		...
		/// <summary> Returns a specific repetition of MFN_M03_MFEOM1Hxx
		/// (a Group object) - creates it if necessary
		/// throws HL7Exception if the repetition requested is more than one 
		/// greater than the number of existing repetitions.
		/// </summary>
		public virtual MFN_M03_MFEOM1Hxx getMFEOM1Hxx(int rep)
		{
			return (MFN_M03_MFEOM1Hxx) this.get_Renamed("MFEOM1Hxx", rep);
		}
	}
}