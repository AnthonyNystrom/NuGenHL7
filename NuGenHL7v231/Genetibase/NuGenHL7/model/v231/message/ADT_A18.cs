...
namespace Genetibase.NuGenHL7.model.v231.message
{
	...
	/// <summary> <p>Represents a ADT_A18 message structure (see chapter ?). This structure contains the 
	...
	public class ADT_A18:AbstractMessage
	{
		...
		/// <summary> Creates a new ADT_A18 Group with custom ModelClassFactory.</summary>
		public ADT_A18(ModelClassFactory factory):base(factory)
		{
			init(factory);
		}
		
		/// <summary> Creates a new ADT_A18 Group with DefaultModelClassFactory. </summary>
