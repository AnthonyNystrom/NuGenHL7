...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	/// <summary> <p>Represents an HL7 RGS message segment. 
	/// This segment has the following fields:</p><p>
	/// RGS-1: Set ID - RGS (SI)<br> 
	/// RGS-2: Segment Action Code (ID)<br> 
	/// RGS-3: Resource Group ID (CE)<br> 
	...
	public class RGS:AbstractSegment
	{
		...
		virtual public CE ResourceGroupID
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a RGS (RGS - resource group segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public RGS(Group parent, ModelClassFactory factory):base(parent, factory)
		{
