...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class ODS:AbstractSegment
	{
		...
		/// <summary> Creates a ODS (ODS - dietary orders, supplements, and preferences segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public ODS(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(CE), true, 20, 60, new System.Object[]{message});
