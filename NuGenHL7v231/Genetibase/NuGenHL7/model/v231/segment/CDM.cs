...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class CDM:AbstractSegment
	{
		...
		/// <summary> Creates a CDM (CDM -  charge description master segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public CDM(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(CK), false, 0, 200, new System.Object[]{message});
				this.add(typeof(XON), false, 0, 200, new System.Object[]{message});
		...
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CK getContractNumber(int rep)
		{
			CK ret = null;
			try
			{
		...
		public virtual CK[] getContractNumber()
		{
			CK[] ret = null;
			try
			{
