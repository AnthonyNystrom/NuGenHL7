...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class FAC:AbstractSegment
	{
		...
		/// <summary> Creates a FAC (FAC - facility segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public FAC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(XAD), true, 0, 200, new System.Object[]{message});
				this.add(typeof(XTN), true, 1, 44, new System.Object[]{message});
				this.add(typeof(XCN), false, 0, 60, new System.Object[]{message});
				this.add(typeof(ST), false, 0, 60, new System.Object[]{message});
				this.add(typeof(XAD), false, 0, 200, new System.Object[]{message});
				this.add(typeof(XTN), false, 0, 44, new System.Object[]{message});
				this.add(typeof(XCN), true, 0, 60, new System.Object[]{message});
				this.add(typeof(ST), false, 1, 60, new System.Object[]{message});
				this.add(typeof(XAD), false, 0, 200, new System.Object[]{message});
				this.add(typeof(XTN), false, 1, 44, new System.Object[]{message});
			}
			catch (NuGenHL7Exception)
			{
			}
