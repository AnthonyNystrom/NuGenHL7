...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class CM2:AbstractSegment
	{
		...
		/// <summary> Creates a CM2 (CM2 - clinical study schedule master segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public CM2(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(CE), true, 200, 60, new System.Object[]{message});
			}
			catch (NuGenHL7Exception)
			{
			}
