...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	/// <summary> <p>Represents an HL7 AIG message segment. 
	...
	public class AIG:AbstractSegment
	{
		...
		virtual public CE ResourceType
		{
			get
			{
				CE ret = null;
		...
		virtual public NM ResourceQuantity
		{
			get
			{
				NM ret = null;
		...
		virtual public CE ResourceQuantityUnits
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a AIG (AIG - appointment information - general resource segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		...
		/// <summary> Returns a single repetition of Resource Group (AIG-5).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getResourceGroup(int rep)
		{
			CE ret = null;
			try
			{
		...
		public virtual CE[] getResourceGroup()
		{
			CE[] ret = null;
			try
			{
