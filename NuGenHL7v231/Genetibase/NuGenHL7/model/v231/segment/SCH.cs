...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class SCH:AbstractSegment
	{
		...
		/// <summary> Creates a SCH (SCH - schedule activity information segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public SCH(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(XCN), false, 0, 48, new System.Object[]{message});
				...
				this.add(typeof(XCN), true, 0, 38, new System.Object[]{message});
				this.add(typeof(XTN), false, 1, 40, new System.Object[]{message});
				this.add(typeof(XAD), false, 0, 106, new System.Object[]{message});
				this.add(typeof(PL), false, 1, 80, new System.Object[]{message});
				this.add(typeof(XCN), true, 0, 48, new System.Object[]{message});
