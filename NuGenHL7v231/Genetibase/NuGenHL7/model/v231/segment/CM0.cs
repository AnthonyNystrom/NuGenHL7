...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class CM0:AbstractSegment
	{
		...
		virtual public XTN ContactSTelNumber
		{
			get
			{
				XTN ret = null;
		...
		/// <summary> Creates a CM0 (CM0 - clinical study master segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public CM0(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(XAD), false, 0, 100, new System.Object[]{message});
			}
			catch (NuGenHL7Exception)
			{
			}
