...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class ORC:AbstractSegment
	{
		...
		/// <summary> Creates a ORC (ORC - common order segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public ORC(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				this.add(typeof(ID), false, 1, 2, new System.Object[]{message, 119});
