...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class RXA:AbstractSegment
	{
		...
		/// <summary> Creates a RXA (RXA - pharmacy/treatment administration segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		...
		/// <summary> Returns a single repetition of Substance Refusal Reason (RXA-18).</summary>
		/// <param name="rep">the repetition number (this is a repeating field)
		/// </param>
		/// <throws>  HL7Exception if the repetition number is invalid. </throws>
		public virtual CE getSubstanceRefusalReason(int rep)
		{
			CE ret = null;
			try
			{
		...
		/// <summary> Returns all repetitions of Substance Refusal Reason (RXA-18).</summary>
		public virtual CE[] getSubstanceRefusalReason()
		{
			CE[] ret = null;
			try
			{
