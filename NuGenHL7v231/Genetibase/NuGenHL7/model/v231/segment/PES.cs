...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class PES:AbstractSegment
	{
		...
		/// <summary> Creates a PES (PES - product experience sender segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public PES(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				this.add(typeof(XON), false, 0, 80, new System.Object[]{message});
