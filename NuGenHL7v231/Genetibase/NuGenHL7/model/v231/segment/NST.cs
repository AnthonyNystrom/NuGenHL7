...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class NST:AbstractSegment
	{
		...
		public NST(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				this.add(typeof(ID), false, 1, 0, new System.Object[]{message, 136});
				this.add(typeof(ST), false, 1, 0, new System.Object[]{message});
				this.add(typeof(ID), false, 1, 0, new System.Object[]{message, 0});
				this.add(typeof(TS), false, 1, 0, new System.Object[]{message});
				this.add(typeof(TS), false, 1, 0, new System.Object[]{message});
				this.add(typeof(NM), false, 1, 0, new System.Object[]{message});
				this.add(typeof(NM), false, 1, 0, new System.Object[]{message});
				this.add(typeof(NM), false, 1, 0, new System.Object[]{message});
				this.add(typeof(NM), false, 1, 0, new System.Object[]{message});
				this.add(typeof(NM), false, 1, 0, new System.Object[]{message});
