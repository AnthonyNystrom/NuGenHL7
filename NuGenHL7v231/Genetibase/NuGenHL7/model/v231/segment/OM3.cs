...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class OM3:AbstractSegment
	{
		...
		virtual public CE AbnormalTextCodesForCategoricalObservations
		{
			get
			{
				CE ret = null;
		...
		virtual public CE CriticalTextCodesForCategoricalObservations
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a OM3 (OM3 - categorical test/observation segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public OM3(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(CE), false, 1, 200, new System.Object[]{message});
				this.add(typeof(ID), false, 1, 3, new System.Object[]{message, 125});
			}
			catch (NuGenHL7Exception)
			{
			}
