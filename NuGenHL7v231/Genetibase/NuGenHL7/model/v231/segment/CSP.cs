...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	/// <summary> <p>Represents an HL7 CSP message segment. 
	...
	public class CSP:AbstractSegment
	{
		...
		virtual public TS DateTimeStudyPhaseBegan
		{
			get
			{
				TS ret = null;
		...
		virtual public TS DateTimeStudyPhaseEnded
		{
			get
			{
				TS ret = null;
		...
		virtual public CE StudyPhaseEvaluability
		{
			get
			{
				CE ret = null;
		...
		/// <summary> Creates a CSP (CSP - clinical study phase segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
