...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class PR1:AbstractSegment
	{
		...
		/// <summary> Creates a PR1 (PR1 - procedures segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
		public PR1(Group parent, ModelClassFactory factory):base(parent, factory)
		{
			...
			try
			{
				...
				this.add(typeof(IS), false, 1, 2, new System.Object[]{message, 89});
				...
				this.add(typeof(IS), true, 1, 2, new System.Object[]{message, 230});
				...
				this.add(typeof(NM), false, 1, 4, new System.Object[]{message});
				this.add(typeof(XCN), false, 0, 120, new System.Object[]{message});
				this.add(typeof(XCN), false, 0, 230, new System.Object[]{message});
