...
namespace Genetibase.NuGenHL7.model.v231.segment
{
	...
	public class AIL:AbstractSegment
	{
		...
		virtual public PL LocationResourceID
		{
			get
			{
				PL ret = null;
		...
		/// <summary> Creates a AIL (AIL - appointment information - location resource segment) segment object that belongs to the given 
		/// message.  
		/// </summary>
