...
namespace Genetibase.NuGenHL7.validation
{
	...
	public class NuGenValidationException:System.Exception
	{
		...
		/// <param name="cause">
		/// </param>
		public NuGenValidationException(System.String message, System.Exception cause):base(message, cause)
		{
		}
		
		/// <param name="cause">
		/// </param>
		public NuGenValidationException(System.Exception cause):base(cause.Message, cause)
		{
		}
		...
		/// </param>
		public NuGenValidationException(System.String msg):base(msg)
		{
		}
	}
}