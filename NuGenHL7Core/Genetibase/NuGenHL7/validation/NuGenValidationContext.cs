...
namespace Genetibase.NuGenHL7.validation
{
	...
	/// </version>
	public interface NuGenValidationContext
	{
		...
		/// </returns>
		NuGenPrimitiveTypeRule[] getPrimitiveRules(System.String theVersion, System.String theTypeName, Primitive theType);
		...
		/// and trigger event 
		/// </returns>
		NuGenMessageRule[] getMessageRules(System.String theVersion, System.String theMessageType, System.String theTriggerEvent);
		...
		/// </returns>
		NuGenEncodingRule[] getEncodingRules(System.String theVersion, System.String theEncoding);
	}
}