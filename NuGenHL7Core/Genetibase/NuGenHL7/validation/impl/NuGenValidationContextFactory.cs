...
namespace Genetibase.NuGenHL7.validation.impl
{
	...
	/// <summary> <p>Source of <code>ValidationContext</code>.  </p>
	/// 
	/// <p>The <code>ValidationContext</code> returned by <code>getContext()</code>
	/// is determined by the system property "Genetibase.NuGenHL7.validation.context_class".
	...
	/// </author>
	/// <version>  $Revision: 1.5 $ updated on $Date: 2005/06/14 20:14:00 $ by $Author: bryan_tripp $
	/// </version>
	public class NuGenValidationContextFactory
	{
		/// <summary> Returns a singleton <code>ValidationContext</code>, creating it if necessary.
		/// 
		/// </summary>
		/// <returns> <code>ValidationContext</code> 
		/// </returns>
		public static NuGenValidationContext Context
		{
			get
			{
				lock (typeof(Genetibase.NuGenHL7.validation.impl.NuGenValidationContextFactory))
				{
					if (ourContext == null)
					{
						ourContext = new NuGenDefaultValidation();
					}
					return ourContext;
				}
			}
		...
		private static NuGenValidationContext ourContext;
		public const System.String CONTEXT_PROPERTY = "Genetibase.NuGenHL7.validation.context_class";
	}
}