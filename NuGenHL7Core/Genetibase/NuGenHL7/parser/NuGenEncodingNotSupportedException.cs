...
namespace Genetibase.NuGenHL7.parser
{
	...
	/// </author>
	[Serializable]
	public class NuGenEncodingNotSupportedException:NuGenHL7Exception
	{
		...
		/// </param>
		public NuGenEncodingNotSupportedException(System.String msg):base(msg, NuGenHL7Exception.APPLICATION_INTERNAL_ERROR)
		{
		}
	}
}