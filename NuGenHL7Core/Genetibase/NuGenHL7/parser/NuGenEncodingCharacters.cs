...
namespace Genetibase.NuGenHL7.parser
{
	...
	public class NuGenEncodingCharacters:System.Object, System.ICloneable
	{
		/// <summary> 
		...
		public NuGenEncodingCharacters(char fieldSeparator, System.String encodingCharacters)
		{
		...
		public NuGenEncodingCharacters(char fieldSeparator, char componentSeparator, char repetitionSeparator, char escapeCharacter, char subcomponentSeparator):this(fieldSeparator, System.Convert.ToString(componentSeparator) + repetitionSeparator + escapeCharacter + subcomponentSeparator)
		{
		}
		...
		public virtual System.Object Clone()
		{
			...
			return new NuGenEncodingCharacters(this);
		}
