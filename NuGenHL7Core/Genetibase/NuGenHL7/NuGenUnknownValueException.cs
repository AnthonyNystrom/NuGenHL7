...
namespace Genetibase.NuGenHL7
{
	...
	/// </author>
	[Serializable]
	public class NuGenUnknownValueException:NuGenHL7Exception
	{
		
		public NuGenUnknownValueException(System.String message):base(message, NuGenHL7Exception.TABLE_VALUE_NOT_FOUND)
		{
		}
	}
}