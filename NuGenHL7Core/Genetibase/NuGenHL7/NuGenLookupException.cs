...
namespace Genetibase.NuGenHL7
{
	...
	/// </author>
	[Serializable]
	public class NuGenLookupException:System.Exception
	{
		...
		/// <param name="message">
		/// </param>
		public NuGenLookupException(System.String message):base(message)
		{
		}
		...
		/// <param name="cause">
		/// </param>
		public NuGenLookupException(System.String message, System.Exception cause):base(message, cause)
		{
		}
	}
}