...
namespace Genetibase.NuGenHL7.sourcegen
{
	...
	/// </author>
	public class NuGenSegmentDef : NuGenStructureDef
	{
		...
		public NuGenSegmentDef(System.String name, System.String groupName, bool required, bool repeating, System.String description)
		{
			this.name = name;
