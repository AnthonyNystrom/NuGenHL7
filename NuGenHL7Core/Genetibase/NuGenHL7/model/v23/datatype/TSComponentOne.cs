...
namespace Genetibase.NuGenHL7.model.v23.datatype
{
	
	/// <summary> Note: The class description below has been excerpted from the Hl7 2.3.0 documentation. Sectional
	...
	/// </author>
	[Serializable]
	public class TSComponentOne:Genetibase.NuGenHL7.model.primitive.TSComponentOne
	{
		/// <returns> "2.3"
		/// </returns>
