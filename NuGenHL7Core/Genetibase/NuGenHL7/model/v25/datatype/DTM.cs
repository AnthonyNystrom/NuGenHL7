...
namespace Genetibase.NuGenHL7.model.v25.datatype
{
	...
	/// <summary> Note: The class description below has been excerpted from the Hl7 2.4 documentation. Sectional
	...
	/// </author>
	[Serializable]
	public class DTM:Genetibase.NuGenHL7.model.primitive.TSComponentOne
	{
		/// <returns> "2.5"
		/// </returns>
		...
		/// </param>
		public DTM(Message theMessage):base(theMessage)
		{
		}
	}
}