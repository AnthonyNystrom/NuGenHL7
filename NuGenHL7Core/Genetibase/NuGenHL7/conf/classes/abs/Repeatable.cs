...
namespace Genetibase.NuGenHL7.conf.classes.abs
{
	...
	/// <summary>A class which implements this interface will provide the methods to return Min and Max repetitions</summary>
	...
	{
		/// <summary>Returns the minimum allowable number of repetitions for this class </summary>
		short MaxReps
		{
			get;
