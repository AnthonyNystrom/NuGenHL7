...
namespace Genetibase.NuGenHL7.app
{
	...
	/// <summary> <p>From an HL7 messaging perspective, an Application is a consumer of a messages. 
	...
	/// <author>   Bryan Tripp
	/// </author>
	public interface NuGenApplication
	{
		...
		/// </summary>
		Message processMessage(Message in_Renamed);
		...
		/// </summary>
		bool canProcess(Message in_Renamed);
	}
}